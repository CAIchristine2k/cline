      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            The Story of <span className="text-primary">{config.influencerName}</span>
          </h1>
          <p className="text-text/80 max-w-3xl mx-auto leading-relaxed">
            {config.influencerTitle} and boxing legend with a career spanning decades.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
          <div>
            ...
            <div className="prose prose-lg prose-invert max-w-none">
              <p>
                {config.influencerBio}
              </p>
              <p>
                Throughout his illustrious career, {config.influencerName} has faced the world's best boxers 
                and established himself as one of the greatest fighters of his generation. His lightning-fast 
                hand speed, technical precision, and relentless work ethic earned him the respect of fans and 
                peers alike.
              </p>
              <p>
                Beyond his accomplishments in the ring, {config.influencerName} has become an entrepreneur and 
                brand ambassador, bringing his championship mentality to new ventures. This exclusive collection 
                represents the culmination of his boxing knowledge and passion for excellence.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-black/40 backdrop-blur-sm border border-primary/10 p-6 rounded-sm">
              ...
              <p className="text-text/80">
                Striving for perfection in every product, just as {config.influencerName} did in the ring.
              </p>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-primary/10 p-6 rounded-sm">
              ...
              <p className="text-text/80">
                Every product reflects the true spirit and legacy of {config.influencerName}'s career.
              </p>
            </div>
            ...
            <div className="bg-black/40 backdrop-blur-sm border border-primary/10 p-6 rounded-sm">
              ...
              <p className="text-text/80">
                Combining traditional boxing wisdom with modern technology and design.
              </p>
            </div>
          </div>
        </div>
