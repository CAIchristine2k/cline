...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  ...
  LineItemContainer: ( Omit<RemainingLineItemContainer, 'lineItems'> & { lineItems: _RefType['RemainingLineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledDigitalLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledGiftCardLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledPhysicalLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } );
  OrderDetailsPageOrder: ( Omit<Order, 'agreements' | 'billingAddress' | 'customer' | 'discountApplications' | 'draftOrder' | 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'purchasingEntity' | 'return' | 'returns' | 'shippingAddress' | 'shippingDiscountAllocations' | 'subscriptionContracts' | 'transactions'> & { agreements: _RefType['SalesAgreementConnection'], billingAddress?: Maybe<_RefType['CustomerAddress']>, customer?: Maybe<_RefType['Customer']>, discountApplications: _RefType['DiscountApplicationConnection'], draftOrder?: Maybe<_RefType['DraftOrder']>, editSummary?: Maybe<_RefType['OrderEditSummary']>, fulfillments: _RefType['FulfillmentConnection'], lineItemContainers: Array<_RefType['LineItemContainer']>, lineItems: _RefType['LineItemConnection'], purchasingEntity?: Maybe<_RefType['PurchasingEntity']>, return?: Maybe<_RefType['Return']>, returns: _RefType['ReturnConnection'], shippingAddress?: Maybe<_RefType['CustomerAddress']>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, subscriptionContracts?: Maybe<_RefType['SubscriptionContractConnection']>, transactions: Array<_RefType['OrderTransaction']> } ) | ( Omit<PublicOrder, 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'return' | 'returns' | 'transactions'> & { editSummary?: Maybe<_RefType['OrderEditSummary']>, fulfillments: _RefType['FulfillmentConnection'], lineItemContainers: Array<_RefType['LineItemContainer']>, lineItems: _RefType['LineItemConnection'], return?: Maybe<_RefType['Return']>, returns: _RefType['ReturnConnection'], transactions: Array<_RefType['OrderTransaction']> } );
  PaymentDetails: ( CardPaymentDetails );
  PricingValue: ( MoneyV2 ) | ( PricingPercentageValue );
  PurchasingEntity: ( Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<_RefType['WalletPaymentConfig']>, companyContacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, defaultAddress?: Maybe<_RefType['CustomerAddress']>, draftOrders: _RefType['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<_RefType['Checkout']>, orders: _RefType['OrderConnection'], paypalBillingAgreement?: Maybe<_RefType['PaypalBillingAgreement']>, return?: Maybe<_RefType['Return']>, storeCreditAccounts: _RefType['StoreCreditAccountConnection'], subscriptionContract?: Maybe<_RefType['SubscriptionContract']>, subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( Omit<PurchasingCompany, 'company' | 'contact' | 'location'> & { company: _RefType['Company'], contact?: Maybe<_RefType['CompanyContact']>, location: _RefType['CompanyLocation'] } );
  ReverseDeliveryDeliverable: ( ReverseDeliveryShippingDeliverable );
  SubscriptionAnchor: ( SubscriptionMonthDayAnchor ) | ( SubscriptionWeekDayAnchor ) | ( SubscriptionYearDayAnchor );
  SubscriptionDeliveryMethod: ( SubscriptionDeliveryMethodLocalDelivery ) | ( SubscriptionDeliveryMethodPickup ) | ( SubscriptionDeliveryMethodShipping );
  SubscriptionDeliveryOption: ( SubscriptionLocalDeliveryOption ) | ( SubscriptionPickupOption ) | ( SubscriptionShippingOption );
  SubscriptionDeliveryOptionsResult: ( SubscriptionDeliveryOptionsResultFailure ) | ( Omit<SubscriptionDeliveryOptionsResultSuccess, 'deliveryOptions'> & { deliveryOptions: Array<_RefType['SubscriptionDeliveryOption']> } );
  WalletPaymentConfig: ( ApplePayWalletConfig ) | ( GooglePayWalletConfig );
};

/** Mapping of interface types */
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  DiscountApplication: ( Omit<AutomaticDiscountApplication, 'value'> & { value: _RefType['PricingValue'] } ) | ( Omit<DiscountCodeApplication, 'value'> & { value: _RefType['PricingValue'] } ) | ( Omit<ManualDiscountApplication, 'value'> & { value: _RefType['PricingValue'] } ) | ( Omit<ScriptDiscountApplication, 'value'> & { value: _RefType['PricingValue'] } );
  DisplayableError: ( ApplePaySessionUserError ) | ( BusinessCustomerUserError ) | ( MetafieldsDeleteUserError ) | ( MetafieldsSetUserError ) | ( ReturnUserError ) | ( SubscriptionBillingCycleSkipUserError ) | ( SubscriptionBillingCycleUnskipUserError ) | ( SubscriptionContractStatusUpdateUserError ) | ( SubscriptionContractUserError ) | ( UserErrorsBusinessContactUserErrors ) | ( UserErrorsBusinessLocationPaymentInstrumentUserErrors ) | ( UserErrorsCustomerAddressUserErrors ) | ( UserErrorsCustomerEmailMarketingOptInUserErrors ) | ( UserErrorsCustomerEmailMarketingUserErrors ) | ( UserErrorsCustomerUserErrors ) | ( UserErrorsPaymentInstrumentUserErrors ) | ( UserErrorsPaypalTokenUserErrors ) | ( UserErrorsResendGiftCardErrors ) | ( UserErrorsStorefrontCustomerAccessTokenCreateUserErrors );
  HasCompareDigest: ( Metafield );
  HasMetafields: ( Omit<Company, 'draftOrders' | 'locations' | 'orders' | 'profile'> & { draftOrders: _RefType['DraftOrderConnection'], locations: _RefType['CompanyLocationConnection'], orders: _RefType['OrderConnection'], profile?: Maybe<_RefType['CompanyContact']> } ) | ( Omit<CompanyLocation, 'billingAddress' | 'buyerExperienceConfiguration' | 'contacts' | 'creditCard' | 'draftOrders' | 'orders' | 'shippingAddress'> & { billingAddress?: Maybe<_RefType['CompanyAddress']>, buyerExperienceConfiguration?: Maybe<_RefType['BuyerExperienceConfiguration']>, contacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, draftOrders: _RefType['DraftOrderConnection'], orders: _RefType['OrderConnection'], shippingAddress?: Maybe<_RefType['CompanyAddress']> } ) | ( Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<_RefType['WalletPaymentConfig']>, companyContacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, defaultAddress?: Maybe<_RefType['CustomerAddress']>, draftOrders: _RefType['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<_RefType['Checkout']>, orders: _RefType['OrderConnection'], paypalBillingAgreement?: Maybe<_RefType['PaypalBillingAgreement']>, return?: Maybe<_RefType['Return']>, storeCreditAccounts: _RefType['StoreCreditAccountConnection'], subscriptionContract?: Maybe<_RefType['SubscriptionContract']>, subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( Omit<Order, 'agreements' | 'billingAddress' | 'customer' | 'discountApplications' | 'draftOrder' | 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'purchasingEntity' | 'return' | 'returns' | 'shippingAddress' | 'shippingDiscountAllocations' | 'subscriptionContracts' | 'transactions'> & { agreements: _RefType['SalesAgreementConnection'], billingAddress?: Maybe<_RefType['CustomerAddress']>, customer?: Maybe<_RefType['Customer']>, discountApplications: _RefType['DiscountApplicationConnection'], draftOrder?: Maybe<_RefType['DraftOrder']>, editSummary?: Maybe<_RefType['OrderEditSummary']>, fulfillments: _RefType['FulfillmentConnection'], lineItemContainers: Array<_RefType['LineItemContainer']>, lineItems: _RefType['LineItemConnection'], purchasingEntity?: Maybe<_RefType['PurchasingEntity']>, return?: Maybe<_RefType['Return']>, returns: _RefType['ReturnConnection'], shippingAddress?: Maybe<_RefType['CustomerAddress']>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, subscriptionContracts?: Maybe<_RefType['SubscriptionContractConnection']>, transactions: Array<_RefType['OrderTransaction']> } ) | ( Shop );
  HasStoreCreditAccounts: ( Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<_RefType['WalletPaymentConfig']>, companyContacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, defaultAddress?: Maybe<_RefType['CustomerAddress']>, draftOrders: _RefType['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<_RefType['Checkout']>, orders: _RefType['OrderConnection'], paypalBillingAgreement?: Maybe<_RefType['PaypalBillingAgreement']>, return?: Maybe<_RefType['Return']>, storeCreditAccounts: _RefType['StoreCreditAccountConnection'], subscriptionContract?: Maybe<_RefType['SubscriptionContract']>, subscriptionContracts: _RefType['SubscriptionContractConnection'] } );
  Node: ( AdditionalFeeSale ) | ( AdjustmentSale ) | ( AppliedGiftCard ) | ( Omit<Checkout, 'appliedGiftCards' | 'discountApplications' | 'shippingDiscountAllocations'> & { appliedGiftCards: Array<_RefType['AppliedGiftCard']>, discountApplications: _RefType['DiscountApplicationConnection'], shippingDiscountAllocations: Array<_RefType['DiscountAllocation']> } ) | ( CheckoutLineItem ) | ( Omit<Company, 'draftOrders' | 'locations' | 'orders' | 'profile'> & { draftOrders: _RefType['DraftOrderConnection'], locations: _RefType['CompanyLocationConnection'], orders: _RefType['OrderConnection'], profile?: Maybe<_RefType['CompanyContact']> } ) | ( CompanyAddress ) | ( Omit<CompanyContact, 'company' | 'customer' | 'draftOrders' | 'locations' | 'orders'> & { company?: Maybe<_RefType['Company']>, customer: _RefType['Customer'], draftOrders: _RefType['DraftOrderConnection'], locations: _RefType['CompanyLocationConnection'], orders: _RefType['OrderConnection'] } ) | ( CompanyContactRole ) | ( Omit<CompanyContactRoleAssignment, 'contact'> & { contact: _RefType['CompanyContact'] } ) | ( Omit<CompanyLocation, 'billingAddress' | 'buyerExperienceConfiguration' | 'contacts' | 'creditCard' | 'draftOrders' | 'orders' | 'shippingAddress'> & { billingAddress?: Maybe<_RefType['CompanyAddress']>, buyerExperienceConfiguration?: Maybe<_RefType['BuyerExperienceConfiguration']>, contacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, draftOrders: _RefType['DraftOrderConnection'], orders: _RefType['OrderConnection'], shippingAddress?: Maybe<_RefType['CompanyAddress']> } ) | ( Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<_RefType['WalletPaymentConfig']>, companyContacts: _RefType['CompanyContactConnection'], creditCard?: Maybe<_RefType['CustomerCreditCard']>, defaultAddress?: Maybe<_RefType['CustomerAddress']>, draftOrders: _RefType['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<_RefType['Checkout']>, orders: _RefType['OrderConnection'], paypalBillingAgreement?: Maybe<_RefType['PaypalBillingAgreement']>, return?: Maybe<_RefType['Return']>, storeCreditAccounts: _RefType['StoreCreditAccountConnection'], subscriptionContract?: Maybe<_RefType['SubscriptionContract']>, subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( CustomerAddress ) | ( Omit<CustomerCreditCard, 'billingAddress' | 'openDraftOrders' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<_RefType['PaymentInstrumentBillingAddress']>, openDraftOrders: _RefType['DraftOrderConnection'], pendingOrders: _RefType['OrderConnection'], subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( CustomerMailingAddress ) | ( Domain ) | ( Omit<DraftOrder, 'billingAddress' | 'customer' | 'order' | 'purchasingEntity' | 'shippingAddress'> & { billingAddress?: Maybe<_RefType['CustomerAddress']>, customer?: Maybe<_RefType['Customer']>, order?: Maybe<_RefType['Order']>, purchasingEntity?: Maybe<_RefType['PurchasingEntity']>, shippingAddress?: Maybe<_RefType['CustomerAddress']> } ) | ( DraftOrderLineItem ) | ( DutySale ) | ( FeeSale ) | ( Omit<Fulfillment, 'fulfillmentLineItems'> & { fulfillmentLineItems: _RefType['FulfillmentLineItemConnection'] } ) | ( FulfillmentEvent ) | ( Omit<FulfillmentLineItem, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<GiftCardSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( LegacyAggregatedMerchandiseTermsAsFees ) | ( Omit<LineItem, 'discountAllocations'> & { discountAllocations: Array<_RefType['DiscountAllocation']> } ) | ( Omit<LineItemContainerLineItem, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( LineItemGroup ) | ( Market ) | ( MarketWebPresence ) | ( Metafield ) | ( Omit<Order, 'agreements' | 'billingAddress' | 'customer' | 'discountApplications' | 'draftOrder' | 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'purchasingEntity' | 'return' | 'returns' | 'shippingAddress' | 'shippingDiscountAllocations' | 'subscriptionContracts' | 'transactions'> & { agreements: _RefType['SalesAgreementConnection'], billingAddress?: Maybe<_RefType['CustomerAddress']>, customer?: Maybe<_RefType['Customer']>, discountApplications: _RefType['DiscountApplicationConnection'], draftOrder?: Maybe<_RefType['DraftOrder']>, editSummary?: Maybe<_RefType['OrderEditSummary']>, fulfillments: _RefType['FulfillmentConnection'], lineItemContainers: Array<_RefType['LineItemContainer']>, lineItems: _RefType['LineItemConnection'], purchasingEntity?: Maybe<_RefType['PurchasingEntity']>, return?: Maybe<_RefType['Return']>, returns: _RefType['ReturnConnection'], shippingAddress?: Maybe<_RefType['CustomerAddress']>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, subscriptionContracts?: Maybe<_RefType['SubscriptionContractConnection']>, transactions: Array<_RefType['OrderTransaction']> } ) | ( Omit<OrderAgreement, 'order' | 'sales'> & { order: _RefType['Order'], sales: _RefType['SaleConnection'] } ) | ( Omit<OrderEditAgreement, 'sales'> & { sales: _RefType['SaleConnection'] } ) | ( Omit<OrderEditSummaryChange, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<OrderTransaction, 'giftCardDetails' | 'paymentDetails'> & { giftCardDetails?: Maybe<_RefType['GiftCardDetails']>, paymentDetails?: Maybe<_RefType['PaymentDetails']> } ) | ( PaymentIconImage ) | ( PaymentSchedule ) | ( PaymentTerms ) | ( PaymentTermsTemplate ) | ( Omit<PaypalBillingAgreement, 'billingAddress' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<_RefType['PaymentInstrumentBillingAddress']>, pendingOrders: _RefType['OrderConnection'], subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( Omit<ProductSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<PublicOrder, 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'return' | 'returns' | 'transactions'> & { editSummary?: Maybe<_RefType['OrderEditSummary']>, fulfillments: _RefType['FulfillmentConnection'], lineItemContainers: Array<_RefType['LineItemContainer']>, lineItems: _RefType['LineItemConnection'], return?: Maybe<_RefType['Return']>, returns: _RefType['ReturnConnection'], transactions: Array<_RefType['OrderTransaction']> } ) | ( Refund ) | ( Omit<RefundAgreement, 'sales'> & { sales: _RefType['SaleConnection'] } ) | ( Omit<RemainingLineItemContainerLineItem, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<Return, 'decline' | 'returnLineItems' | 'reverseDeliveries'> & { decline?: Maybe<_RefType['ReturnDecline']>, returnLineItems: _RefType['ReturnLineItemConnection'], reverseDeliveries: _RefType['ReverseDeliveryConnection'] } ) | ( Omit<ReturnAgreement, 'return' | 'sales'> & { return: _RefType['Return'], sales: _RefType['SaleConnection'] } ) | ( Omit<ReturnLineItem, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<ReverseDelivery, 'deliverable'> & { deliverable?: Maybe<_RefType['ReverseDeliveryDeliverable']> } ) | ( SaleTax ) | ( ShippingLineSale ) | ( Shop ) | ( ShopPolicy ) | ( Omit<StoreCreditAccount, 'transactions'> & { transactions: _RefType['StoreCreditAccountTransactionConnection'] } ) | ( Omit<StoreCreditAccountCreditTransaction, 'account'> & { account: _RefType['StoreCreditAccount'] } ) | ( Omit<StoreCreditAccountDebitRevertTransaction, 'account' | 'debitTransaction'> & { account: _RefType['StoreCreditAccount'], debitTransaction: _RefType['StoreCreditAccountDebitTransaction'] } ) | ( Omit<StoreCreditAccountDebitTransaction, 'account'> & { account: _RefType['StoreCreditAccount'] } ) | ( Omit<SubscriptionContract, 'billingPolicy' | 'deliveryMethod' | 'deliveryPolicy' | 'orders' | 'originOrder' | 'paymentInstrument'> & { billingPolicy: _RefType['SubscriptionBillingPolicy'], deliveryMethod?: Maybe<_RefType['SubscriptionDeliveryMethod']>, deliveryPolicy: _RefType['SubscriptionDeliveryPolicy'], orders: _RefType['OrderConnection'], originOrder?: Maybe<_RefType['Order']>, paymentInstrument?: Maybe<_RefType['PaymentInstrument']> } ) | ( TaxLine ) | ( TimelineEvent ) | ( Omit<TipSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( UiExtensionMetafield ) | ( UnknownSale );
  PaymentIcon: ( Omit<OrderTransaction, 'giftCardDetails' | 'paymentDetails'> & { giftCardDetails?: Maybe<_RefType['GiftCardDetails']>, paymentDetails?: Maybe<_RefType['PaymentDetails']> } );
  PaymentInstrument: ( Omit<CustomerCreditCard, 'billingAddress' | 'openDraftOrders' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<_RefType['PaymentInstrumentBillingAddress']>, openDraftOrders: _RefType['DraftOrderConnection'], pendingOrders: _RefType['OrderConnection'], subscriptionContracts: _RefType['SubscriptionContractConnection'] } ) | ( Omit<PaypalBillingAgreement, 'billingAddress' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<_RefType['PaymentInstrumentBillingAddress']>, pendingOrders: _RefType['OrderConnection'], subscriptionContracts: _RefType['SubscriptionContractConnection'] } );
  Sale: ( AdditionalFeeSale ) | ( AdjustmentSale ) | ( DutySale ) | ( FeeSale ) | ( Omit<GiftCardSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( Omit<ProductSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( ShippingLineSale ) | ( Omit<TipSale, 'lineItem'> & { lineItem: _RefType['LineItem'] } ) | ( UnknownSale );
  SalesAgreement: ( Omit<OrderAgreement, 'order' | 'sales'> & { order: _RefType['Order'], sales: _RefType['SaleConnection'] } ) | ( Omit<OrderEditAgreement, 'sales'> & { sales: _RefType['SaleConnection'] } ) | ( Omit<RefundAgreement, 'sales'> & { sales: _RefType['SaleConnection'] } ) | ( Omit<ReturnAgreement, 'return' | 'sales'> & { return: _RefType['Return'], sales: _RefType['SaleConnection'] } );
  StoreCreditAccountTransaction: ( Omit<StoreCreditAccountCreditTransaction, 'account'> & { account: _RefType['StoreCreditAccount'] } ) | ( Omit<StoreCreditAccountDebitRevertTransaction, 'account' | 'debitTransaction'> & { account: _RefType['StoreCreditAccount'], debitTransaction: _RefType['StoreCreditAccountDebitTransaction'] } ) | ( Omit<StoreCreditAccountDebitTransaction, 'account'> & { account: _RefType['StoreCreditAccount'] } ) | ( Omit<StoreCreditAccountExpirationTransaction, 'account' | 'creditTransaction'> & { account: _RefType['StoreCreditAccount'], creditTransaction: _RefType['StoreCreditAccountCreditTransaction'] } );
  SubscriptionContractBase: ( Omit<SubscriptionContract, 'billingPolicy' | 'deliveryMethod' | 'deliveryPolicy' | 'orders' | 'originOrder' | 'paymentInstrument'> & { billingPolicy: _RefType['SubscriptionBillingPolicy'], deliveryMethod?: Maybe<_RefType['SubscriptionDeliveryMethod']>, deliveryPolicy: _RefType['SubscriptionDeliveryPolicy'], orders: _RefType['OrderConnection'], originOrder?: Maybe<_RefType['Order']>, paymentInstrument?: Maybe<_RefType['PaymentInstrument']> } );
  UnfulfilledLineItemContainerCommonFields: ( Omit<UnfulfilledDigitalLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledGiftCardLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } ) | ( Omit<UnfulfilledPhysicalLineItemContainer, 'lineItems'> & { lineItems: _RefType['LineItemContainerLineItemConnection'] } );
};
...
export type ResolversTypes = {
  ...
  ApplePayCreditCardAddPayload: ResolverTypeWrapper<Omit<ApplePayCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  ApplePayCreditCardUpdatePayload: ResolverTypeWrapper<Omit<ApplePayCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  ...
  BusinessContactUpdatePayload: ResolverTypeWrapper<Omit<BusinessContactUpdatePayload, 'businessContact'> & { businessContact?: Maybe<ResolversTypes['CompanyContact']> }>;
  ...
  BusinessLocationCreditCardAddPayload: ResolverTypeWrapper<Omit<BusinessLocationCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  BusinessLocationCreditCardUpdatePayload: ResolverTypeWrapper<Omit<BusinessLocationCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  BusinessLocationPaymentInstrumentRemovePayload: ResolverTypeWrapper<BusinessLocationPaymentInstrumentRemovePayload>;
  BuyerExperienceConfiguration: ResolverTypeWrapper<Omit<BuyerExperienceConfiguration, 'deposit'> & { deposit?: Maybe<ResolversTypes['DepositConfiguration']> }>;
  CardPaymentDetails: ResolverTypeWrapper<CardPaymentDetails>;
  Checkout: ResolverTypeWrapper<Omit<Checkout, 'appliedGiftCards' | 'discountApplications' | 'shippingDiscountAllocations'> & { appliedGiftCards: Array<ResolversTypes['AppliedGiftCard']>, discountApplications: ResolversTypes['DiscountApplicationConnection'], shippingDiscountAllocations: Array<ResolversTypes['DiscountAllocation']> }>;
  ...
  Company: ResolverTypeWrapper<Omit<Company, 'draftOrders' | 'locations' | 'orders' | 'profile'> & { draftOrders: ResolversTypes['DraftOrderConnection'], locations: ResolversTypes['CompanyLocationConnection'], orders: ResolversTypes['OrderConnection'], profile?: Maybe<ResolversTypes['CompanyContact']> }>;
  ...
  CompanyContact: ResolverTypeWrapper<Omit<CompanyContact, 'company' | 'customer' | 'draftOrders' | 'locations' | 'orders'> & { company?: Maybe<ResolversTypes['Company']>, customer: ResolversTypes['Customer'], draftOrders: ResolversTypes['DraftOrderConnection'], locations: ResolversTypes['CompanyLocationConnection'], orders: ResolversTypes['OrderConnection'] }>;
  CompanyContactConnection: ResolverTypeWrapper<Omit<CompanyContactConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['CompanyContactEdge']>, nodes: Array<ResolversTypes['CompanyContact']> }>;
  CompanyContactEdge: ResolverTypeWrapper<Omit<CompanyContactEdge, 'node'> & { node: ResolversTypes['CompanyContact'] }>;
  CompanyContactRole: ResolverTypeWrapper<CompanyContactRole>;
  CompanyContactRoleAssignment: ResolverTypeWrapper<Omit<CompanyContactRoleAssignment, 'contact'> & { contact: ResolversTypes['CompanyContact'] }>;
  ...
  CompanyLocation: ResolverTypeWrapper<Omit<CompanyLocation, 'billingAddress' | 'buyerExperienceConfiguration' | 'contacts' | 'creditCard' | 'draftOrders' | 'orders' | 'shippingAddress'> & { billingAddress?: Maybe<ResolversTypes['CompanyAddress']>, buyerExperienceConfiguration?: Maybe<ResolversTypes['BuyerExperienceConfiguration']>, contacts: ResolversTypes['CompanyContactConnection'], creditCard?: Maybe<ResolversTypes['CustomerCreditCard']>, draftOrders: ResolversTypes['DraftOrderConnection'], orders: ResolversTypes['OrderConnection'], shippingAddress?: Maybe<ResolversTypes['CompanyAddress']> }>;
  CompanyLocationAssignAddressPayload: ResolverTypeWrapper<Omit<CompanyLocationAssignAddressPayload, 'addresses'> & { addresses?: Maybe<Array<ResolversTypes['CompanyAddress']>> }>;
  CompanyLocationConnection: ResolverTypeWrapper<Omit<CompanyLocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['CompanyLocationEdge']>, nodes: Array<ResolversTypes['CompanyLocation']> }>;
  CompanyLocationEdge: ResolverTypeWrapper<Omit<CompanyLocationEdge, 'node'> & { node: ResolversTypes['CompanyLocation'] }>;
  ...
  CountryCode: CountryCode;
  CreditCardAddPayload: ResolverTypeWrapper<Omit<CreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  CreditCardUpdatePayload: ResolverTypeWrapper<Omit<CreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  CropRegion: CropRegion;
  CurrencyCode: CurrencyCode;
  Customer: ResolverTypeWrapper<Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<ResolversTypes['WalletPaymentConfig']>, companyContacts: ResolversTypes['CompanyContactConnection'], creditCard?: Maybe<ResolversTypes['CustomerCreditCard']>, defaultAddress?: Maybe<ResolversTypes['CustomerAddress']>, draftOrders: ResolversTypes['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<ResolversTypes['Checkout']>, orders: ResolversTypes['OrderConnection'], paypalBillingAgreement?: Maybe<ResolversTypes['PaypalBillingAgreement']>, return?: Maybe<ResolversTypes['Return']>, storeCreditAccounts: ResolversTypes['StoreCreditAccountConnection'], subscriptionContract?: Maybe<ResolversTypes['SubscriptionContract']>, subscriptionContracts: ResolversTypes['SubscriptionContractConnection'] }>;
  CustomerAddress: ResolverTypeWrapper<CustomerAddress>;
  CustomerAddressConnection: ResolverTypeWrapper<Omit<CustomerAddressConnection, 'nodes'> & { nodes: Array<ResolversTypes['CustomerAddress']> }>;
  CustomerAddressCreatePayload: ResolverTypeWrapper<Omit<CustomerAddressCreatePayload, 'customerAddress'> & { customerAddress?: Maybe<ResolversTypes['CustomerAddress']> }>;
  CustomerAddressDeletePayload: ResolverTypeWrapper<CustomerAddressDeletePayload>;
  CustomerAddressEdge: ResolverTypeWrapper<Omit<CustomerAddressEdge, 'node'> & { node: ResolversTypes['CustomerAddress'] }>;
  CustomerAddressInput: CustomerAddressInput;
  CustomerAddressUpdatePayload: ResolverTypeWrapper<Omit<CustomerAddressUpdatePayload, 'customerAddress'> & { customerAddress?: Maybe<ResolversTypes['CustomerAddress']> }>;
  CustomerCreditCard: ResolverTypeWrapper<Omit<CustomerCreditCard, 'billingAddress' | 'openDraftOrders' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<ResolversTypes['PaymentInstrumentBillingAddress']>, openDraftOrders: ResolversTypes['DraftOrderConnection'], pendingOrders: ResolversTypes['OrderConnection'], subscriptionContracts: ResolversTypes['SubscriptionContractConnection'] }>;
  CustomerCreditCardConnection: ResolverTypeWrapper<Omit<CustomerCreditCardConnection, 'nodes'> & { nodes: Array<ResolversTypes['CustomerCreditCard']> }>;
  CustomerCreditCardEdge: ResolverTypeWrapper<Omit<CustomerCreditCardEdge, 'node'> & { node: ResolversTypes['CustomerCreditCard'] }>;
  ...
  CustomerUpdatePayload: ResolverTypeWrapper<Omit<CustomerUpdatePayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  DateTime: ResolverTypeWrapper<Scalars['DateTime']['output']>;
  Decimal: ResolverTypeWrapper<Scalars['Decimal']['output']>;
  DeliveryOptionGroupType: DeliveryOptionGroupType;
  DepositConfiguration: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['DepositConfiguration']>;
  DepositPercentage: ResolverTypeWrapper<DepositPercentage>;
  DiscountAllocation: ResolverTypeWrapper<Omit<DiscountAllocation, 'discountApplication'> & { discountApplication: ResolversTypes['DiscountApplication'] }>;
  DiscountApplication: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['DiscountApplication']>;
  DiscountApplicationAllocationMethod: DiscountApplicationAllocationMethod;
  DiscountApplicationConnection: ResolverTypeWrapper<Omit<DiscountApplicationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['DiscountApplicationEdge']>, nodes: Array<ResolversTypes['DiscountApplication']> }>;
  DiscountApplicationEdge: ResolverTypeWrapper<Omit<DiscountApplicationEdge, 'node'> & { node: ResolversTypes['DiscountApplication'] }>;
  ...
  DraftOrder: ResolverTypeWrapper<Omit<DraftOrder, 'billingAddress' | 'customer' | 'order' | 'purchasingEntity' | 'shippingAddress'> & { billingAddress?: Maybe<ResolversTypes['CustomerAddress']>, customer?: Maybe<ResolversTypes['Customer']>, order?: Maybe<ResolversTypes['Order']>, purchasingEntity?: Maybe<ResolversTypes['PurchasingEntity']>, shippingAddress?: Maybe<ResolversTypes['CustomerAddress']> }>;
  ...
  DraftOrderConnection: ResolverTypeWrapper<Omit<DraftOrderConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['DraftOrderEdge']>, nodes: Array<ResolversTypes['DraftOrder']> }>;
  DraftOrderDiscountInformation: ResolverTypeWrapper<DraftOrderDiscountInformation>;
  DraftOrderEdge: ResolverTypeWrapper<Omit<DraftOrderEdge, 'node'> & { node: ResolversTypes['DraftOrder'] }>;
  ...
  Fulfillment: ResolverTypeWrapper<Omit<Fulfillment, 'fulfillmentLineItems'> & { fulfillmentLineItems: ResolversTypes['FulfillmentLineItemConnection'] }>;
  FulfillmentConnection: ResolverTypeWrapper<Omit<FulfillmentConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['FulfillmentEdge']>, nodes: Array<ResolversTypes['Fulfillment']> }>;
  FulfillmentEdge: ResolverTypeWrapper<Omit<FulfillmentEdge, 'node'> & { node: ResolversTypes['Fulfillment'] }>;
  ...
  FulfillmentLineItem: ResolverTypeWrapper<Omit<FulfillmentLineItem, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  FulfillmentLineItemConnection: ResolverTypeWrapper<Omit<FulfillmentLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['FulfillmentLineItemEdge']>, nodes: Array<ResolversTypes['FulfillmentLineItem']> }>;
  FulfillmentLineItemEdge: ResolverTypeWrapper<Omit<FulfillmentLineItemEdge, 'node'> & { node: ResolversTypes['FulfillmentLineItem'] }>;
  FulfillmentSortKeys: FulfillmentSortKeys;
  FulfillmentStatus: FulfillmentStatus;
  GiftCardDetails: ResolverTypeWrapper<GiftCardDetails>;
  GiftCardSale: ResolverTypeWrapper<Omit<GiftCardSale, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  GooglePayBillingAddressInput: GooglePayBillingAddressInput;
  GooglePayCreditCardAddPayload: ResolverTypeWrapper<Omit<GooglePayCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  GooglePayCreditCardUpdatePayload: ResolverTypeWrapper<Omit<GooglePayCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversTypes['CustomerCreditCard']> }>;
  GooglePayWalletConfig: ResolverTypeWrapper<GooglePayWalletConfig>;
  HTML: ResolverTypeWrapper<Scalars['HTML']['output']>;
  HasCompareDigest: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasCompareDigest']>;
  HasMetafields: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasMetafields']>;
  HasMetafieldsIdentifier: HasMetafieldsIdentifier;
  HasStoreCreditAccounts: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['HasStoreCreditAccounts']>;
  ...
  LineItem: ResolverTypeWrapper<Omit<LineItem, 'discountAllocations'> & { discountAllocations: Array<ResolversTypes['DiscountAllocation']> }>;
  LineItemConnection: ResolverTypeWrapper<Omit<LineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['LineItemEdge']>, nodes: Array<ResolversTypes['LineItem']> }>;
  LineItemContainer: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['LineItemContainer']>;
  LineItemContainerLineItem: ResolverTypeWrapper<Omit<LineItemContainerLineItem, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  LineItemContainerLineItemConnection: ResolverTypeWrapper<Omit<LineItemContainerLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['LineItemContainerLineItemEdge']>, nodes: Array<ResolversTypes['LineItemContainerLineItem']> }>;
  LineItemContainerLineItemEdge: ResolverTypeWrapper<Omit<LineItemContainerLineItemEdge, 'node'> & { node: ResolversTypes['LineItemContainerLineItem'] }>;
  LineItemDiscountInformation: ResolverTypeWrapper<LineItemDiscountInformation>;
  LineItemEdge: ResolverTypeWrapper<Omit<LineItemEdge, 'node'> & { node: ResolversTypes['LineItem'] }>;
  ...
  Order: ResolverTypeWrapper<Omit<Order, 'agreements' | 'billingAddress' | 'customer' | 'discountApplications' | 'draftOrder' | 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'purchasingEntity' | 'return' | 'returns' | 'shippingAddress' | 'shippingDiscountAllocations' | 'subscriptionContracts' | 'transactions'> & { agreements: ResolversTypes['SalesAgreementConnection'], billingAddress?: Maybe<ResolversTypes['CustomerAddress']>, customer?: Maybe<ResolversTypes['Customer']>, discountApplications: ResolversTypes['DiscountApplicationConnection'], draftOrder?: Maybe<ResolversTypes['DraftOrder']>, editSummary?: Maybe<ResolversTypes['OrderEditSummary']>, fulfillments: ResolversTypes['FulfillmentConnection'], lineItemContainers: Array<ResolversTypes['LineItemContainer']>, lineItems: ResolversTypes['LineItemConnection'], purchasingEntity?: Maybe<ResolversTypes['PurchasingEntity']>, return?: Maybe<ResolversTypes['Return']>, returns: ResolversTypes['ReturnConnection'], shippingAddress?: Maybe<ResolversTypes['CustomerAddress']>, shippingDiscountAllocations: Array<ResolversTypes['DiscountAllocation']>, subscriptionContracts?: Maybe<ResolversTypes['SubscriptionContractConnection']>, transactions: Array<ResolversTypes['OrderTransaction']> }>;
  OrderActionType: OrderActionType;
  OrderAgreement: ResolverTypeWrapper<Omit<OrderAgreement, 'order' | 'sales'> & { order: ResolversTypes['Order'], sales: ResolversTypes['SaleConnection'] }>;
  ...
  OrderConnection: ResolverTypeWrapper<Omit<OrderConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['OrderEdge']>, nodes: Array<ResolversTypes['Order']> }>;
  OrderDetailsPageOrder: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['OrderDetailsPageOrder']>;
  ...
  OrderEditAgreement: ResolverTypeWrapper<Omit<OrderEditAgreement, 'sales'> & { sales: ResolversTypes['SaleConnection'] }>;
  OrderEditSummary: ResolverTypeWrapper<Omit<OrderEditSummary, 'changes'> & { changes: Array<ResolversTypes['OrderEditSummaryChange']> }>;
  OrderEditSummaryChange: ResolverTypeWrapper<Omit<OrderEditSummaryChange, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  ...
  OrderRequestReturnPayload: ResolverTypeWrapper<Omit<OrderRequestReturnPayload, 'return'> & { return?: Maybe<ResolversTypes['Return']> }>;
  ...
  OrderTransaction: ResolverTypeWrapper<Omit<OrderTransaction, 'giftCardDetails' | 'paymentDetails'> & { giftCardDetails?: Maybe<ResolversTypes['GiftCardDetails']>, paymentDetails?: Maybe<ResolversTypes['PaymentDetails']> }>;
  ...
  PaymentIcon: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['PaymentIcon']>;
  PaymentIconImage: ResolverTypeWrapper<PaymentIconImage>;
  PaymentInstrument: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['PaymentInstrument']>;
  ...
  PaymentTermsType: PaymentTermsType;
  PaypalAccountEnablePayload: ResolverTypeWrapper<Omit<PaypalAccountEnablePayload, 'paypalBillingAgreement'> & { paypalBillingAgreement?: Maybe<ResolversTypes['PaypalBillingAgreement']> }>;
  PaypalBillingAgreement: ResolverTypeWrapper<Omit<PaypalBillingAgreement, 'billingAddress' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<ResolversTypes['PaymentInstrumentBillingAddress']>, pendingOrders: ResolversTypes['OrderConnection'], subscriptionContracts: ResolversTypes['SubscriptionContractConnection'] }>;
  ...
  PricingValue: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['PricingValue']>;
  ProductSale: ResolverTypeWrapper<Omit<ProductSale, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  PublicOrder: ResolverTypeWrapper<Omit<PublicOrder, 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'return' | 'returns' | 'transactions'> & { editSummary?: Maybe<ResolversTypes['OrderEditSummary']>, fulfillments: ResolversTypes['FulfillmentConnection'], lineItemContainers: Array<ResolversTypes['LineItemContainer']>, lineItems: ResolversTypes['LineItemConnection'], return?: Maybe<ResolversTypes['Return']>, returns: ResolversTypes['ReturnConnection'], transactions: Array<ResolversTypes['OrderTransaction']> }>;
  PurchasingCompany: ResolverTypeWrapper<Omit<PurchasingCompany, 'company' | 'contact' | 'location'> & { company: ResolversTypes['Company'], contact?: Maybe<ResolversTypes['CompanyContact']>, location: ResolversTypes['CompanyLocation'] }>;
  PurchasingEntity: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['PurchasingEntity']>;
  QueryRoot: ResolverTypeWrapper<{}>;
  Refund: ResolverTypeWrapper<Refund>;
  RefundAgreement: ResolverTypeWrapper<Omit<RefundAgreement, 'sales'> & { sales: ResolversTypes['SaleConnection'] }>;
  RemainingLineItemContainer: ResolverTypeWrapper<Omit<RemainingLineItemContainer, 'lineItems'> & { lineItems: ResolversTypes['RemainingLineItemContainerLineItemConnection'] }>;
  RemainingLineItemContainerLineItem: ResolverTypeWrapper<Omit<RemainingLineItemContainerLineItem, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  RemainingLineItemContainerLineItemConnection: ResolverTypeWrapper<Omit<RemainingLineItemContainerLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['RemainingLineItemContainerLineItemEdge']>, nodes: Array<ResolversTypes['RemainingLineItemContainerLineItem']> }>;
  RemainingLineItemContainerLineItemEdge: ResolverTypeWrapper<Omit<RemainingLineItemContainerLineItemEdge, 'node'> & { node: ResolversTypes['RemainingLineItemContainerLineItem'] }>;
  ...
  Return: ResolverTypeWrapper<Omit<Return, 'decline' | 'returnLineItems' | 'reverseDeliveries'> & { decline?: Maybe<ResolversTypes['ReturnDecline']>, returnLineItems: ResolversTypes['ReturnLineItemConnection'], reverseDeliveries: ResolversTypes['ReverseDeliveryConnection'] }>;
  ReturnAgreement: ResolverTypeWrapper<Omit<ReturnAgreement, 'return' | 'sales'> & { return: ResolversTypes['Return'], sales: ResolversTypes['SaleConnection'] }>;
  ReturnConnection: ResolverTypeWrapper<Omit<ReturnConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['ReturnEdge']>, nodes: Array<ResolversTypes['Return']> }>;
  ReturnDecline: ResolverTypeWrapper<ReturnDecline>;
  ReturnDeclineReason: ReturnDeclineReason;
  ReturnEdge: ResolverTypeWrapper<Omit<ReturnEdge, 'node'> & { node: ResolversTypes['Return'] }>;
  ReturnErrorCode: ReturnErrorCode;
  ReturnLineItem: ResolverTypeWrapper<Omit<ReturnLineItem, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  ReturnLineItemConnection: ResolverTypeWrapper<Omit<ReturnLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['ReturnLineItemEdge']>, nodes: Array<ResolversTypes['ReturnLineItem']> }>;
  ReturnLineItemEdge: ResolverTypeWrapper<Omit<ReturnLineItemEdge, 'node'> & { node: ResolversTypes['ReturnLineItem'] }>;
  ReturnReason: ReturnReason;
  ...
  ReverseDelivery: ResolverTypeWrapper<Omit<ReverseDelivery, 'deliverable'> & { deliverable?: Maybe<ResolversTypes['ReverseDeliveryDeliverable']> }>;
  ReverseDeliveryConnection: ResolverTypeWrapper<Omit<ReverseDeliveryConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['ReverseDeliveryEdge']>, nodes: Array<ResolversTypes['ReverseDelivery']> }>;
  ReverseDeliveryDeliverable: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['ReverseDeliveryDeliverable']>;
  ReverseDeliveryEdge: ResolverTypeWrapper<Omit<ReverseDeliveryEdge, 'node'> & { node: ResolversTypes['ReverseDelivery'] }>;
  ...
  SaleConnection: ResolverTypeWrapper<Omit<SaleConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SaleEdge']>, nodes: Array<ResolversTypes['Sale']> }>;
  ...
  SalesAgreement: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['SalesAgreement']>;
  SalesAgreementConnection: ResolverTypeWrapper<Omit<SalesAgreementConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SalesAgreementEdge']>, nodes: Array<ResolversTypes['SalesAgreement']> }>;
  SalesAgreementEdge: ResolverTypeWrapper<Omit<SalesAgreementEdge, 'node'> & { node: ResolversTypes['SalesAgreement'] }>;
  ...
  StoreCreditAccount: ResolverTypeWrapper<Omit<StoreCreditAccount, 'transactions'> & { transactions: ResolversTypes['StoreCreditAccountTransactionConnection'] }>;
  StoreCreditAccountConnection: ResolverTypeWrapper<Omit<StoreCreditAccountConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['StoreCreditAccountEdge']>, nodes: Array<ResolversTypes['StoreCreditAccount']> }>;
  StoreCreditAccountCreditTransaction: ResolverTypeWrapper<Omit<StoreCreditAccountCreditTransaction, 'account'> & { account: ResolversTypes['StoreCreditAccount'] }>;
  StoreCreditAccountDebitRevertTransaction: ResolverTypeWrapper<Omit<StoreCreditAccountDebitRevertTransaction, 'account' | 'debitTransaction'> & { account: ResolversTypes['StoreCreditAccount'], debitTransaction: ResolversTypes['StoreCreditAccountDebitTransaction'] }>;
  StoreCreditAccountDebitTransaction: ResolverTypeWrapper<Omit<StoreCreditAccountDebitTransaction, 'account'> & { account: ResolversTypes['StoreCreditAccount'] }>;
  StoreCreditAccountEdge: ResolverTypeWrapper<Omit<StoreCreditAccountEdge, 'node'> & { node: ResolversTypes['StoreCreditAccount'] }>;
  StoreCreditAccountExpirationTransaction: ResolverTypeWrapper<Omit<StoreCreditAccountExpirationTransaction, 'account' | 'creditTransaction'> & { account: ResolversTypes['StoreCreditAccount'], creditTransaction: ResolversTypes['StoreCreditAccountCreditTransaction'] }>;
  StoreCreditAccountTransaction: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['StoreCreditAccountTransaction']>;
  StoreCreditAccountTransactionConnection: ResolverTypeWrapper<Omit<StoreCreditAccountTransactionConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['StoreCreditAccountTransactionEdge']>, nodes: Array<ResolversTypes['StoreCreditAccountTransaction']> }>;
  StoreCreditAccountTransactionEdge: ResolverTypeWrapper<Omit<StoreCreditAccountTransactionEdge, 'node'> & { node: ResolversTypes['StoreCreditAccountTransaction'] }>;
  StorefrontCustomerAccessTokenCreatePayload: ResolverTypeWrapper<StorefrontCustomerAccessTokenCreatePayload>;
  String: ResolverTypeWrapper<Scalars['String']['output']>;
  SubscriptionAnchor: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SubscriptionAnchor']>;
  ...
  SubscriptionBillingPolicy: ResolverTypeWrapper<Omit<SubscriptionBillingPolicy, 'anchors'> & { anchors: Array<ResolversTypes['SubscriptionAnchor']> }>;
  SubscriptionContract: ResolverTypeWrapper<Omit<SubscriptionContract, 'billingPolicy' | 'deliveryMethod' | 'deliveryPolicy' | 'orders' | 'originOrder' | 'paymentInstrument'> & { billingPolicy: ResolversTypes['SubscriptionBillingPolicy'], deliveryMethod?: Maybe<ResolversTypes['SubscriptionDeliveryMethod']>, deliveryPolicy: ResolversTypes['SubscriptionDeliveryPolicy'], orders: ResolversTypes['OrderConnection'], originOrder?: Maybe<ResolversTypes['Order']>, paymentInstrument?: Maybe<ResolversTypes['PaymentInstrument']> }>;
  SubscriptionContractActivatePayload: ResolverTypeWrapper<Omit<SubscriptionContractActivatePayload, 'contract'> & { contract?: Maybe<ResolversTypes['SubscriptionContract']> }>;
  SubscriptionContractBase: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['SubscriptionContractBase']>;
  SubscriptionContractCancelPayload: ResolverTypeWrapper<Omit<SubscriptionContractCancelPayload, 'contract'> & { contract?: Maybe<ResolversTypes['SubscriptionContract']> }>;
  SubscriptionContractChangePaymentInstrumentPayload: ResolverTypeWrapper<Omit<SubscriptionContractChangePaymentInstrumentPayload, 'contract'> & { contract?: Maybe<ResolversTypes['SubscriptionContract']> }>;
  SubscriptionContractConnection: ResolverTypeWrapper<Omit<SubscriptionContractConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SubscriptionContractEdge']>, nodes: Array<ResolversTypes['SubscriptionContract']> }>;
  SubscriptionContractEdge: ResolverTypeWrapper<Omit<SubscriptionContractEdge, 'node'> & { node: ResolversTypes['SubscriptionContract'] }>;
  SubscriptionContractFetchDeliveryOptionsPayload: ResolverTypeWrapper<Omit<SubscriptionContractFetchDeliveryOptionsPayload, 'deliveryOptionsResult'> & { deliveryOptionsResult?: Maybe<ResolversTypes['SubscriptionDeliveryOptionsResult']> }>;
  ...
  SubscriptionContractPausePayload: ResolverTypeWrapper<Omit<SubscriptionContractPausePayload, 'contract'> & { contract?: Maybe<ResolversTypes['SubscriptionContract']> }>;
  SubscriptionContractSelectDeliveryMethodPayload: ResolverTypeWrapper<Omit<SubscriptionContractSelectDeliveryMethodPayload, 'contract'> & { contract?: Maybe<ResolversTypes['SubscriptionContract']> }>;
  ...
  SubscriptionDeliveryMethod: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SubscriptionDeliveryMethod']>;
  ...
  SubscriptionDeliveryOption: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SubscriptionDeliveryOption']>;
  SubscriptionDeliveryOptionsResult: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SubscriptionDeliveryOptionsResult']>;
  SubscriptionDeliveryOptionsResultFailure: ResolverTypeWrapper<SubscriptionDeliveryOptionsResultFailure>;
  SubscriptionDeliveryOptionsResultSuccess: ResolverTypeWrapper<Omit<SubscriptionDeliveryOptionsResultSuccess, 'deliveryOptions'> & { deliveryOptions: Array<ResolversTypes['SubscriptionDeliveryOption']> }>;
  SubscriptionDeliveryPolicy: ResolverTypeWrapper<Omit<SubscriptionDeliveryPolicy, 'anchors'> & { anchors: Array<ResolversTypes['SubscriptionAnchor']> }>;
  ...
  TipSale: ResolverTypeWrapper<Omit<TipSale, 'lineItem'> & { lineItem: ResolversTypes['LineItem'] }>;
  ...
  UnfulfilledDigitalLineItemContainer: ResolverTypeWrapper<Omit<UnfulfilledDigitalLineItemContainer, 'lineItems'> & { lineItems: ResolversTypes['LineItemContainerLineItemConnection'] }>;
  UnfulfilledGiftCardLineItemContainer: ResolverTypeWrapper<Omit<UnfulfilledGiftCardLineItemContainer, 'lineItems'> & { lineItems: ResolversTypes['LineItemContainerLineItemConnection'] }>;
  UnfulfilledLineItemContainer: ResolverTypeWrapper<Omit<UnfulfilledLineItemContainer, 'lineItems'> & { lineItems: ResolversTypes['LineItemContainerLineItemConnection'] }>;
  UnfulfilledLineItemContainerCommonFields: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['UnfulfilledLineItemContainerCommonFields']>;
  UnfulfilledPhysicalLineItemContainer: ResolverTypeWrapper<Omit<UnfulfilledPhysicalLineItemContainer, 'lineItems'> & { lineItems: ResolversTypes['LineItemContainerLineItemConnection'] }>;
  ...
  WalletPaymentConfig: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['WalletPaymentConfig']>;
...
export type ResolversParentTypes = {
  ...
  ApplePayBillingAddressInput: ApplePayBillingAddressInput;
  ApplePayCreditCardAddPayload: Omit<ApplePayCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  ApplePayCreditCardUpdatePayload: Omit<ApplePayCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  ...
  BusinessContactUpdateInput: BusinessContactUpdateInput;
  BusinessContactUpdatePayload: Omit<BusinessContactUpdatePayload, 'businessContact'> & { businessContact?: Maybe<ResolversParentTypes['CompanyContact']> };
  BusinessCustomerUserError: BusinessCustomerUserError;
  BusinessLocationCreditCardAddPayload: Omit<BusinessLocationCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  BusinessLocationCreditCardUpdatePayload: Omit<BusinessLocationCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  BusinessLocationPaymentInstrumentRemovePayload: BusinessLocationPaymentInstrumentRemovePayload;
  BuyerExperienceConfiguration: Omit<BuyerExperienceConfiguration, 'deposit'> & { deposit?: Maybe<ResolversParentTypes['DepositConfiguration']> };
  CardPaymentDetails: CardPaymentDetails;
  Checkout: Omit<Checkout, 'appliedGiftCards' | 'discountApplications' | 'shippingDiscountAllocations'> & { appliedGiftCards: Array<ResolversParentTypes['AppliedGiftCard']>, discountApplications: ResolversParentTypes['DiscountApplicationConnection'], shippingDiscountAllocations: Array<ResolversParentTypes['DiscountAllocation']> };
  ...
  Company: Omit<Company, 'draftOrders' | 'locations' | 'orders' | 'profile'> & { draftOrders: ResolversParentTypes['DraftOrderConnection'], locations: ResolversParentTypes['CompanyLocationConnection'], orders: ResolversParentTypes['OrderConnection'], profile?: Maybe<ResolversParentTypes['CompanyContact']> };
  CompanyAddress: CompanyAddress;
  CompanyAddressInput: CompanyAddressInput;
  CompanyContact: Omit<CompanyContact, 'company' | 'customer' | 'draftOrders' | 'locations' | 'orders'> & { company?: Maybe<ResolversParentTypes['Company']>, customer: ResolversParentTypes['Customer'], draftOrders: ResolversParentTypes['DraftOrderConnection'], locations: ResolversParentTypes['CompanyLocationConnection'], orders: ResolversParentTypes['OrderConnection'] };
  CompanyContactConnection: Omit<CompanyContactConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['CompanyContactEdge']>, nodes: Array<ResolversParentTypes['CompanyContact']> };
  CompanyContactEdge: Omit<CompanyContactEdge, 'node'> & { node: ResolversParentTypes['CompanyContact'] };
  CompanyContactRole: CompanyContactRole;
  CompanyContactRoleAssignment: Omit<CompanyContactRoleAssignment, 'contact'> & { contact: ResolversParentTypes['CompanyContact'] };
  ...
  CompanyLocation: Omit<CompanyLocation, 'billingAddress' | 'buyerExperienceConfiguration' | 'contacts' | 'creditCard' | 'draftOrders' | 'orders' | 'shippingAddress'> & { billingAddress?: Maybe<ResolversParentTypes['CompanyAddress']>, buyerExperienceConfiguration?: Maybe<ResolversParentTypes['BuyerExperienceConfiguration']>, contacts: ResolversParentTypes['CompanyContactConnection'], creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']>, draftOrders: ResolversParentTypes['DraftOrderConnection'], orders: ResolversParentTypes['OrderConnection'], shippingAddress?: Maybe<ResolversParentTypes['CompanyAddress']> };
  CompanyLocationAssignAddressPayload: Omit<CompanyLocationAssignAddressPayload, 'addresses'> & { addresses?: Maybe<Array<ResolversParentTypes['CompanyAddress']>> };
  CompanyLocationConnection: Omit<CompanyLocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['CompanyLocationEdge']>, nodes: Array<ResolversParentTypes['CompanyLocation']> };
  CompanyLocationEdge: Omit<CompanyLocationEdge, 'node'> & { node: ResolversParentTypes['CompanyLocation'] };
  Count: Count;
  CreditCardAddPayload: Omit<CreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  CreditCardUpdatePayload: Omit<CreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  Customer: Omit<Customer, 'availableWalletPaymentConfigs' | 'companyContacts' | 'creditCard' | 'defaultAddress' | 'draftOrders' | 'lastIncompleteCheckout' | 'orders' | 'paypalBillingAgreement' | 'return' | 'storeCreditAccounts' | 'subscriptionContract' | 'subscriptionContracts'> & { availableWalletPaymentConfigs: Array<ResolversParentTypes['WalletPaymentConfig']>, companyContacts: ResolversParentTypes['CompanyContactConnection'], creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']>, defaultAddress?: Maybe<ResolversParentTypes['CustomerAddress']>, draftOrders: ResolversParentTypes['DraftOrderConnection'], lastIncompleteCheckout?: Maybe<ResolversParentTypes['Checkout']>, orders: ResolversParentTypes['OrderConnection'], paypalBillingAgreement?: Maybe<ResolversParentTypes['PaypalBillingAgreement']>, return?: Maybe<ResolversParentTypes['Return']>, storeCreditAccounts: ResolversParentTypes['StoreCreditAccountConnection'], subscriptionContract?: Maybe<ResolversParentTypes['SubscriptionContract']>, subscriptionContracts: ResolversParentTypes['SubscriptionContractConnection'] };
  CustomerAddress: CustomerAddress;
  CustomerAddressConnection: Omit<CustomerAddressConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['CustomerAddress']> };
  CustomerAddressCreatePayload: Omit<CustomerAddressCreatePayload, 'customerAddress'> & { customerAddress?: Maybe<ResolversParentTypes['CustomerAddress']> };
  CustomerAddressDeletePayload: CustomerAddressDeletePayload;
  CustomerAddressEdge: Omit<CustomerAddressEdge, 'node'> & { node: ResolversParentTypes['CustomerAddress'] };
  CustomerAddressInput: CustomerAddressInput;
  CustomerAddressUpdatePayload: Omit<CustomerAddressUpdatePayload, 'customerAddress'> & { customerAddress?: Maybe<ResolversParentTypes['CustomerAddress']> };
  CustomerCreditCard: Omit<CustomerCreditCard, 'billingAddress' | 'openDraftOrders' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<ResolversParentTypes['PaymentInstrumentBillingAddress']>, openDraftOrders: ResolversParentTypes['DraftOrderConnection'], pendingOrders: ResolversParentTypes['OrderConnection'], subscriptionContracts: ResolversParentTypes['SubscriptionContractConnection'] };
  CustomerCreditCardConnection: Omit<CustomerCreditCardConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['CustomerCreditCard']> };
  CustomerCreditCardEdge: Omit<CustomerCreditCardEdge, 'node'> & { node: ResolversParentTypes['CustomerCreditCard'] };
  ...
  CustomerUpdateInput: CustomerUpdateInput;
  CustomerUpdatePayload: Omit<CustomerUpdatePayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  DateTime: Scalars['DateTime']['output'];
  Decimal: Scalars['Decimal']['output'];
  DepositConfiguration: ResolversUnionTypes<ResolversParentTypes>['DepositConfiguration'];
  DepositPercentage: DepositPercentage;
  DiscountAllocation: Omit<DiscountAllocation, 'discountApplication'> & { discountApplication: ResolversParentTypes['DiscountApplication'] };
  DiscountApplication: ResolversInterfaceTypes<ResolversParentTypes>['DiscountApplication'];
  DiscountApplicationConnection: Omit<DiscountApplicationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['DiscountApplicationEdge']>, nodes: Array<ResolversParentTypes['DiscountApplication']> };
  DiscountApplicationEdge: Omit<DiscountApplicationEdge, 'node'> & { node: ResolversParentTypes['DiscountApplication'] };
  ...
  Domain: Domain;
  DraftOrder: Omit<DraftOrder, 'billingAddress' | 'customer' | 'order' | 'purchasingEntity' | 'shippingAddress'> & { billingAddress?: Maybe<ResolversParentTypes['CustomerAddress']>, customer?: Maybe<ResolversParentTypes['Customer']>, order?: Maybe<ResolversParentTypes['Order']>, purchasingEntity?: Maybe<ResolversParentTypes['PurchasingEntity']>, shippingAddress?: Maybe<ResolversParentTypes['CustomerAddress']> };
  DraftOrderAppliedDiscount: DraftOrderAppliedDiscount;
  DraftOrderConnection: Omit<DraftOrderConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['DraftOrderEdge']>, nodes: Array<ResolversParentTypes['DraftOrder']> };
  DraftOrderDiscountInformation: DraftOrderDiscountInformation;
  DraftOrderEdge: Omit<DraftOrderEdge, 'node'> & { node: ResolversParentTypes['DraftOrder'] };
  ...
  Fulfillment: Omit<Fulfillment, 'fulfillmentLineItems'> & { fulfillmentLineItems: ResolversParentTypes['FulfillmentLineItemConnection'] };
  FulfillmentConnection: Omit<FulfillmentConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['FulfillmentEdge']>, nodes: Array<ResolversParentTypes['Fulfillment']> };
  FulfillmentEdge: Omit<FulfillmentEdge, 'node'> & { node: ResolversParentTypes['Fulfillment'] };
  ...
  FulfillmentLineItem: Omit<FulfillmentLineItem, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  FulfillmentLineItemConnection: Omit<FulfillmentLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['FulfillmentLineItemEdge']>, nodes: Array<ResolversParentTypes['FulfillmentLineItem']> };
  FulfillmentLineItemEdge: Omit<FulfillmentLineItemEdge, 'node'> & { node: ResolversParentTypes['FulfillmentLineItem'] };
  GiftCardDetails: GiftCardDetails;
  GiftCardSale: Omit<GiftCardSale, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  GooglePayBillingAddressInput: GooglePayBillingAddressInput;
  GooglePayCreditCardAddPayload: Omit<GooglePayCreditCardAddPayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  GooglePayCreditCardUpdatePayload: Omit<GooglePayCreditCardUpdatePayload, 'creditCard'> & { creditCard?: Maybe<ResolversParentTypes['CustomerCreditCard']> };
  ...
  LineItem: Omit<LineItem, 'discountAllocations'> & { discountAllocations: Array<ResolversParentTypes['DiscountAllocation']> };
  LineItemConnection: Omit<LineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['LineItemEdge']>, nodes: Array<ResolversParentTypes['LineItem']> };
  LineItemContainer: ResolversUnionTypes<ResolversParentTypes>['LineItemContainer'];
  LineItemContainerLineItem: Omit<LineItemContainerLineItem, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  LineItemContainerLineItemConnection: Omit<LineItemContainerLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['LineItemContainerLineItemEdge']>, nodes: Array<ResolversParentTypes['LineItemContainerLineItem']> };
  LineItemContainerLineItemEdge: Omit<LineItemContainerLineItemEdge, 'node'> & { node: ResolversParentTypes['LineItemContainerLineItem'] };
  LineItemDiscountInformation: LineItemDiscountInformation;
  LineItemEdge: Omit<LineItemEdge, 'node'> & { node: ResolversParentTypes['LineItem'] };
  ...
  Order: Omit<Order, 'agreements' | 'billingAddress' | 'customer' | 'discountApplications' | 'draftOrder' | 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'purchasingEntity' | 'return' | 'returns' | 'shippingAddress' | 'shippingDiscountAllocations' | 'subscriptionContracts' | 'transactions'> & { agreements: ResolversParentTypes['SalesAgreementConnection'], billingAddress?: Maybe<ResolversParentTypes['CustomerAddress']>, customer?: Maybe<ResolversParentTypes['Customer']>, discountApplications: ResolversParentTypes['DiscountApplicationConnection'], draftOrder?: Maybe<ResolversParentTypes['DraftOrder']>, editSummary?: Maybe<ResolversParentTypes['OrderEditSummary']>, fulfillments: ResolversParentTypes['FulfillmentConnection'], lineItemContainers: Array<ResolversParentTypes['LineItemContainer']>, lineItems: ResolversParentTypes['LineItemConnection'], purchasingEntity?: Maybe<ResolversParentTypes['PurchasingEntity']>, return?: Maybe<ResolversParentTypes['Return']>, returns: ResolversParentTypes['ReturnConnection'], shippingAddress?: Maybe<ResolversParentTypes['CustomerAddress']>, shippingDiscountAllocations: Array<ResolversParentTypes['DiscountAllocation']>, subscriptionContracts?: Maybe<ResolversParentTypes['SubscriptionContractConnection']>, transactions: Array<ResolversParentTypes['OrderTransaction']> };
  OrderAgreement: Omit<OrderAgreement, 'order' | 'sales'> & { order: ResolversParentTypes['Order'], sales: ResolversParentTypes['SaleConnection'] };
  OrderAllDiscounts: OrderAllDiscounts;
  OrderConnection: Omit<OrderConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['OrderEdge']>, nodes: Array<ResolversParentTypes['Order']> };
  ...
  OrderEditAgreement: Omit<OrderEditAgreement, 'sales'> & { sales: ResolversParentTypes['SaleConnection'] };
  OrderEditSummary: Omit<OrderEditSummary, 'changes'> & { changes: Array<ResolversParentTypes['OrderEditSummaryChange']> };
  OrderEditSummaryChange: Omit<OrderEditSummaryChange, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  ...
  OrderRequestReturnPayload: Omit<OrderRequestReturnPayload, 'return'> & { return?: Maybe<ResolversParentTypes['Return']> };
  OrderShippingLineGroup: OrderShippingLineGroup;
  OrderSoldInformation: OrderSoldInformation;
  OrderTransaction: Omit<OrderTransaction, 'giftCardDetails' | 'paymentDetails'> & { giftCardDetails?: Maybe<ResolversParentTypes['GiftCardDetails']>, paymentDetails?: Maybe<ResolversParentTypes['PaymentDetails']> };
  PageInfo: PageInfo;
  ...
  PaypalAccountEnablePayload: Omit<PaypalAccountEnablePayload, 'paypalBillingAgreement'> & { paypalBillingAgreement?: Maybe<ResolversParentTypes['PaypalBillingAgreement']> };
  PaypalBillingAgreement: Omit<PaypalBillingAgreement, 'billingAddress' | 'pendingOrders' | 'subscriptionContracts'> & { billingAddress?: Maybe<ResolversParentTypes['PaymentInstrumentBillingAddress']>, pendingOrders: ResolversParentTypes['OrderConnection'], subscriptionContracts: ResolversParentTypes['SubscriptionContractConnection'] };
  ...
  ProductSale: Omit<ProductSale, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  PublicOrder: Omit<PublicOrder, 'editSummary' | 'fulfillments' | 'lineItemContainers' | 'lineItems' | 'return' | 'returns' | 'transactions'> & { editSummary?: Maybe<ResolversParentTypes['OrderEditSummary']>, fulfillments: ResolversParentTypes['FulfillmentConnection'], lineItemContainers: Array<ResolversParentTypes['LineItemContainer']>, lineItems: ResolversParentTypes['LineItemConnection'], return?: Maybe<ResolversParentTypes['Return']>, returns: ResolversParentTypes['ReturnConnection'], transactions: Array<ResolversParentTypes['OrderTransaction']> };
  PurchasingCompany: Omit<PurchasingCompany, 'company' | 'contact' | 'location'> & { company: ResolversParentTypes['Company'], contact?: Maybe<ResolversParentTypes['CompanyContact']>, location: ResolversParentTypes['CompanyLocation'] };
  PurchasingEntity: ResolversUnionTypes<ResolversParentTypes>['PurchasingEntity'];
  QueryRoot: {};
  Refund: Refund;
  RefundAgreement: Omit<RefundAgreement, 'sales'> & { sales: ResolversParentTypes['SaleConnection'] };
  RemainingLineItemContainer: Omit<RemainingLineItemContainer, 'lineItems'> & { lineItems: ResolversParentTypes['RemainingLineItemContainerLineItemConnection'] };
  RemainingLineItemContainerLineItem: Omit<RemainingLineItemContainerLineItem, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  RemainingLineItemContainerLineItemConnection: Omit<RemainingLineItemContainerLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['RemainingLineItemContainerLineItemEdge']>, nodes: Array<ResolversParentTypes['RemainingLineItemContainerLineItem']> };
  RemainingLineItemContainerLineItemEdge: Omit<RemainingLineItemContainerLineItemEdge, 'node'> & { node: ResolversParentTypes['RemainingLineItemContainerLineItem'] };
  RequestedLineItemInput: RequestedLineItemInput;
  ResendGiftCardPayload: ResendGiftCardPayload;
  ResourcePermission: ResourcePermission;
  Return: Omit<Return, 'decline' | 'returnLineItems' | 'reverseDeliveries'> & { decline?: Maybe<ResolversParentTypes['ReturnDecline']>, returnLineItems: ResolversParentTypes['ReturnLineItemConnection'], reverseDeliveries: ResolversParentTypes['ReverseDeliveryConnection'] };
  ReturnAgreement: Omit<ReturnAgreement, 'return' | 'sales'> & { return: ResolversParentTypes['Return'], sales: ResolversParentTypes['SaleConnection'] };
  ReturnConnection: Omit<ReturnConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['ReturnEdge']>, nodes: Array<ResolversParentTypes['Return']> };
  ReturnDecline: ReturnDecline;
  ReturnEdge: Omit<ReturnEdge, 'node'> & { node: ResolversParentTypes['Return'] };
  ReturnLineItem: Omit<ReturnLineItem, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  ReturnLineItemConnection: Omit<ReturnLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['ReturnLineItemEdge']>, nodes: Array<ResolversParentTypes['ReturnLineItem']> };
  ReturnLineItemEdge: Omit<ReturnLineItemEdge, 'node'> & { node: ResolversParentTypes['ReturnLineItem'] };
  ReturnSupportedReason: ReturnSupportedReason;
  ReturnUserError: ReturnUserError;
  ReverseDelivery: Omit<ReverseDelivery, 'deliverable'> & { deliverable?: Maybe<ResolversParentTypes['ReverseDeliveryDeliverable']> };
  ReverseDeliveryConnection: Omit<ReverseDeliveryConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['ReverseDeliveryEdge']>, nodes: Array<ResolversParentTypes['ReverseDelivery']> };
  ReverseDeliveryDeliverable: ResolversUnionTypes<ResolversParentTypes>['ReverseDeliveryDeliverable'];
  ReverseDeliveryEdge: Omit<ReverseDeliveryEdge, 'node'> & { node: ResolversParentTypes['ReverseDelivery'] };
  ...
  SaleConnection: Omit<SaleConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SaleEdge']>, nodes: Array<ResolversParentTypes['Sale']> };
  ...
  SalesAgreementConnection: Omit<SalesAgreementConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SalesAgreementEdge']>, nodes: Array<ResolversParentTypes['SalesAgreement']> };
  SalesAgreementEdge: Omit<SalesAgreementEdge, 'node'> & { node: ResolversParentTypes['SalesAgreement'] };
  ...
  StoreCreditAccount: Omit<StoreCreditAccount, 'transactions'> & { transactions: ResolversParentTypes['StoreCreditAccountTransactionConnection'] };
  StoreCreditAccountConnection: Omit<StoreCreditAccountConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['StoreCreditAccountEdge']>, nodes: Array<ResolversParentTypes['StoreCreditAccount']> };
  StoreCreditAccountCreditTransaction: Omit<StoreCreditAccountCreditTransaction, 'account'> & { account: ResolversParentTypes['StoreCreditAccount'] };
  StoreCreditAccountDebitRevertTransaction: Omit<StoreCreditAccountDebitRevertTransaction, 'account' | 'debitTransaction'> & { account: ResolversParentTypes['StoreCreditAccount'], debitTransaction: ResolversParentTypes['StoreCreditAccountDebitTransaction'] };
  StoreCreditAccountDebitTransaction: Omit<StoreCreditAccountDebitTransaction, 'account'> & { account: ResolversParentTypes['StoreCreditAccount'] };
  StoreCreditAccountEdge: Omit<StoreCreditAccountEdge, 'node'> & { node: ResolversParentTypes['StoreCreditAccount'] };
  StoreCreditAccountExpirationTransaction: Omit<StoreCreditAccountExpirationTransaction, 'account' | 'creditTransaction'> & { account: ResolversParentTypes['StoreCreditAccount'], creditTransaction: ResolversParentTypes['StoreCreditAccountCreditTransaction'] };
  StoreCreditAccountTransaction: ResolversInterfaceTypes<ResolversParentTypes>['StoreCreditAccountTransaction'];
  StoreCreditAccountTransactionConnection: Omit<StoreCreditAccountTransactionConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['StoreCreditAccountTransactionEdge']>, nodes: Array<ResolversParentTypes['StoreCreditAccountTransaction']> };
  StoreCreditAccountTransactionEdge: Omit<StoreCreditAccountTransactionEdge, 'node'> & { node: ResolversParentTypes['StoreCreditAccountTransaction'] };
  ...
  SubscriptionBillingPolicy: Omit<SubscriptionBillingPolicy, 'anchors'> & { anchors: Array<ResolversParentTypes['SubscriptionAnchor']> };
  SubscriptionContract: Omit<SubscriptionContract, 'billingPolicy' | 'deliveryMethod' | 'deliveryPolicy' | 'orders' | 'originOrder' | 'paymentInstrument'> & { billingPolicy: ResolversParentTypes['SubscriptionBillingPolicy'], deliveryMethod?: Maybe<ResolversParentTypes['SubscriptionDeliveryMethod']>, deliveryPolicy: ResolversParentTypes['SubscriptionDeliveryPolicy'], orders: ResolversParentTypes['OrderConnection'], originOrder?: Maybe<ResolversParentTypes['Order']>, paymentInstrument?: Maybe<ResolversParentTypes['PaymentInstrument']> };
  SubscriptionContractActivatePayload: Omit<SubscriptionContractActivatePayload, 'contract'> & { contract?: Maybe<ResolversParentTypes['SubscriptionContract']> };
  SubscriptionContractBase: ResolversInterfaceTypes<ResolversParentTypes>['SubscriptionContractBase'];
  SubscriptionContractCancelPayload: Omit<SubscriptionContractCancelPayload, 'contract'> & { contract?: Maybe<ResolversParentTypes['SubscriptionContract']> };
  SubscriptionContractChangePaymentInstrumentPayload: Omit<SubscriptionContractChangePaymentInstrumentPayload, 'contract'> & { contract?: Maybe<ResolversParentTypes['SubscriptionContract']> };
  SubscriptionContractConnection: Omit<SubscriptionContractConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SubscriptionContractEdge']>, nodes: Array<ResolversParentTypes['SubscriptionContract']> };
  SubscriptionContractEdge: Omit<SubscriptionContractEdge, 'node'> & { node: ResolversParentTypes['SubscriptionContract'] };
  SubscriptionContractFetchDeliveryOptionsPayload: Omit<SubscriptionContractFetchDeliveryOptionsPayload, 'deliveryOptionsResult'> & { deliveryOptionsResult?: Maybe<ResolversParentTypes['SubscriptionDeliveryOptionsResult']> };
  SubscriptionContractPausePayload: Omit<SubscriptionContractPausePayload, 'contract'> & { contract?: Maybe<ResolversParentTypes['SubscriptionContract']> };
  SubscriptionContractSelectDeliveryMethodPayload: Omit<SubscriptionContractSelectDeliveryMethodPayload, 'contract'> & { contract?: Maybe<ResolversParentTypes['SubscriptionContract']> };
  ...
  SubscriptionDeliveryOptionsResultSuccess: Omit<SubscriptionDeliveryOptionsResultSuccess, 'deliveryOptions'> & { deliveryOptions: Array<ResolversParentTypes['SubscriptionDeliveryOption']> };
  SubscriptionDeliveryPolicy: Omit<SubscriptionDeliveryPolicy, 'anchors'> & { anchors: Array<ResolversParentTypes['SubscriptionAnchor']> };
  ...
  TipSale: Omit<TipSale, 'lineItem'> & { lineItem: ResolversParentTypes['LineItem'] };
  ...
  UnfulfilledDigitalLineItemContainer: Omit<UnfulfilledDigitalLineItemContainer, 'lineItems'> & { lineItems: ResolversParentTypes['LineItemContainerLineItemConnection'] };
  UnfulfilledGiftCardLineItemContainer: Omit<UnfulfilledGiftCardLineItemContainer, 'lineItems'> & { lineItems: ResolversParentTypes['LineItemContainerLineItemConnection'] };
  UnfulfilledLineItemContainer: Omit<UnfulfilledLineItemContainer, 'lineItems'> & { lineItems: ResolversParentTypes['LineItemContainerLineItemConnection'] };
  ...
  UnfulfilledPhysicalLineItemContainer: Omit<UnfulfilledPhysicalLineItemContainer, 'lineItems'> & { lineItems: ResolversParentTypes['LineItemContainerLineItemConnection'] };
  UnitPrice: UnitPrice;
...
export type AdditionalFeeSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['AdditionalFeeSale'] = ResolversParentTypes['AdditionalFeeSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  ...
  totalDiscountAmountAfterTaxes?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalDiscountAmountBeforeTaxes?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalTaxAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AddressFormFieldResolvers<ContextType = any, ParentType extends ResolversParentTypes['AddressFormField'] = ResolversParentTypes['AddressFormField']> = {
  mode?: Resolver<ResolversTypes['AddressFormFieldMode'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AddressFormSettingsResolvers<ContextType = any, ParentType extends ResolversParentTypes['AddressFormSettings'] = ResolversParentTypes['AddressFormSettings']> = {
  address2?: Resolver<ResolversTypes['AddressFormField'], ParentType, ContextType>;
  addressAutocompletion?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  company?: Resolver<ResolversTypes['AddressFormField'], ParentType, ContextType>;
  firstName?: Resolver<ResolversTypes['AddressFormField'], ParentType, ContextType>;
  phone?: Resolver<ResolversTypes['AddressFormField'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AdjustmentSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['AdjustmentSale'] = ResolversParentTypes['AdjustmentSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type ApplePayCreditCardAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApplePayCreditCardAddPayload'] = ResolversParentTypes['ApplePayCreditCardAddPayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ApplePayCreditCardUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApplePayCreditCardUpdatePayload'] = ResolversParentTypes['ApplePayCreditCardUpdatePayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ApplePaySessionCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApplePaySessionCreatePayload'] = ResolversParentTypes['ApplePaySessionCreatePayload']> = {
  body?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ready?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['ApplePaySessionUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ApplePaySessionUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApplePaySessionUserError'] = ResolversParentTypes['ApplePaySessionUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['ApplePaySessionUserErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ApplePayWalletConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['ApplePayWalletConfig'] = ResolversParentTypes['ApplePayWalletConfig']> = {
  supportedNetworks?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type BusinessContactUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['BusinessContactUpdatePayload'] = ResolversParentTypes['BusinessContactUpdatePayload']> = {
  businessContact?: Resolver<Maybe<ResolversTypes['CompanyContact']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsBusinessContactUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BusinessCustomerUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['BusinessCustomerUserError'] = ResolversParentTypes['BusinessCustomerUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['BusinessCustomerErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BusinessLocationCreditCardAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['BusinessLocationCreditCardAddPayload'] = ResolversParentTypes['BusinessLocationCreditCardAddPayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  nextActionUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BusinessLocationCreditCardUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['BusinessLocationCreditCardUpdatePayload'] = ResolversParentTypes['BusinessLocationCreditCardUpdatePayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type BusinessLocationPaymentInstrumentRemovePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['BusinessLocationPaymentInstrumentRemovePayload'] = ResolversParentTypes['BusinessLocationPaymentInstrumentRemovePayload']> = {
  deletedPaymentInstrumentId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BuyerExperienceConfigurationResolvers<ContextType = any, ParentType extends ResolversParentTypes['BuyerExperienceConfiguration'] = ResolversParentTypes['BuyerExperienceConfiguration']> = {
  deposit?: Resolver<Maybe<ResolversTypes['DepositConfiguration']>, ParentType, ContextType>;
  payNowOnly?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  paymentTermsTemplate?: Resolver<Maybe<ResolversTypes['PaymentTermsTemplate']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CardPaymentDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['CardPaymentDetails'] = ResolversParentTypes['CardPaymentDetails']> = {
...
export type CheckoutResolvers<ContextType = any, ParentType extends ResolversParentTypes['Checkout'] = ResolversParentTypes['Checkout']> = {
  ...
  shippingAddress?: Resolver<Maybe<ResolversTypes['CustomerMailingAddress']>, ParentType, ContextType>;
  ...
  shopPayConfiguration?: Resolver<Maybe<ResolversTypes['ShopPayConfiguration']>, ParentType, ContextType>;
...
export type CheckoutLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CheckoutLineItemConnection'] = ResolversParentTypes['CheckoutLineItemConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['CheckoutLineItem']>, ParentType, ContextType>;
...
export type CompanyResolvers<ContextType = any, ParentType extends ResolversParentTypes['Company'] = ResolversParentTypes['Company']> = {
  draftOrders?: Resolver<ResolversTypes['DraftOrderConnection'], ParentType, ContextType, RequireFields<CompanyDraftOrdersArgs, 'reverse' | 'sortKey'>>;
  externalId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  locations?: Resolver<ResolversTypes['CompanyLocationConnection'], ParentType, ContextType, RequireFields<CompanyLocationsArgs, 'reverse' | 'sortKey'>>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CompanyMetafieldArgs, 'key' | 'namespace'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<CompanyMetafieldsArgs, 'identifiers'>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<CompanyOrdersArgs, 'reverse' | 'sortKey'>>;
  profile?: Resolver<Maybe<ResolversTypes['CompanyContact']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CompanyAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyAddress'] = ResolversParentTypes['CompanyAddress']> = {
  ...
  countryCodeV2?: Resolver<ResolversTypes['CountryCode'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  firstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  formatted?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<CompanyAddressFormattedArgs, 'withCompanyName' | 'withName'>>;
  formattedAddress?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<CompanyAddressFormattedAddressArgs, 'withCompanyName' | 'withName'>>;
...
export type CompanyContactResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContact'] = ResolversParentTypes['CompanyContact']> = {
  company?: Resolver<Maybe<ResolversTypes['Company']>, ParentType, ContextType>;
  customer?: Resolver<ResolversTypes['Customer'], ParentType, ContextType>;
  draftOrders?: Resolver<ResolversTypes['DraftOrderConnection'], ParentType, ContextType, RequireFields<CompanyContactDraftOrdersArgs, 'reverse' | 'sortKey'>>;
  hasPermissionOnLocations?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<CompanyContactHasPermissionOnLocationsArgs, 'permissions' | 'resource' | 'scope'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  locations?: Resolver<ResolversTypes['CompanyLocationConnection'], ParentType, ContextType, RequireFields<CompanyContactLocationsArgs, 'reverse' | 'sortKey'>>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<CompanyContactOrdersArgs, 'reverse' | 'sortKey'>>;
  status?: Resolver<ResolversTypes['CompanyContactStatusType'], ParentType, ContextType>;
  taxExemptionsDetails?: Resolver<Array<ResolversTypes['TaxExemptionDetails']>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactConnection'] = ResolversParentTypes['CompanyContactConnection']> = {
  edges?: Resolver<Array<ResolversTypes['CompanyContactEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['CompanyContact']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactEdge'] = ResolversParentTypes['CompanyContactEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['CompanyContact'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactRoleResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactRole'] = ResolversParentTypes['CompanyContactRole']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  resourcePermission?: Resolver<Array<ResolversTypes['PermittedOperation']>, ParentType, ContextType, RequireFields<CompanyContactRoleResourcePermissionArgs, 'resource'>>;
  resourcePermissions?: Resolver<Array<ResolversTypes['ResourcePermission']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactRoleAssignmentResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactRoleAssignment'] = ResolversParentTypes['CompanyContactRoleAssignment']> = {
  contact?: Resolver<ResolversTypes['CompanyContact'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  role?: Resolver<ResolversTypes['CompanyContactRole'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactRoleAssignmentConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactRoleAssignmentConnection'] = ResolversParentTypes['CompanyContactRoleAssignmentConnection']> = {
  edges?: Resolver<Array<ResolversTypes['CompanyContactRoleAssignmentEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['CompanyContactRoleAssignment']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyContactRoleAssignmentEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyContactRoleAssignmentEdge'] = ResolversParentTypes['CompanyContactRoleAssignmentEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['CompanyContactRoleAssignment'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyLocation'] = ResolversParentTypes['CompanyLocation']> = {
  billingAddress?: Resolver<Maybe<ResolversTypes['CompanyAddress']>, ParentType, ContextType>;
  buyerExperienceConfiguration?: Resolver<Maybe<ResolversTypes['BuyerExperienceConfiguration']>, ParentType, ContextType>;
  contacts?: Resolver<ResolversTypes['CompanyContactConnection'], ParentType, ContextType, RequireFields<CompanyLocationContactsArgs, 'reverse' | 'sortKey'>>;
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType, RequireFields<CompanyLocationCreditCardArgs, 'id'>>;
  creditCards?: Resolver<ResolversTypes['CustomerCreditCardConnection'], ParentType, ContextType, RequireFields<CompanyLocationCreditCardsArgs, 'reverse'>>;
  draftOrders?: Resolver<ResolversTypes['DraftOrderConnection'], ParentType, ContextType, RequireFields<CompanyLocationDraftOrdersArgs, 'reverse' | 'sortKey'>>;
  externalId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  market?: Resolver<ResolversTypes['Market'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CompanyLocationMetafieldArgs, 'key' | 'namespace'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<CompanyLocationMetafieldsArgs, 'identifiers'>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<CompanyLocationOrdersArgs, 'reverse' | 'sortKey'>>;
  roleAssignments?: Resolver<ResolversTypes['CompanyContactRoleAssignmentConnection'], ParentType, ContextType, RequireFields<CompanyLocationRoleAssignmentsArgs, 'reverse' | 'sortKey'>>;
  shippingAddress?: Resolver<Maybe<ResolversTypes['CompanyAddress']>, ParentType, ContextType>;
  taxExemptions?: Resolver<Array<ResolversTypes['TaxExemption']>, ParentType, ContextType>;
  taxExemptionsDetails?: Resolver<Array<ResolversTypes['TaxExemptionDetails']>, ParentType, ContextType>;
  taxIdentifier?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyLocationAssignAddressPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyLocationAssignAddressPayload'] = ResolversParentTypes['CompanyLocationAssignAddressPayload']> = {
  addresses?: Resolver<Maybe<Array<ResolversTypes['CompanyAddress']>>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['BusinessCustomerUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyLocationConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyLocationConnection'] = ResolversParentTypes['CompanyLocationConnection']> = {
  edges?: Resolver<Array<ResolversTypes['CompanyLocationEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['CompanyLocation']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompanyLocationEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyLocationEdge'] = ResolversParentTypes['CompanyLocationEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type CountResolvers<ContextType = any, ParentType extends ResolversParentTypes['Count'] = ResolversParentTypes['Count']> = {
  ...
  precision?: Resolver<ResolversTypes['CountPrecision'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CreditCardAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreditCardAddPayload'] = ResolversParentTypes['CreditCardAddPayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  nextActionUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
...
export type CreditCardUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CreditCardUpdatePayload'] = ResolversParentTypes['CreditCardUpdatePayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CustomerResolvers<ContextType = any, ParentType extends ResolversParentTypes['Customer'] = ResolversParentTypes['Customer']> = {
  addresses?: Resolver<ResolversTypes['CustomerAddressConnection'], ParentType, ContextType, RequireFields<CustomerAddressesArgs, 'reverse' | 'skipDefault'>>;
  availableWalletPaymentConfigs?: Resolver<Array<ResolversTypes['WalletPaymentConfig']>, ParentType, ContextType>;
  companyContacts?: Resolver<ResolversTypes['CompanyContactConnection'], ParentType, ContextType, RequireFields<CustomerCompanyContactsArgs, 'reverse'>>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creationDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType, RequireFields<CustomerCreditCardArgs, 'id'>>;
  creditCards?: Resolver<ResolversTypes['CustomerCreditCardConnection'], ParentType, ContextType, RequireFields<CustomerCreditCardsArgs, 'reverse'>>;
  defaultAddress?: Resolver<Maybe<ResolversTypes['CustomerAddress']>, ParentType, ContextType>;
  displayName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  draftOrders?: Resolver<ResolversTypes['DraftOrderConnection'], ParentType, ContextType, RequireFields<CustomerDraftOrdersArgs, 'reverse' | 'sortKey'>>;
  ...
  lastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CustomerMetafieldArgs, 'key' | 'namespace'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<CustomerMetafieldsArgs, 'identifiers'>>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<CustomerOrdersArgs, 'reverse' | 'sortKey'>>;
  paypalBillingAgreement?: Resolver<Maybe<ResolversTypes['PaypalBillingAgreement']>, ParentType, ContextType>;
  phoneNumber?: Resolver<Maybe<ResolversTypes['CustomerPhoneNumber']>, ParentType, ContextType>;
  return?: Resolver<Maybe<ResolversTypes['Return']>, ParentType, ContextType, RequireFields<CustomerReturnArgs, 'id'>>;
  storeCreditAccounts?: Resolver<ResolversTypes['StoreCreditAccountConnection'], ParentType, ContextType, Partial<CustomerStoreCreditAccountsArgs>>;
  subscriptionContract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType, RequireFields<CustomerSubscriptionContractArgs, 'id'>>;
  subscriptionContracts?: Resolver<ResolversTypes['SubscriptionContractConnection'], ParentType, ContextType, RequireFields<CustomerSubscriptionContractsArgs, 'reverse' | 'sortKey'>>;
...
export type CustomerAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerAddress'] = ResolversParentTypes['CustomerAddress']> = {
  ...
  country?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  firstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  formatted?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<CustomerAddressFormattedArgs, 'withCompany' | 'withName'>>;
  formattedArea?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  province?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  territoryCode?: Resolver<Maybe<ResolversTypes['CountryCode']>, ParentType, ContextType>;
  zip?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  zoneCode?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CustomerAddressCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerAddressCreatePayload'] = ResolversParentTypes['CustomerAddressCreatePayload']> = {
  ...
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsCustomerAddressUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CustomerCreditCardResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerCreditCard'] = ResolversParentTypes['CustomerCreditCard']> = {
  billingAddress?: Resolver<Maybe<ResolversTypes['PaymentInstrumentBillingAddress']>, ParentType, ContextType>;
  ...
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  openDraftOrders?: Resolver<ResolversTypes['DraftOrderConnection'], ParentType, ContextType, RequireFields<CustomerCreditCardOpenDraftOrdersArgs, 'reverse'>>;
  pendingOrders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<CustomerCreditCardPendingOrdersArgs, 'reverse'>>;
  permissionToShowAtCheckout?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  subscriptionContracts?: Resolver<ResolversTypes['SubscriptionContractConnection'], ParentType, ContextType, RequireFields<CustomerCreditCardSubscriptionContractsArgs, 'reverse' | 'sortKey'>>;
  virtualLastDigits?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  walletType?: Resolver<Maybe<ResolversTypes['PaymentInstrumentWalletType']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerCreditCardConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerCreditCardConnection'] = ResolversParentTypes['CustomerCreditCardConnection']> = {
  edges?: Resolver<Array<ResolversTypes['CustomerCreditCardEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerCreditCardEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerCreditCardEdge'] = ResolversParentTypes['CustomerCreditCardEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['CustomerCreditCard'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerEmailAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerEmailAddress'] = ResolversParentTypes['CustomerEmailAddress']> = {
  emailAddress?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  marketingState?: Resolver<ResolversTypes['EmailMarketingState'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerEmailMarketingOptInPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerEmailMarketingOptInPayload'] = ResolversParentTypes['CustomerEmailMarketingOptInPayload']> = {
  customerEmailAddress?: Resolver<Maybe<ResolversTypes['CustomerEmailAddress']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsCustomerEmailMarketingOptInUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerEmailMarketingSubscribePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerEmailMarketingSubscribePayload'] = ResolversParentTypes['CustomerEmailMarketingSubscribePayload']> = {
  emailAddress?: Resolver<Maybe<ResolversTypes['CustomerEmailAddress']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsCustomerEmailMarketingUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerEmailMarketingUnsubscribePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerEmailMarketingUnsubscribePayload'] = ResolversParentTypes['CustomerEmailMarketingUnsubscribePayload']> = {
  emailAddress?: Resolver<Maybe<ResolversTypes['CustomerEmailAddress']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsCustomerEmailMarketingUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CustomerMailingAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerMailingAddress'] = ResolversParentTypes['CustomerMailingAddress']> = {
  address1?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  address2?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  company?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  firstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  formatted?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<CustomerMailingAddressFormattedArgs, 'withCompany' | 'withName'>>;
  formattedArea?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  latitude?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type CustomerPhoneNumberResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerPhoneNumber'] = ResolversParentTypes['CustomerPhoneNumber']> = {
  marketingState?: Resolver<ResolversTypes['SmsMarketingState'], ParentType, ContextType>;
...
export type CustomerUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CustomerUpdatePayload'] = ResolversParentTypes['CustomerUpdatePayload']> = {
  ...
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsCustomerUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DepositConfigurationResolvers<ContextType = any, ParentType extends ResolversParentTypes['DepositConfiguration'] = ResolversParentTypes['DepositConfiguration']> = {
  __resolveType: TypeResolveFn<'DepositPercentage', ParentType, ContextType>;
};

export type DepositPercentageResolvers<ContextType = any, ParentType extends ResolversParentTypes['DepositPercentage'] = ResolversParentTypes['DepositPercentage']> = {
...
export type DiscountApplicationConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['DiscountApplicationConnection'] = ResolversParentTypes['DiscountApplicationConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['DiscountApplication']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type DisplayableErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['DisplayableError'] = ResolversParentTypes['DisplayableError']> = {
  __resolveType: TypeResolveFn<'ApplePaySessionUserError' | 'BusinessCustomerUserError' | 'MetafieldsDeleteUserError' | 'MetafieldsSetUserError' | 'ReturnUserError' | 'SubscriptionBillingCycleSkipUserError' | 'SubscriptionBillingCycleUnskipUserError' | 'SubscriptionContractStatusUpdateUserError' | 'SubscriptionContractUserError' | 'UserErrorsBusinessContactUserErrors' | 'UserErrorsBusinessLocationPaymentInstrumentUserErrors' | 'UserErrorsCustomerAddressUserErrors' | 'UserErrorsCustomerEmailMarketingOptInUserErrors' | 'UserErrorsCustomerEmailMarketingUserErrors' | 'UserErrorsCustomerUserErrors' | 'UserErrorsPaymentInstrumentUserErrors' | 'UserErrorsPaypalTokenUserErrors' | 'UserErrorsResendGiftCardErrors' | 'UserErrorsStorefrontCustomerAccessTokenCreateUserErrors', ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type DomainResolvers<ContextType = any, ParentType extends ResolversParentTypes['Domain'] = ResolversParentTypes['Domain']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  redirectHost?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  url?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrder'] = ResolversParentTypes['DraftOrder']> = {
  billingAddress?: Resolver<Maybe<ResolversTypes['CustomerAddress']>, ParentType, ContextType>;
  contactExists?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  currencyCode?: Resolver<ResolversTypes['CurrencyCode'], ParentType, ContextType>;
  customer?: Resolver<Maybe<ResolversTypes['Customer']>, ParentType, ContextType>;
  discountInformation?: Resolver<ResolversTypes['DraftOrderDiscountInformation'], ParentType, ContextType>;
  email?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  legacyAggregatedMerchandiseTermsAsFees?: Resolver<Array<ResolversTypes['LegacyAggregatedMerchandiseTermsAsFees']>, ParentType, ContextType>;
  legacyRepresentProductsAsFees?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  legacySubtotalWithoutFees?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['DraftOrderLineItemConnection'], ParentType, ContextType, RequireFields<DraftOrderLineItemsArgs, 'reverse'>>;
  lineItemsSummary?: Resolver<Maybe<ResolversTypes['DraftOrderLineItemsSummary']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  order?: Resolver<Maybe<ResolversTypes['Order']>, ParentType, ContextType>;
  phone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  purchasingEntity?: Resolver<Maybe<ResolversTypes['PurchasingEntity']>, ParentType, ContextType>;
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  shippingAddress?: Resolver<Maybe<ResolversTypes['CustomerAddress']>, ParentType, ContextType>;
  status?: Resolver<ResolversTypes['DraftOrderStatus'], ParentType, ContextType>;
  subtotalPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  subtotalPriceBeforeDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  taxExempt?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  taxesIncluded?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  totalLineItemsPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalShippingPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalTax?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalWeight?: Resolver<ResolversTypes['UnsignedInt64'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderAppliedDiscountResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderAppliedDiscount'] = ResolversParentTypes['DraftOrderAppliedDiscount']> = {
  discountValue?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderConnection'] = ResolversParentTypes['DraftOrderConnection']> = {
  edges?: Resolver<Array<ResolversTypes['DraftOrderEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['DraftOrder']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderDiscountInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderDiscountInformation'] = ResolversParentTypes['DraftOrderDiscountInformation']> = {
  appliedDiscount?: Resolver<Maybe<ResolversTypes['DraftOrderAppliedDiscount']>, ParentType, ContextType>;
  totalDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderEdge'] = ResolversParentTypes['DraftOrderEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['DraftOrder'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderLineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderLineItem'] = ResolversParentTypes['DraftOrderLineItem']> = {
  discountInformation?: Resolver<ResolversTypes['DraftOrderLineItemDiscountInformation'], ParentType, ContextType>;
  discountedTotal?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  discountedUnitPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  legacyFee?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  legacyFeeDescription?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  legacyFeeTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  originalTotal?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  originalUnitPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type DraftOrderLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderLineItemConnection'] = ResolversParentTypes['DraftOrderLineItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['DraftOrderLineItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['DraftOrderLineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderLineItemDiscountInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderLineItemDiscountInformation'] = ResolversParentTypes['DraftOrderLineItemDiscountInformation']> = {
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  totalDiscount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderLineItemEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderLineItemEdge'] = ResolversParentTypes['DraftOrderLineItemEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['DraftOrderLineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DraftOrderLineItemsSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['DraftOrderLineItemsSummary'] = ResolversParentTypes['DraftOrderLineItemsSummary']> = {
  lineItemCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  totalQuantityOfLegacyFeeLineItems?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  totalQuantityOfLineItems?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type DutySaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['DutySale'] = ResolversParentTypes['DutySale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type ExtensionApiTokensResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExtensionApiTokens'] = ResolversParentTypes['ExtensionApiTokens']> = {
  storefrontApi?: Resolver<Maybe<ResolversTypes['ExtensionStorefrontApiToken']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ExtensionStorefrontApiTokenResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExtensionStorefrontApiToken'] = ResolversParentTypes['ExtensionStorefrontApiToken']> = {
  expiresAt?: Resolver<ResolversTypes['ISO8601DateTime'], ParentType, ContextType>;
  token?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FeeSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['FeeSale'] = ResolversParentTypes['FeeSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type FulfillmentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Fulfillment'] = ResolversParentTypes['Fulfillment']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  estimatedDeliveryAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  events?: Resolver<ResolversTypes['FulfillmentEventConnection'], ParentType, ContextType, RequireFields<FulfillmentEventsArgs, 'reverse' | 'sortKey'>>;
  ...
  latestShipmentStatus?: Resolver<Maybe<ResolversTypes['FulfillmentEventStatus']>, ParentType, ContextType>;
  pickupAddress?: Resolver<Maybe<ResolversTypes['PickupAddress']>, ParentType, ContextType>;
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  status?: Resolver<Maybe<ResolversTypes['FulfillmentStatus']>, ParentType, ContextType>;
  trackingInformation?: Resolver<Array<ResolversTypes['TrackingInformation']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FulfillmentConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentConnection'] = ResolversParentTypes['FulfillmentConnection']> = {
  edges?: Resolver<Array<ResolversTypes['FulfillmentEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['Fulfillment']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FulfillmentEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentEdge'] = ResolversParentTypes['FulfillmentEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Fulfillment'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FulfillmentEventResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentEvent'] = ResolversParentTypes['FulfillmentEvent']> = {
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  status?: Resolver<ResolversTypes['FulfillmentEventStatus'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FulfillmentEventConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentEventConnection'] = ResolversParentTypes['FulfillmentEventConnection']> = {
  edges?: Resolver<Array<ResolversTypes['FulfillmentEventEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['FulfillmentEvent']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type FulfillmentEventEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentEventEdge'] = ResolversParentTypes['FulfillmentEventEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type FulfillmentLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['FulfillmentLineItemConnection'] = ResolversParentTypes['FulfillmentLineItemConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['FulfillmentLineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GiftCardDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['GiftCardDetails'] = ResolversParentTypes['GiftCardDetails']> = {
  balance?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  last4?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type GiftCardSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['GiftCardSale'] = ResolversParentTypes['GiftCardSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
...
export type GooglePayCreditCardAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['GooglePayCreditCardAddPayload'] = ResolversParentTypes['GooglePayCreditCardAddPayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GooglePayCreditCardUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['GooglePayCreditCardUpdatePayload'] = ResolversParentTypes['GooglePayCreditCardUpdatePayload']> = {
  creditCard?: Resolver<Maybe<ResolversTypes['CustomerCreditCard']>, ParentType, ContextType>;
  processing?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type GooglePayWalletConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['GooglePayWalletConfig'] = ResolversParentTypes['GooglePayWalletConfig']> = {
  allowedAuthMethods?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  allowedCardNetworks?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  gatewayMerchantId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type HasCompareDigestResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasCompareDigest'] = ResolversParentTypes['HasCompareDigest']> = {
...
export type HasMetafieldsResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasMetafields'] = ResolversParentTypes['HasMetafields']> = {
  __resolveType: TypeResolveFn<'Company' | 'CompanyLocation' | 'Customer' | 'Order' | 'Shop', ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<HasMetafieldsMetafieldArgs, 'key' | 'namespace'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<HasMetafieldsMetafieldsArgs, 'identifiers'>>;
};

export type HasStoreCreditAccountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasStoreCreditAccounts'] = ResolversParentTypes['HasStoreCreditAccounts']> = {
  __resolveType: TypeResolveFn<'Customer', ParentType, ContextType>;
  storeCreditAccounts?: Resolver<ResolversTypes['StoreCreditAccountConnection'], ParentType, ContextType, Partial<HasStoreCreditAccountsStoreCreditAccountsArgs>>;
};
...
export type LegacyAggregatedMerchandiseTermsAsFeesResolvers<ContextType = any, ParentType extends ResolversParentTypes['LegacyAggregatedMerchandiseTermsAsFees'] = ResolversParentTypes['LegacyAggregatedMerchandiseTermsAsFees']> = {
...
export type LineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItem'] = ResolversParentTypes['LineItem']> = {
  currentTotalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  customAttributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  discountAllocations?: Resolver<Array<ResolversTypes['DiscountAllocation']>, ParentType, ContextType>;
  discountInformation?: Resolver<Array<ResolversTypes['LineItemDiscountInformation']>, ParentType, ContextType>;
  giftCard?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  group?: Resolver<Maybe<ResolversTypes['LineItemGroup']>, ParentType, ContextType>;
  groupTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  legacyFee?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  legacyFeeDescription?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  legacyFeeTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  presentmentTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  price?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  ...
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  sellingPlan?: Resolver<Maybe<ResolversTypes['LineItemSellingPlan']>, ParentType, ContextType>;
  sku?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  soldDiscountInformation?: Resolver<Array<ResolversTypes['LineItemDiscountInformation']>, ParentType, ContextType>;
  soldDiscountedTotalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  soldQuantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  soldTotalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  supportedReturnReasons?: Resolver<Array<ResolversTypes['ReturnSupportedReason']>, ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  totalDiscount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalPriceBeforeDiscounts?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalPriceWithDiscounts?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  unitPrice?: Resolver<Maybe<ResolversTypes['UnitPrice']>, ParentType, ContextType>;
  variantId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  variantOptions?: Resolver<Maybe<Array<ResolversTypes['LineItemVariantOption']>>, ParentType, ContextType>;
  variantTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  vendor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemConnection'] = ResolversParentTypes['LineItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['LineItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['LineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemContainer'] = ResolversParentTypes['LineItemContainer']> = {
  __resolveType: TypeResolveFn<'RemainingLineItemContainer' | 'UnfulfilledDigitalLineItemContainer' | 'UnfulfilledGiftCardLineItemContainer' | 'UnfulfilledLineItemContainer' | 'UnfulfilledPhysicalLineItemContainer', ParentType, ContextType>;
};

export type LineItemContainerLineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemContainerLineItem'] = ResolversParentTypes['LineItemContainerLineItem']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
...
export type LineItemContainerLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemContainerLineItemConnection'] = ResolversParentTypes['LineItemContainerLineItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['LineItemContainerLineItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['LineItemContainerLineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemContainerLineItemEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemContainerLineItemEdge'] = ResolversParentTypes['LineItemContainerLineItemEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['LineItemContainerLineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemDiscountInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemDiscountInformation'] = ResolversParentTypes['LineItemDiscountInformation']> = {
  discountValue?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemEdge'] = ResolversParentTypes['LineItemEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemGroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemGroup'] = ResolversParentTypes['LineItemGroup']> = {
  currentTotalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  discountInformation?: Resolver<Maybe<Array<ResolversTypes['LineItemDiscountInformation']>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type LineItemSellingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemSellingPlan'] = ResolversParentTypes['LineItemSellingPlan']> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  sellingPlanId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type LineItemVariantOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['LineItemVariantOption'] = ResolversParentTypes['LineItemVariantOption']> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MarketResolvers<ContextType = any, ParentType extends ResolversParentTypes['Market'] = ResolversParentTypes['Market']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  webPresence?: Resolver<Maybe<ResolversTypes['MarketWebPresence']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MarketWebPresenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketWebPresence'] = ResolversParentTypes['MarketWebPresence']> = {
  domain?: Resolver<Maybe<ResolversTypes['Domain']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  rootUrls?: Resolver<Array<ResolversTypes['MarketWebPresenceRootUrl']>, ParentType, ContextType>;
  subfolderSuffix?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MarketWebPresenceRootUrlResolvers<ContextType = any, ParentType extends ResolversParentTypes['MarketWebPresenceRootUrl'] = ResolversParentTypes['MarketWebPresenceRootUrl']> = {
...
export type MetafieldIdentifierResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldIdentifier'] = ResolversParentTypes['MetafieldIdentifier']> = {
  key?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  namespace?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MetafieldsDeletePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldsDeletePayload'] = ResolversParentTypes['MetafieldsDeletePayload']> = {
  deletedMetafields?: Resolver<Maybe<Array<Maybe<ResolversTypes['MetafieldIdentifier']>>>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['MetafieldsDeleteUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetafieldsDeleteUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldsDeleteUserError'] = ResolversParentTypes['MetafieldsDeleteUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['MetafieldsDeleteUserErrorCode']>, ParentType, ContextType>;
  elementIndex?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetafieldsSetPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldsSetPayload'] = ResolversParentTypes['MetafieldsSetPayload']> = {
  metafields?: Resolver<Maybe<Array<ResolversTypes['Metafield']>>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['MetafieldsSetUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetafieldsSetUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldsSetUserError'] = ResolversParentTypes['MetafieldsSetUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['MetafieldsSetUserErrorCode']>, ParentType, ContextType>;
  elementIndex?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type MoneyBagResolvers<ContextType = any, ParentType extends ResolversParentTypes['MoneyBag'] = ResolversParentTypes['MoneyBag']> = {
  presentmentMoney?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  applePayCreditCardAdd?: Resolver<Maybe<ResolversTypes['ApplePayCreditCardAddPayload']>, ParentType, ContextType, RequireFields<MutationApplePayCreditCardAddArgs, 'applePayTokenizedCard' | 'billingAddress'>>;
  applePayCreditCardUpdate?: Resolver<Maybe<ResolversTypes['ApplePayCreditCardUpdatePayload']>, ParentType, ContextType, RequireFields<MutationApplePayCreditCardUpdateArgs, 'applePayTokenizedCard' | 'billingAddress' | 'paymentMethodId'>>;
  applePaySessionCreate?: Resolver<Maybe<ResolversTypes['ApplePaySessionCreatePayload']>, ParentType, ContextType, RequireFields<MutationApplePaySessionCreateArgs, 'resourceId' | 'validationUrl'>>;
  businessContactUpdate?: Resolver<Maybe<ResolversTypes['BusinessContactUpdatePayload']>, ParentType, ContextType, RequireFields<MutationBusinessContactUpdateArgs, 'input'>>;
  businessLocationCreditCardAdd?: Resolver<Maybe<ResolversTypes['BusinessLocationCreditCardAddPayload']>, ParentType, ContextType, RequireFields<MutationBusinessLocationCreditCardAddArgs, 'billingAddress' | 'companyLocationId' | 'sessionId'>>;
  businessLocationCreditCardUpdate?: Resolver<Maybe<ResolversTypes['BusinessLocationCreditCardUpdatePayload']>, ParentType, ContextType, RequireFields<MutationBusinessLocationCreditCardUpdateArgs, 'billingAddress' | 'companyLocationId' | 'paymentMethodId' | 'sessionId'>>;
  businessLocationPaymentInstrumentRemove?: Resolver<Maybe<ResolversTypes['BusinessLocationPaymentInstrumentRemovePayload']>, ParentType, ContextType, RequireFields<MutationBusinessLocationPaymentInstrumentRemoveArgs, 'companyLocationId' | 'paymentInstrumentId'>>;
  companyLocationAssignAddress?: Resolver<Maybe<ResolversTypes['CompanyLocationAssignAddressPayload']>, ParentType, ContextType, RequireFields<MutationCompanyLocationAssignAddressArgs, 'address' | 'addressTypes' | 'locationId'>>;
  creditCardAdd?: Resolver<Maybe<ResolversTypes['CreditCardAddPayload']>, ParentType, ContextType, RequireFields<MutationCreditCardAddArgs, 'billingAddress' | 'default' | 'sessionId'>>;
  creditCardUpdate?: Resolver<Maybe<ResolversTypes['CreditCardUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCreditCardUpdateArgs, 'billingAddress' | 'paymentMethodId' | 'sessionId'>>;
  customerAddressCreate?: Resolver<Maybe<ResolversTypes['CustomerAddressCreatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressCreateArgs, 'address' | 'defaultAddress'>>;
  customerAddressDelete?: Resolver<Maybe<ResolversTypes['CustomerAddressDeletePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressDeleteArgs, 'addressId'>>;
  customerAddressUpdate?: Resolver<Maybe<ResolversTypes['CustomerAddressUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressUpdateArgs, 'addressId' | 'defaultAddress'>>;
  customerEmailMarketingOptIn?: Resolver<Maybe<ResolversTypes['CustomerEmailMarketingOptInPayload']>, ParentType, ContextType>;
  customerEmailMarketingSubscribe?: Resolver<Maybe<ResolversTypes['CustomerEmailMarketingSubscribePayload']>, ParentType, ContextType>;
  customerEmailMarketingUnsubscribe?: Resolver<Maybe<ResolversTypes['CustomerEmailMarketingUnsubscribePayload']>, ParentType, ContextType>;
  customerUpdate?: Resolver<Maybe<ResolversTypes['CustomerUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerUpdateArgs, 'input'>>;
  googlePayCreditCardAdd?: Resolver<Maybe<ResolversTypes['GooglePayCreditCardAddPayload']>, ParentType, ContextType, RequireFields<MutationGooglePayCreditCardAddArgs, 'billingAddress' | 'googlePayTokenizedCard'>>;
  googlePayCreditCardUpdate?: Resolver<Maybe<ResolversTypes['GooglePayCreditCardUpdatePayload']>, ParentType, ContextType, RequireFields<MutationGooglePayCreditCardUpdateArgs, 'billingAddress' | 'googlePayTokenizedCard' | 'paymentMethodId'>>;
  metafieldsDelete?: Resolver<Maybe<ResolversTypes['MetafieldsDeletePayload']>, ParentType, ContextType, RequireFields<MutationMetafieldsDeleteArgs, 'metafields'>>;
  metafieldsSet?: Resolver<Maybe<ResolversTypes['MetafieldsSetPayload']>, ParentType, ContextType, RequireFields<MutationMetafieldsSetArgs, 'metafields'>>;
  orderRequestReturn?: Resolver<Maybe<ResolversTypes['OrderRequestReturnPayload']>, ParentType, ContextType, RequireFields<MutationOrderRequestReturnArgs, 'orderId' | 'requestedLineItems'>>;
  paymentInstrumentRemove?: Resolver<Maybe<ResolversTypes['PaymentInstrumentRemovePayload']>, ParentType, ContextType, RequireFields<MutationPaymentInstrumentRemoveArgs, 'paymentInstrumentId'>>;
  paymentInstrumentUpdateDefault?: Resolver<Maybe<ResolversTypes['PaymentInstrumentUpdateDefaultPayload']>, ParentType, ContextType, RequireFields<MutationPaymentInstrumentUpdateDefaultArgs, 'default' | 'paymentInstrumentId'>>;
  paypalAccountEnable?: Resolver<Maybe<ResolversTypes['PaypalAccountEnablePayload']>, ParentType, ContextType, RequireFields<MutationPaypalAccountEnableArgs, 'paypalPayerId' | 'paypalToken'>>;
  paypalTokenCreate?: Resolver<Maybe<ResolversTypes['PaypalTokenCreatePayload']>, ParentType, ContextType>;
  resendGiftCard?: Resolver<Maybe<ResolversTypes['ResendGiftCardPayload']>, ParentType, ContextType, RequireFields<MutationResendGiftCardArgs, 'orderId'>>;
  shopPayCreditCardGetUpdateUrl?: Resolver<Maybe<ResolversTypes['ShopPayCreditCardGetUpdateUrlPayload']>, ParentType, ContextType, RequireFields<MutationShopPayCreditCardGetUpdateUrlArgs, 'paymentMethodId'>>;
  storefrontCustomerAccessTokenCreate?: Resolver<Maybe<ResolversTypes['StorefrontCustomerAccessTokenCreatePayload']>, ParentType, ContextType>;
  subscriptionBillingCycleSkip?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycleSkipPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionBillingCycleSkipArgs, 'billingCycleInput'>>;
  subscriptionBillingCycleUnskip?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycleUnskipPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionBillingCycleUnskipArgs, 'billingCycleInput'>>;
  subscriptionContractActivate?: Resolver<Maybe<ResolversTypes['SubscriptionContractActivatePayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractActivateArgs, 'subscriptionContractId'>>;
  subscriptionContractCancel?: Resolver<Maybe<ResolversTypes['SubscriptionContractCancelPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractCancelArgs, 'subscriptionContractId'>>;
  subscriptionContractChangePaymentInstrument?: Resolver<Maybe<ResolversTypes['SubscriptionContractChangePaymentInstrumentPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractChangePaymentInstrumentArgs, 'paymentInstrumentId' | 'subscriptionContractId'>>;
  subscriptionContractFetchDeliveryOptions?: Resolver<Maybe<ResolversTypes['SubscriptionContractFetchDeliveryOptionsPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractFetchDeliveryOptionsArgs, 'subscriptionContractId'>>;
  subscriptionContractPause?: Resolver<Maybe<ResolversTypes['SubscriptionContractPausePayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractPauseArgs, 'subscriptionContractId'>>;
  subscriptionContractSelectDeliveryMethod?: Resolver<Maybe<ResolversTypes['SubscriptionContractSelectDeliveryMethodPayload']>, ParentType, ContextType, RequireFields<MutationSubscriptionContractSelectDeliveryMethodArgs, 'deliveryMethodInput' | 'subscriptionContractId' | 'subscriptionDeliveryOptionsResultToken'>>;
};

export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'AdditionalFeeSale' | 'AdjustmentSale' | 'AppliedGiftCard' | 'Checkout' | 'CheckoutLineItem' | 'Company' | 'CompanyAddress' | 'CompanyContact' | 'CompanyContactRole' | 'CompanyContactRoleAssignment' | 'CompanyLocation' | 'Customer' | 'CustomerAddress' | 'CustomerCreditCard' | 'CustomerMailingAddress' | 'Domain' | 'DraftOrder' | 'DraftOrderLineItem' | 'DutySale' | 'FeeSale' | 'Fulfillment' | 'FulfillmentEvent' | 'FulfillmentLineItem' | 'GiftCardSale' | 'LegacyAggregatedMerchandiseTermsAsFees' | 'LineItem' | 'LineItemContainerLineItem' | 'LineItemGroup' | 'Market' | 'MarketWebPresence' | 'Metafield' | 'Order' | 'OrderAgreement' | 'OrderEditAgreement' | 'OrderEditSummaryChange' | 'OrderTransaction' | 'PaymentIconImage' | 'PaymentSchedule' | 'PaymentTerms' | 'PaymentTermsTemplate' | 'PaypalBillingAgreement' | 'ProductSale' | 'PublicOrder' | 'Refund' | 'RefundAgreement' | 'RemainingLineItemContainerLineItem' | 'Return' | 'ReturnAgreement' | 'ReturnLineItem' | 'ReverseDelivery' | 'SaleTax' | 'ShippingLineSale' | 'Shop' | 'ShopPolicy' | 'StoreCreditAccount' | 'StoreCreditAccountCreditTransaction' | 'StoreCreditAccountDebitRevertTransaction' | 'StoreCreditAccountDebitTransaction' | 'SubscriptionContract' | 'TaxLine' | 'TimelineEvent' | 'TipSale' | 'UiExtensionMetafield' | 'UnknownSale', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};

export type OrderResolvers<ContextType = any, ParentType extends ResolversParentTypes['Order'] = ResolversParentTypes['Order']> = {
  agreements?: Resolver<ResolversTypes['SalesAgreementConnection'], ParentType, ContextType, RequireFields<OrderAgreementsArgs, 'reverse'>>;
  billingAddress?: Resolver<Maybe<ResolversTypes['CustomerAddress']>, ParentType, ContextType>;
  ...
  confirmationNumber?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  currencyCode?: Resolver<ResolversTypes['CurrencyCode'], ParentType, ContextType>;
  customAttributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  customer?: Resolver<Maybe<ResolversTypes['Customer']>, ParentType, ContextType>;
  ...
  discountInformation?: Resolver<ResolversTypes['OrderDiscountInformation'], ParentType, ContextType>;
  draftOrder?: Resolver<Maybe<ResolversTypes['DraftOrder']>, ParentType, ContextType>;
  draftOrderName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  editSummary?: Resolver<Maybe<ResolversTypes['OrderEditSummary']>, ParentType, ContextType>;
  ...
  fulfillments?: Resolver<ResolversTypes['FulfillmentConnection'], ParentType, ContextType, RequireFields<OrderFulfillmentsArgs, 'reverse' | 'sortKey'>>;
  hasEmail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasMultipleFulfillments?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  latestFulfillmentDeliveryDate?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  legacyAggregatedMerchandiseTermsAsFees?: Resolver<Array<ResolversTypes['LegacyAggregatedMerchandiseTermsAsFees']>, ParentType, ContextType>;
  legacyRepresentProductsAsFees?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  legacySubtotalWithoutFees?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  lineItemContainers?: Resolver<Array<ResolversTypes['LineItemContainer']>, ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['LineItemConnection'], ParentType, ContextType, RequireFields<OrderLineItemsArgs, 'reverse'>>;
  lineItemsSummary?: Resolver<Maybe<ResolversTypes['OrderLineItemsSummary']>, ParentType, ContextType>;
  locationName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  market?: Resolver<ResolversTypes['Market'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<OrderMetafieldArgs, 'key' | 'namespace'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<OrderMetafieldsArgs, 'identifiers'>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  note?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  number?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  orderReceiptMetafields?: Resolver<Array<ResolversTypes['Metafield']>, ParentType, ContextType>;
  paymentInformation?: Resolver<Maybe<ResolversTypes['OrderPaymentInformation']>, ParentType, ContextType>;
  paymentTermsTemplate?: Resolver<Maybe<ResolversTypes['PaymentTermsTemplate']>, ParentType, ContextType>;
  phone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  pickupInformation?: Resolver<Maybe<ResolversTypes['OrderPickupInformation']>, ParentType, ContextType>;
  ...
  reorderPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  return?: Resolver<Maybe<ResolversTypes['Return']>, ParentType, ContextType, RequireFields<OrderReturnArgs, 'id'>>;
  returns?: Resolver<ResolversTypes['ReturnConnection'], ParentType, ContextType, RequireFields<OrderReturnsArgs, 'reverse' | 'sortKey'>>;
  shippingAddress?: Resolver<Maybe<ResolversTypes['CustomerAddress']>, ParentType, ContextType>;
  shippingDiscountAllocations?: Resolver<Array<ResolversTypes['DiscountAllocation']>, ParentType, ContextType>;
  shippingLine?: Resolver<Maybe<ResolversTypes['ShippingLine']>, ParentType, ContextType>;
  shippingLineGroups?: Resolver<Array<ResolversTypes['OrderShippingLineGroup']>, ParentType, ContextType>;
  shippingTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  shopAppLinksAndResources?: Resolver<Maybe<ResolversTypes['ShopAppLinksAndResources']>, ParentType, ContextType>;
  soldInformation?: Resolver<ResolversTypes['OrderSoldInformation'], ParentType, ContextType>;
  statusPageUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  subscriptionContracts?: Resolver<Maybe<ResolversTypes['SubscriptionContractConnection']>, ParentType, ContextType, RequireFields<OrderSubscriptionContractsArgs, 'reverse' | 'sortKey'>>;
  subtotal?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  subtotalBeforeDiscounts?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  taxInvoices?: Resolver<Array<ResolversTypes['TaxInvoice']>, ParentType, ContextType>;
  totalDiscountedShipping?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalDuties?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalDutiesSummary?: Resolver<Maybe<ResolversTypes['OrderDutiesSummary']>, ParentType, ContextType>;
  totalPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  ...
  totalTax?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalTip?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  transactions?: Resolver<Array<ResolversTypes['OrderTransaction']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderAgreement'] = ResolversParentTypes['OrderAgreement']> = {
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  order?: Resolver<ResolversTypes['Order'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['OrderActionType'], ParentType, ContextType>;
  sales?: Resolver<ResolversTypes['SaleConnection'], ParentType, ContextType, RequireFields<OrderAgreementSalesArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderAllDiscountsResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderAllDiscounts'] = ResolversParentTypes['OrderAllDiscounts']> = {
  discountApplicationType?: Resolver<ResolversTypes['DiscountApplicationType'], ParentType, ContextType>;
  discountValue?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  targetType?: Resolver<ResolversTypes['DiscountApplicationTargetType'], ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type OrderDetailsPageOrderResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderDetailsPageOrder'] = ResolversParentTypes['OrderDetailsPageOrder']> = {
  __resolveType: TypeResolveFn<'Order' | 'PublicOrder', ParentType, ContextType>;
};

export type OrderDiscountInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderDiscountInformation'] = ResolversParentTypes['OrderDiscountInformation']> = {
  allAppliedDiscounts?: Resolver<Array<ResolversTypes['OrderAllDiscounts']>, ParentType, ContextType>;
  allOrderLevelAppliedDiscounts?: Resolver<Array<ResolversTypes['OrderAllDiscounts']>, ParentType, ContextType>;
  allOrderLevelAppliedDiscountsOnSoldItems?: Resolver<Array<ResolversTypes['OrderAllDiscounts']>, ParentType, ContextType>;
  totalDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalOrderLevelAppliedDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderDutiesSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderDutiesSummary'] = ResolversParentTypes['OrderDutiesSummary']> = {
  totalDuties?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalDutiesStatus?: Resolver<Maybe<ResolversTypes['OrderDutiesStatusType']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type OrderEditAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderEditAgreement'] = ResolversParentTypes['OrderEditAgreement']> = {
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['OrderActionType'], ParentType, ContextType>;
  sales?: Resolver<ResolversTypes['SaleConnection'], ParentType, ContextType, RequireFields<OrderEditAgreementSalesArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderEditSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderEditSummary'] = ResolversParentTypes['OrderEditSummary']> = {
  changes?: Resolver<Array<ResolversTypes['OrderEditSummaryChange']>, ParentType, ContextType>;
  latestHappenedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderEditSummaryChangeResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderEditSummaryChange'] = ResolversParentTypes['OrderEditSummaryChange']> = {
...
export type OrderLineItemsSummaryResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderLineItemsSummary'] = ResolversParentTypes['OrderLineItemsSummary']> = {
  lineItemCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  totalQuantityOfLegacyFeesLineItems?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  totalQuantityOfLineItems?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  totalQuantityOfTipLineItems?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderPaymentInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderPaymentInformation'] = ResolversParentTypes['OrderPaymentInformation']> = {
  paymentCollectionUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  paymentStatus?: Resolver<Maybe<ResolversTypes['OrderPaymentStatus']>, ParentType, ContextType>;
  paymentTerms?: Resolver<Maybe<ResolversTypes['PaymentTerms']>, ParentType, ContextType>;
  totalOutstandingAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalPaidAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderPickupInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderPickupInformation'] = ResolversParentTypes['OrderPickupInformation']> = {
  address?: Resolver<Maybe<ResolversTypes['PickupAddress']>, ParentType, ContextType>;
  createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  status?: Resolver<Maybe<ResolversTypes['PickupStatus']>, ParentType, ContextType>;
  updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderRequestReturnPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderRequestReturnPayload'] = ResolversParentTypes['OrderRequestReturnPayload']> = {
  return?: Resolver<Maybe<ResolversTypes['Return']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['ReturnUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderShippingLineGroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderShippingLineGroup'] = ResolversParentTypes['OrderShippingLineGroup']> = {
  groupType?: Resolver<ResolversTypes['DeliveryOptionGroupType'], ParentType, ContextType>;
  lineAmountAfterDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderSoldInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderSoldInformation'] = ResolversParentTypes['OrderSoldInformation']> = {
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  ...
  totalDiscount?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalTaxes?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type OrderTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['OrderTransaction'] = ResolversParentTypes['OrderTransaction']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  giftCardDetails?: Resolver<Maybe<ResolversTypes['GiftCardDetails']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  kind?: Resolver<Maybe<ResolversTypes['OrderTransactionKind']>, ParentType, ContextType>;
  paymentDetails?: Resolver<Maybe<ResolversTypes['PaymentDetails']>, ParentType, ContextType>;
  paymentIcon?: Resolver<Maybe<ResolversTypes['PaymentIconImage']>, ParentType, ContextType>;
  processedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  status?: Resolver<Maybe<ResolversTypes['OrderTransactionStatus']>, ParentType, ContextType>;
  transactionAmount?: Resolver<ResolversTypes['MoneyBag'], ParentType, ContextType>;
  transactionParentId?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['OrderTransactionType'], ParentType, ContextType>;
  typeDetails?: Resolver<Maybe<ResolversTypes['TransactionTypeDetails']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type PaymentIconResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentIcon'] = ResolversParentTypes['PaymentIcon']> = {
  __resolveType: TypeResolveFn<'OrderTransaction', ParentType, ContextType>;
  paymentIcon?: Resolver<Maybe<ResolversTypes['PaymentIconImage']>, ParentType, ContextType>;
};

export type PaymentIconImageResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentIconImage'] = ResolversParentTypes['PaymentIconImage']> = {
  altText?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  height?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  originalSrc?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  src?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  transformedSrc?: Resolver<ResolversTypes['URL'], ParentType, ContextType, RequireFields<PaymentIconImageTransformedSrcArgs, 'scale'>>;
  url?: Resolver<ResolversTypes['URL'], ParentType, ContextType, Partial<PaymentIconImageUrlArgs>>;
  width?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaymentInstrumentResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentInstrument'] = ResolversParentTypes['PaymentInstrument']> = {
  __resolveType: TypeResolveFn<'CustomerCreditCard' | 'PaypalBillingAgreement', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};

export type PaymentInstrumentBillingAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentInstrumentBillingAddress'] = ResolversParentTypes['PaymentInstrumentBillingAddress']> = {
  address1?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  address2?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  country?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PaymentInstrumentRemovePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentInstrumentRemovePayload'] = ResolversParentTypes['PaymentInstrumentRemovePayload']> = {
  deletedPaymentInstrumentId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaymentInstrumentUpdateDefaultPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentInstrumentUpdateDefaultPayload'] = ResolversParentTypes['PaymentInstrumentUpdateDefaultPayload']> = {
  updatedPaymentInstrumentId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaymentScheduleResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentSchedule'] = ResolversParentTypes['PaymentSchedule']> = {
...
export type PaymentScheduleConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentScheduleConnection'] = ResolversParentTypes['PaymentScheduleConnection']> = {
  edges?: Resolver<Array<ResolversTypes['PaymentScheduleEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['PaymentSchedule']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaymentScheduleEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentScheduleEdge'] = ResolversParentTypes['PaymentScheduleEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PaymentTermsResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentTerms'] = ResolversParentTypes['PaymentTerms']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  nextDueAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  overdue?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  paymentSchedules?: Resolver<ResolversTypes['PaymentScheduleConnection'], ParentType, ContextType, RequireFields<PaymentTermsPaymentSchedulesArgs, 'reverse'>>;
  paymentTermsName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  paymentTermsType?: Resolver<ResolversTypes['PaymentTermsType'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaymentTermsTemplateResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaymentTermsTemplate'] = ResolversParentTypes['PaymentTermsTemplate']> = {
...
export type PaypalAccountEnablePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaypalAccountEnablePayload'] = ResolversParentTypes['PaypalAccountEnablePayload']> = {
  paypalBillingAgreement?: Resolver<Maybe<ResolversTypes['PaypalBillingAgreement']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaypalTokenUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaypalBillingAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaypalBillingAgreement'] = ResolversParentTypes['PaypalBillingAgreement']> = {
  billingAddress?: Resolver<Maybe<ResolversTypes['PaymentInstrumentBillingAddress']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  paypalAccountEmail?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  pendingOrders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<PaypalBillingAgreementPendingOrdersArgs, 'reverse'>>;
  subscriptionContracts?: Resolver<ResolversTypes['SubscriptionContractConnection'], ParentType, ContextType, RequireFields<PaypalBillingAgreementSubscriptionContractsArgs, 'reverse' | 'sortKey'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PaypalTokenCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaypalTokenCreatePayload'] = ResolversParentTypes['PaypalTokenCreatePayload']> = {
  token?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaypalTokenUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PickupAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['PickupAddress'] = ResolversParentTypes['PickupAddress']> = {
  address1?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  address2?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type ProductSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductSale'] = ResolversParentTypes['ProductSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
...
export type PublicOrderResolvers<ContextType = any, ParentType extends ResolversParentTypes['PublicOrder'] = ResolversParentTypes['PublicOrder']> = {
  cancelledAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  confirmationNumber?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  discountInformation?: Resolver<ResolversTypes['OrderDiscountInformation'], ParentType, ContextType>;
  draftOrderName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  ...
  financialStatus?: Resolver<Maybe<ResolversTypes['OrderFinancialStatus']>, ParentType, ContextType>;
  fulfillmentStatus?: Resolver<ResolversTypes['OrderFulfillmentStatus'], ParentType, ContextType>;
  fulfillments?: Resolver<ResolversTypes['FulfillmentConnection'], ParentType, ContextType, RequireFields<PublicOrderFulfillmentsArgs, 'reverse' | 'sortKey'>>;
  hasEmail?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  legacyAggregatedMerchandiseTermsAsFees?: Resolver<Array<ResolversTypes['LegacyAggregatedMerchandiseTermsAsFees']>, ParentType, ContextType>;
  legacyRepresentProductsAsFees?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  legacySubtotalWithoutFees?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  lineItemContainers?: Resolver<Array<ResolversTypes['LineItemContainer']>, ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['LineItemConnection'], ParentType, ContextType, RequireFields<PublicOrderLineItemsArgs, 'reverse'>>;
  market?: Resolver<ResolversTypes['Market'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  paymentInformation?: Resolver<Maybe<ResolversTypes['OrderPaymentInformation']>, ParentType, ContextType>;
  pickupInformation?: Resolver<Maybe<ResolversTypes['OrderPickupInformation']>, ParentType, ContextType>;
  ...
  reorderPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  requiresShipping?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  return?: Resolver<Maybe<ResolversTypes['Return']>, ParentType, ContextType, RequireFields<PublicOrderReturnArgs, 'id'>>;
  returns?: Resolver<ResolversTypes['ReturnConnection'], ParentType, ContextType, RequireFields<PublicOrderReturnsArgs, 'reverse' | 'sortKey'>>;
  shippingLineGroups?: Resolver<Array<ResolversTypes['OrderShippingLineGroup']>, ParentType, ContextType>;
  soldInformation?: Resolver<ResolversTypes['OrderSoldInformation'], ParentType, ContextType>;
  subtotal?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  subtotalBeforeDiscounts?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
...
export type PurchasingCompanyResolvers<ContextType = any, ParentType extends ResolversParentTypes['PurchasingCompany'] = ResolversParentTypes['PurchasingCompany']> = {
  company?: Resolver<ResolversTypes['Company'], ParentType, ContextType>;
  contact?: Resolver<Maybe<ResolversTypes['CompanyContact']>, ParentType, ContextType>;
  location?: Resolver<ResolversTypes['CompanyLocation'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PurchasingEntityResolvers<ContextType = any, ParentType extends ResolversParentTypes['PurchasingEntity'] = ResolversParentTypes['PurchasingEntity']> = {
  __resolveType: TypeResolveFn<'Customer' | 'PurchasingCompany', ParentType, ContextType>;
};
...
export type QueryRootResolvers<ContextType = any, ParentType extends ResolversParentTypes['QueryRoot'] = ResolversParentTypes['QueryRoot']> = {
  company?: Resolver<Maybe<ResolversTypes['Company']>, ParentType, ContextType, RequireFields<QueryRootCompanyArgs, 'id'>>;
  companyLocation?: Resolver<Maybe<ResolversTypes['CompanyLocation']>, ParentType, ContextType, RequireFields<QueryRootCompanyLocationArgs, 'id'>>;
  customer?: Resolver<ResolversTypes['Customer'], ParentType, ContextType>;
  draftOrder?: Resolver<Maybe<ResolversTypes['DraftOrder']>, ParentType, ContextType, RequireFields<QueryRootDraftOrderArgs, 'id'>>;
  extensionApiTokens?: Resolver<Maybe<ResolversTypes['ExtensionApiTokens']>, ParentType, ContextType, RequireFields<QueryRootExtensionApiTokensArgs, 'appId'>>;
  order?: Resolver<Maybe<ResolversTypes['Order']>, ParentType, ContextType, RequireFields<QueryRootOrderArgs, 'id'>>;
  orderDetailsPageOrder?: Resolver<Maybe<ResolversTypes['OrderDetailsPageOrder']>, ParentType, ContextType, RequireFields<QueryRootOrderDetailsPageOrderArgs, 'id'>>;
  shop?: Resolver<ResolversTypes['Shop'], ParentType, ContextType>;
  uiExtensionMetafields?: Resolver<Array<ResolversTypes['UiExtensionMetafield']>, ParentType, ContextType, Partial<QueryRootUiExtensionMetafieldsArgs>>;
  uiExtensionSessionToken?: Resolver<Maybe<ResolversTypes['UiExtensionSessionToken']>, ParentType, ContextType, Partial<QueryRootUiExtensionSessionTokenArgs>>;
};

export type RefundResolvers<ContextType = any, ParentType extends ResolversParentTypes['Refund'] = ResolversParentTypes['Refund']> = {
  createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  returnName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  totalRefunded?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RefundAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['RefundAgreement'] = ResolversParentTypes['RefundAgreement']> = {
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['OrderActionType'], ParentType, ContextType>;
  refund?: Resolver<ResolversTypes['Refund'], ParentType, ContextType>;
  sales?: Resolver<ResolversTypes['SaleConnection'], ParentType, ContextType, RequireFields<RefundAgreementSalesArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RemainingLineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['RemainingLineItemContainer'] = ResolversParentTypes['RemainingLineItemContainer']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['RemainingLineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<RemainingLineItemContainerLineItemsArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RemainingLineItemContainerLineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['RemainingLineItemContainerLineItem'] = ResolversParentTypes['RemainingLineItemContainerLineItem']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RemainingLineItemContainerLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['RemainingLineItemContainerLineItemConnection'] = ResolversParentTypes['RemainingLineItemContainerLineItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['RemainingLineItemContainerLineItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['RemainingLineItemContainerLineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type RemainingLineItemContainerLineItemEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['RemainingLineItemContainerLineItemEdge'] = ResolversParentTypes['RemainingLineItemContainerLineItemEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['RemainingLineItemContainerLineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ResendGiftCardPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ResendGiftCardPayload'] = ResolversParentTypes['ResendGiftCardPayload']> = {
  orderId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsResendGiftCardErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ResourcePermissionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ResourcePermission'] = ResolversParentTypes['ResourcePermission']> = {
  permittedOperations?: Resolver<Array<ResolversTypes['PermittedOperation']>, ParentType, ContextType>;
  resource?: Resolver<ResolversTypes['ResourceType'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnResolvers<ContextType = any, ParentType extends ResolversParentTypes['Return'] = ResolversParentTypes['Return']> = {
  closedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  createdAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  decline?: Resolver<Maybe<ResolversTypes['ReturnDecline']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  returnLineItems?: Resolver<ResolversTypes['ReturnLineItemConnection'], ParentType, ContextType, RequireFields<ReturnReturnLineItemsArgs, 'reverse'>>;
  reverseDeliveries?: Resolver<ResolversTypes['ReverseDeliveryConnection'], ParentType, ContextType, RequireFields<ReturnReverseDeliveriesArgs, 'reverse'>>;
  status?: Resolver<ResolversTypes['ReturnStatus'], ParentType, ContextType>;
  timelineEvents?: Resolver<Array<ResolversTypes['TimelineEvent']>, ParentType, ContextType>;
  updatedAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnAgreement'] = ResolversParentTypes['ReturnAgreement']> = {
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['OrderActionType'], ParentType, ContextType>;
  return?: Resolver<ResolversTypes['Return'], ParentType, ContextType>;
  sales?: Resolver<ResolversTypes['SaleConnection'], ParentType, ContextType, RequireFields<ReturnAgreementSalesArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnConnection'] = ResolversParentTypes['ReturnConnection']> = {
  edges?: Resolver<Array<ResolversTypes['ReturnEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['Return']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnDeclineResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnDecline'] = ResolversParentTypes['ReturnDecline']> = {
  note?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['ReturnDeclineReason'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnEdge'] = ResolversParentTypes['ReturnEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Return'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnLineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnLineItem'] = ResolversParentTypes['ReturnLineItem']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  returnReason?: Resolver<ResolversTypes['ReturnReason'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnLineItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnLineItemConnection'] = ResolversParentTypes['ReturnLineItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['ReturnLineItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['ReturnLineItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnLineItemEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnLineItemEdge'] = ResolversParentTypes['ReturnLineItemEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['ReturnLineItem'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnSupportedReasonResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnSupportedReason'] = ResolversParentTypes['ReturnSupportedReason']> = {
  reason?: Resolver<ResolversTypes['ReturnReason'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReturnUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReturnUserError'] = ResolversParentTypes['ReturnUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['ReturnErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDelivery'] = ResolversParentTypes['ReverseDelivery']> = {
  customerGeneratedLabel?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  deliverable?: Resolver<Maybe<ResolversTypes['ReverseDeliveryDeliverable']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryConnection'] = ResolversParentTypes['ReverseDeliveryConnection']> = {
  edges?: Resolver<Array<ResolversTypes['ReverseDeliveryEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['ReverseDelivery']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryDeliverableResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryDeliverable'] = ResolversParentTypes['ReverseDeliveryDeliverable']> = {
  __resolveType: TypeResolveFn<'ReverseDeliveryShippingDeliverable', ParentType, ContextType>;
};

export type ReverseDeliveryEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryEdge'] = ResolversParentTypes['ReverseDeliveryEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['ReverseDelivery'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryLabelResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryLabel'] = ResolversParentTypes['ReverseDeliveryLabel']> = {
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  publicFileUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryShippingDeliverableResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryShippingDeliverable'] = ResolversParentTypes['ReverseDeliveryShippingDeliverable']> = {
  label?: Resolver<Maybe<ResolversTypes['ReverseDeliveryLabel']>, ParentType, ContextType>;
  tracking?: Resolver<Maybe<ResolversTypes['ReverseDeliveryTracking']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ReverseDeliveryTrackingResolvers<ContextType = any, ParentType extends ResolversParentTypes['ReverseDeliveryTracking'] = ResolversParentTypes['ReverseDeliveryTracking']> = {
  carrierName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['Sale'] = ResolversParentTypes['Sale']> = {
  __resolveType: TypeResolveFn<'AdditionalFeeSale' | 'AdjustmentSale' | 'DutySale' | 'FeeSale' | 'GiftCardSale' | 'ProductSale' | 'ShippingLineSale' | 'TipSale' | 'UnknownSale', ParentType, ContextType>;
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type SaleTaxResolvers<ContextType = any, ParentType extends ResolversParentTypes['SaleTax'] = ResolversParentTypes['SaleTax']> = {
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type SalesAgreementResolvers<ContextType = any, ParentType extends ResolversParentTypes['SalesAgreement'] = ResolversParentTypes['SalesAgreement']> = {
  __resolveType: TypeResolveFn<'OrderAgreement' | 'OrderEditAgreement' | 'RefundAgreement' | 'ReturnAgreement', ParentType, ContextType>;
  happenedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  reason?: Resolver<ResolversTypes['OrderActionType'], ParentType, ContextType>;
  sales?: Resolver<ResolversTypes['SaleConnection'], ParentType, ContextType, RequireFields<SalesAgreementSalesArgs, 'reverse'>>;
};

export type SalesAgreementConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SalesAgreementConnection'] = ResolversParentTypes['SalesAgreementConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SalesAgreementEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['SalesAgreement']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SalesAgreementEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SalesAgreementEdge'] = ResolversParentTypes['SalesAgreementEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ShippingLineSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShippingLineSale'] = ResolversParentTypes['ShippingLineSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type ShopResolvers<ContextType = any, ParentType extends ResolversParentTypes['Shop'] = ResolversParentTypes['Shop']> = {
  addressFormSettings?: Resolver<ResolversTypes['AddressFormSettings'], ParentType, ContextType>;
  ...
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<ShopMetafieldsArgs, 'identifiers'>>;
  myshopifyDomain?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  shopPolicies?: Resolver<Array<ResolversTypes['ShopPolicy']>, ParentType, ContextType>;
  url?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopAppLinksAndResourcesResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopAppLinksAndResources'] = ResolversParentTypes['ShopAppLinksAndResources']> = {
  buyerHasShopApp?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  buyerHasShopPay?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  canTrackOrderUpdates?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  installmentsHighlightEligible?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  mobileUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  mobileUrlAttributionPayload?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  orderUpdateOptions?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  qrCodeUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  shopAppEligible?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  shopAppQrCodeKillswitch?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  shopInstallmentsMobileUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  shopInstallmentsViewSchedules?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  shopPayOrder?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayConfigurationResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayConfiguration'] = ResolversParentTypes['ShopPayConfiguration']> = {
  checkoutOne?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  transactionParams?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  transactionUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayCreditCardGetUpdateUrlPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayCreditCardGetUpdateUrlPayload'] = ResolversParentTypes['ShopPayCreditCardGetUpdateUrlPayload']> = {
  updateShopPayCreditCardUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsPaymentInstrumentUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type StoreCreditAccountResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccount'] = ResolversParentTypes['StoreCreditAccount']> = {
  balance?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  transactions?: Resolver<ResolversTypes['StoreCreditAccountTransactionConnection'], ParentType, ContextType, RequireFields<StoreCreditAccountTransactionsArgs, 'reverse' | 'sortKey'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountConnection'] = ResolversParentTypes['StoreCreditAccountConnection']> = {
  edges?: Resolver<Array<ResolversTypes['StoreCreditAccountEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['StoreCreditAccount']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountCreditTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountCreditTransaction'] = ResolversParentTypes['StoreCreditAccountCreditTransaction']> = {
  account?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  balanceAfterTransaction?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  expiresAt?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  remainingAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountDebitRevertTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountDebitRevertTransaction'] = ResolversParentTypes['StoreCreditAccountDebitRevertTransaction']> = {
  account?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  balanceAfterTransaction?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  debitTransaction?: Resolver<ResolversTypes['StoreCreditAccountDebitTransaction'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountDebitTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountDebitTransaction'] = ResolversParentTypes['StoreCreditAccountDebitTransaction']> = {
  account?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  balanceAfterTransaction?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type StoreCreditAccountEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountEdge'] = ResolversParentTypes['StoreCreditAccountEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountExpirationTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountExpirationTransaction'] = ResolversParentTypes['StoreCreditAccountExpirationTransaction']> = {
  account?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  balanceAfterTransaction?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creditTransaction?: Resolver<ResolversTypes['StoreCreditAccountCreditTransaction'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountTransactionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountTransaction'] = ResolversParentTypes['StoreCreditAccountTransaction']> = {
  __resolveType: TypeResolveFn<'StoreCreditAccountCreditTransaction' | 'StoreCreditAccountDebitRevertTransaction' | 'StoreCreditAccountDebitTransaction' | 'StoreCreditAccountExpirationTransaction', ParentType, ContextType>;
  account?: Resolver<ResolversTypes['StoreCreditAccount'], ParentType, ContextType>;
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  balanceAfterTransaction?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
...
export type StoreCreditAccountTransactionConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountTransactionConnection'] = ResolversParentTypes['StoreCreditAccountTransactionConnection']> = {
  edges?: Resolver<Array<ResolversTypes['StoreCreditAccountTransactionEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['StoreCreditAccountTransaction']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StoreCreditAccountTransactionEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreCreditAccountTransactionEdge'] = ResolversParentTypes['StoreCreditAccountTransactionEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['StoreCreditAccountTransaction'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type StorefrontCustomerAccessTokenCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['StorefrontCustomerAccessTokenCreatePayload'] = ResolversParentTypes['StorefrontCustomerAccessTokenCreatePayload']> = {
  customerAccessToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsStorefrontCustomerAccessTokenCreateUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionAnchorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionAnchor'] = ResolversParentTypes['SubscriptionAnchor']> = {
  __resolveType: TypeResolveFn<'SubscriptionMonthDayAnchor' | 'SubscriptionWeekDayAnchor' | 'SubscriptionYearDayAnchor', ParentType, ContextType>;
};

export type SubscriptionBillingCycleResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycle'] = ResolversParentTypes['SubscriptionBillingCycle']> = {
  billingAttemptExpectedDate?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  ...
  status?: Resolver<ResolversTypes['SubscriptionBillingCycleBillingCycleStatus'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleConnection'] = ResolversParentTypes['SubscriptionBillingCycleConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SubscriptionBillingCycleEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['SubscriptionBillingCycle']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleEdge'] = ResolversParentTypes['SubscriptionBillingCycleEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['SubscriptionBillingCycle'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleSkipPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleSkipPayload'] = ResolversParentTypes['SubscriptionBillingCycleSkipPayload']> = {
  billingCycle?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycle']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionBillingCycleSkipUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleSkipUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleSkipUserError'] = ResolversParentTypes['SubscriptionBillingCycleSkipUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycleSkipUserErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleUnskipPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleUnskipPayload'] = ResolversParentTypes['SubscriptionBillingCycleUnskipPayload']> = {
  billingCycle?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycle']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionBillingCycleUnskipUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingCycleUnskipUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingCycleUnskipUserError'] = ResolversParentTypes['SubscriptionBillingCycleUnskipUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['SubscriptionBillingCycleUnskipUserErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionBillingPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionBillingPolicy'] = ResolversParentTypes['SubscriptionBillingPolicy']> = {
  anchors?: Resolver<Array<ResolversTypes['SubscriptionAnchor']>, ParentType, ContextType>;
  interval?: Resolver<ResolversTypes['SubscriptionInterval'], ParentType, ContextType>;
  intervalCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
...
export type SubscriptionContractResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContract'] = ResolversParentTypes['SubscriptionContract']> = {
  appEligibleForCustomerActions?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  billingPolicy?: Resolver<ResolversTypes['SubscriptionBillingPolicy'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  currencyCode?: Resolver<ResolversTypes['CurrencyCode'], ParentType, ContextType>;
  customAttributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  deliveryMethod?: Resolver<Maybe<ResolversTypes['SubscriptionDeliveryMethod']>, ParentType, ContextType>;
  deliveryPolicy?: Resolver<ResolversTypes['SubscriptionDeliveryPolicy'], ParentType, ContextType>;
  deliveryPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastBillingAttemptErrorType?: Resolver<Maybe<ResolversTypes['SubscriptionContractLastBillingErrorType']>, ParentType, ContextType>;
  lastPaymentStatus?: Resolver<Maybe<ResolversTypes['SubscriptionContractLastPaymentStatus']>, ParentType, ContextType>;
  lineCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  lines?: Resolver<ResolversTypes['SubscriptionLineConnection'], ParentType, ContextType, RequireFields<SubscriptionContractLinesArgs, 'reverse'>>;
  linesCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
  nextBillingDate?: Resolver<Maybe<ResolversTypes['DateTime']>, ParentType, ContextType>;
  note?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<SubscriptionContractOrdersArgs, 'reverse'>>;
  originOrder?: Resolver<Maybe<ResolversTypes['Order']>, ParentType, ContextType>;
  paymentInstrument?: Resolver<Maybe<ResolversTypes['PaymentInstrument']>, ParentType, ContextType>;
  priceBreakdownEstimate?: Resolver<Maybe<ResolversTypes['SubscriptionPriceBreakdown']>, ParentType, ContextType>;
  revisionId?: Resolver<ResolversTypes['UnsignedInt64'], ParentType, ContextType>;
  status?: Resolver<ResolversTypes['SubscriptionContractSubscriptionStatus'], ParentType, ContextType>;
  upcomingBillingCycles?: Resolver<ResolversTypes['SubscriptionBillingCycleConnection'], ParentType, ContextType, RequireFields<SubscriptionContractUpcomingBillingCyclesArgs, 'reverse' | 'sortKey'>>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractActivatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractActivatePayload'] = ResolversParentTypes['SubscriptionContractActivatePayload']> = {
  contract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractStatusUpdateUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractBaseResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractBase'] = ResolversParentTypes['SubscriptionContractBase']> = {
  ...
  deliveryPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  lineCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  lines?: Resolver<ResolversTypes['SubscriptionLineConnection'], ParentType, ContextType, RequireFields<SubscriptionContractBaseLinesArgs, 'reverse'>>;
  linesCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
  note?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  orders?: Resolver<ResolversTypes['OrderConnection'], ParentType, ContextType, RequireFields<SubscriptionContractBaseOrdersArgs, 'reverse'>>;
  priceBreakdownEstimate?: Resolver<Maybe<ResolversTypes['SubscriptionPriceBreakdown']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type SubscriptionContractCancelPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractCancelPayload'] = ResolversParentTypes['SubscriptionContractCancelPayload']> = {
  contract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractStatusUpdateUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractChangePaymentInstrumentPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractChangePaymentInstrumentPayload'] = ResolversParentTypes['SubscriptionContractChangePaymentInstrumentPayload']> = {
  contract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SubscriptionContractConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractConnection'] = ResolversParentTypes['SubscriptionContractConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SubscriptionContractEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractEdge'] = ResolversParentTypes['SubscriptionContractEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['SubscriptionContract'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractFetchDeliveryOptionsPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractFetchDeliveryOptionsPayload'] = ResolversParentTypes['SubscriptionContractFetchDeliveryOptionsPayload']> = {
  deliveryOptionsResult?: Resolver<Maybe<ResolversTypes['SubscriptionDeliveryOptionsResult']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractPausePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractPausePayload'] = ResolversParentTypes['SubscriptionContractPausePayload']> = {
  contract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractStatusUpdateUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractSelectDeliveryMethodPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractSelectDeliveryMethodPayload'] = ResolversParentTypes['SubscriptionContractSelectDeliveryMethodPayload']> = {
  contract?: Resolver<Maybe<ResolversTypes['SubscriptionContract']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['SubscriptionContractUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractStatusUpdateUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractStatusUpdateUserError'] = ResolversParentTypes['SubscriptionContractStatusUpdateUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['SubscriptionContractStatusUpdateErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionContractUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionContractUserError'] = ResolversParentTypes['SubscriptionContractUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['SubscriptionContractUserErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethod'] = ResolversParentTypes['SubscriptionDeliveryMethod']> = {
  __resolveType: TypeResolveFn<'SubscriptionDeliveryMethodLocalDelivery' | 'SubscriptionDeliveryMethodPickup' | 'SubscriptionDeliveryMethodShipping', ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodLocalDeliveryResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodLocalDelivery'] = ResolversParentTypes['SubscriptionDeliveryMethodLocalDelivery']> = {
  address?: Resolver<ResolversTypes['SubscriptionMailingAddress'], ParentType, ContextType>;
  localDeliveryOption?: Resolver<ResolversTypes['SubscriptionDeliveryMethodLocalDeliveryOption'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodLocalDeliveryOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodLocalDeliveryOption'] = ResolversParentTypes['SubscriptionDeliveryMethodLocalDeliveryOption']> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionDeliveryMethodPickupResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodPickup'] = ResolversParentTypes['SubscriptionDeliveryMethodPickup']> = {
  pickupOption?: Resolver<ResolversTypes['SubscriptionDeliveryMethodPickupOption'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodPickupOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodPickupOption'] = ResolversParentTypes['SubscriptionDeliveryMethodPickupOption']> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  pickupAddress?: Resolver<ResolversTypes['PickupAddress'], ParentType, ContextType>;
  presentmentTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodShippingResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodShipping'] = ResolversParentTypes['SubscriptionDeliveryMethodShipping']> = {
  address?: Resolver<ResolversTypes['SubscriptionMailingAddress'], ParentType, ContextType>;
  shippingOption?: Resolver<ResolversTypes['SubscriptionDeliveryMethodShippingOption'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryMethodShippingOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryMethodShippingOption'] = ResolversParentTypes['SubscriptionDeliveryMethodShippingOption']> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  presentmentTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type SubscriptionDeliveryOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryOption'] = ResolversParentTypes['SubscriptionDeliveryOption']> = {
  __resolveType: TypeResolveFn<'SubscriptionLocalDeliveryOption' | 'SubscriptionPickupOption' | 'SubscriptionShippingOption', ParentType, ContextType>;
};

export type SubscriptionDeliveryOptionsResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryOptionsResult'] = ResolversParentTypes['SubscriptionDeliveryOptionsResult']> = {
  __resolveType: TypeResolveFn<'SubscriptionDeliveryOptionsResultFailure' | 'SubscriptionDeliveryOptionsResultSuccess', ParentType, ContextType>;
};

export type SubscriptionDeliveryOptionsResultFailureResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryOptionsResultFailure'] = ResolversParentTypes['SubscriptionDeliveryOptionsResultFailure']> = {
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryOptionsResultSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryOptionsResultSuccess'] = ResolversParentTypes['SubscriptionDeliveryOptionsResultSuccess']> = {
  deliveryOptions?: Resolver<Array<ResolversTypes['SubscriptionDeliveryOption']>, ParentType, ContextType>;
  token?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionDeliveryPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionDeliveryPolicy'] = ResolversParentTypes['SubscriptionDeliveryPolicy']> = {
  anchors?: Resolver<Array<ResolversTypes['SubscriptionAnchor']>, ParentType, ContextType>;
  interval?: Resolver<ResolversTypes['SubscriptionInterval'], ParentType, ContextType>;
  intervalCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type SubscriptionLineResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionLine'] = ResolversParentTypes['SubscriptionLine']> = {
  currentPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  customAttributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  lineDiscountedPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  taxable?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  variantImage?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  variantTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionLineConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionLineConnection'] = ResolversParentTypes['SubscriptionLineConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SubscriptionLineEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['SubscriptionLine']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionLineEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionLineEdge'] = ResolversParentTypes['SubscriptionLineEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['SubscriptionLine'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionLocalDeliveryOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionLocalDeliveryOption'] = ResolversParentTypes['SubscriptionLocalDeliveryOption']> = {
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionMailingAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionMailingAddress'] = ResolversParentTypes['SubscriptionMailingAddress']> = {
  address1?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  address2?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  city?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  company?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionMonthDayAnchorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionMonthDayAnchor'] = ResolversParentTypes['SubscriptionMonthDayAnchor']> = {
  dayOfMonth?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionPickupOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPickupOption'] = ResolversParentTypes['SubscriptionPickupOption']> = {
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionPriceBreakdownResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionPriceBreakdown'] = ResolversParentTypes['SubscriptionPriceBreakdown']> = {
  subtotalPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  taxesIncluded?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  totalDiscounts?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
...
export type SubscriptionShippingOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionShippingOption'] = ResolversParentTypes['SubscriptionShippingOption']> = {
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  phoneRequired?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  presentmentTitle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SubscriptionWeekDayAnchorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionWeekDayAnchor'] = ResolversParentTypes['SubscriptionWeekDayAnchor']> = {
  dayOfWeek?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubscriptionYearDayAnchorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubscriptionYearDayAnchor'] = ResolversParentTypes['SubscriptionYearDayAnchor']> = {
  dayOfMonth?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  month?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TaxExemptionDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TaxExemptionDetails'] = ResolversParentTypes['TaxExemptionDetails']> = {
  ...
  exemptionGroupName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  groupedName?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  taxRegionCode?: Resolver<Maybe<ResolversTypes['TaxRegionCode']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['TaxExemption'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TaxInvoiceResolvers<ContextType = any, ParentType extends ResolversParentTypes['TaxInvoice'] = ResolversParentTypes['TaxInvoice']> = {
  ...
  status?: Resolver<ResolversTypes['TaxInvoiceStatus'], ParentType, ContextType>;
  url?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TipSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['TipSale'] = ResolversParentTypes['TipSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineItem?: Resolver<ResolversTypes['LineItem'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
...
export type TrackingInformationResolvers<ContextType = any, ParentType extends ResolversParentTypes['TrackingInformation'] = ResolversParentTypes['TrackingInformation']> = {
  company?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type TransactionTypeDetailsResolvers<ContextType = any, ParentType extends ResolversParentTypes['TransactionTypeDetails'] = ResolversParentTypes['TransactionTypeDetails']> = {
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  name?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type UiExtensionMetafieldResolvers<ContextType = any, ParentType extends ResolversParentTypes['UiExtensionMetafield'] = ResolversParentTypes['UiExtensionMetafield']> = {
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  key?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  namespace?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type UiExtensionSessionTokenResolvers<ContextType = any, ParentType extends ResolversParentTypes['UiExtensionSessionToken'] = ResolversParentTypes['UiExtensionSessionToken']> = {
  expiresIn?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  value?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnfulfilledDigitalLineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnfulfilledDigitalLineItemContainer'] = ResolversParentTypes['UnfulfilledDigitalLineItemContainer']> = {
  lineItems?: Resolver<ResolversTypes['LineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<UnfulfilledDigitalLineItemContainerLineItemsArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnfulfilledGiftCardLineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnfulfilledGiftCardLineItemContainer'] = ResolversParentTypes['UnfulfilledGiftCardLineItemContainer']> = {
  lineItems?: Resolver<ResolversTypes['LineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<UnfulfilledGiftCardLineItemContainerLineItemsArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnfulfilledLineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnfulfilledLineItemContainer'] = ResolversParentTypes['UnfulfilledLineItemContainer']> = {
  displayableState?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['LineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<UnfulfilledLineItemContainerLineItemsArgs, 'reverse'>>;
  state?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnfulfilledLineItemContainerCommonFieldsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnfulfilledLineItemContainerCommonFields'] = ResolversParentTypes['UnfulfilledLineItemContainerCommonFields']> = {
  __resolveType: TypeResolveFn<'UnfulfilledDigitalLineItemContainer' | 'UnfulfilledGiftCardLineItemContainer' | 'UnfulfilledLineItemContainer' | 'UnfulfilledPhysicalLineItemContainer', ParentType, ContextType>;
  lineItems?: Resolver<ResolversTypes['LineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<UnfulfilledLineItemContainerCommonFieldsLineItemsArgs, 'reverse'>>;
};

export type UnfulfilledPhysicalLineItemContainerResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnfulfilledPhysicalLineItemContainer'] = ResolversParentTypes['UnfulfilledPhysicalLineItemContainer']> = {
  lineItems?: Resolver<ResolversTypes['LineItemContainerLineItemConnection'], ParentType, ContextType, RequireFields<UnfulfilledPhysicalLineItemContainerLineItemsArgs, 'reverse'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnitPriceResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnitPrice'] = ResolversParentTypes['UnitPrice']> = {
  measurement?: Resolver<ResolversTypes['UnitPriceMeasurement'], ParentType, ContextType>;
  price?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type UnitPriceMeasurementResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnitPriceMeasurement'] = ResolversParentTypes['UnitPriceMeasurement']> = {
  referenceUnit?: Resolver<ResolversTypes['UnitPriceMeasurementUnit'], ParentType, ContextType>;
  referenceValue?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UnknownSaleResolvers<ContextType = any, ParentType extends ResolversParentTypes['UnknownSale'] = ResolversParentTypes['UnknownSale']> = {
  actionType?: Resolver<ResolversTypes['SaleActionType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineType?: Resolver<ResolversTypes['SaleLineType'], ParentType, ContextType>;
  quantity?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
...
export type UserErrorsBusinessContactUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsBusinessContactUserErrors'] = ResolversParentTypes['UserErrorsBusinessContactUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsBusinessContactUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsBusinessLocationPaymentInstrumentUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrors'] = ResolversParentTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsBusinessLocationPaymentInstrumentUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsCustomerAddressUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsCustomerAddressUserErrors'] = ResolversParentTypes['UserErrorsCustomerAddressUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsCustomerAddressUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsCustomerEmailMarketingOptInUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsCustomerEmailMarketingOptInUserErrors'] = ResolversParentTypes['UserErrorsCustomerEmailMarketingOptInUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsCustomerEmailMarketingOptInUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsCustomerEmailMarketingUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsCustomerEmailMarketingUserErrors'] = ResolversParentTypes['UserErrorsCustomerEmailMarketingUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsCustomerEmailMarketingUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsCustomerUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsCustomerUserErrors'] = ResolversParentTypes['UserErrorsCustomerUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsCustomerUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsPaymentInstrumentUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsPaymentInstrumentUserErrors'] = ResolversParentTypes['UserErrorsPaymentInstrumentUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsPaymentInstrumentUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsPaypalTokenUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsPaypalTokenUserErrors'] = ResolversParentTypes['UserErrorsPaypalTokenUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsPaypalTokenUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsResendGiftCardErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsResendGiftCardErrors'] = ResolversParentTypes['UserErrorsResendGiftCardErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsResendGiftCardErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UserErrorsStorefrontCustomerAccessTokenCreateUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsStorefrontCustomerAccessTokenCreateUserErrors'] = ResolversParentTypes['UserErrorsStorefrontCustomerAccessTokenCreateUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsStorefrontCustomerAccessTokenCreateUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type WalletPaymentConfigResolvers<ContextType = any, ParentType extends ResolversParentTypes['WalletPaymentConfig'] = ResolversParentTypes['WalletPaymentConfig']> = {
  __resolveType: TypeResolveFn<'ApplePayWalletConfig' | 'GooglePayWalletConfig', ParentType, ContextType>;
};
