...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = {
  ...
  CartCompletionAttemptResult: ( Omit<CartCompletionActionRequired, 'action'> & { action?: Maybe<_RefType['CartCompletionAction']> } ) | ( CartCompletionFailed ) | ( CartCompletionProcessing ) | ( CartCompletionSuccess );
  CartPrepareForCompletionResult: ( Omit<CartStatusNotReady, 'cart'> & { cart?: Maybe<_RefType['Cart']> } ) | ( Omit<CartStatusReady, 'cart'> & { cart?: Maybe<_RefType['Cart']> } ) | ( CartThrottled );
  CartSubmitForCompletionResult: ( SubmitAlreadyAccepted ) | ( SubmitFailed ) | ( SubmitSuccess ) | ( SubmitThrottled );
  DeliveryAddress: ( MailingAddress );
  MenuItemResource: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<_RefType['Article']>, articles: _RefType['ArticleConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<_RefType['MetaobjectField']>, fields: Array<_RefType['MetaobjectField']>, seo?: Maybe<_RefType['MetaobjectSEO']> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( ShopPolicy );
  Merchandise: ( Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, product: _RefType['Product'], sellingPlanAllocations: _RefType['SellingPlanAllocationConnection'], storeAvailability: _RefType['StoreAvailabilityConnection'] } );
  MetafieldParentResource: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<_RefType['Article']>, articles: _RefType['ArticleConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Cart, 'buyerIdentity' | 'delivery' | 'deliveryGroups' | 'discountAllocations' | 'lines' | 'metafield' | 'metafields'> & { buyerIdentity: _RefType['CartBuyerIdentity'], delivery: _RefType['CartDelivery'], deliveryGroups: _RefType['CartDeliveryGroupConnection'], discountAllocations: Array<_RefType['CartDiscountAllocation']>, lines: _RefType['BaseCartLineConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<Company, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<CompanyLocation, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Customer, 'metafield' | 'metafields' | 'orders'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, orders: _RefType['OrderConnection'] } ) | ( Omit<Location, 'address' | 'metafield' | 'metafields'> & { address: _RefType['LocationAddress'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Market, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Order, 'discountApplications' | 'lineItems' | 'metafield' | 'metafields' | 'shippingDiscountAllocations' | 'successfulFulfillments'> & { discountApplications: _RefType['DiscountApplicationConnection'], lineItems: _RefType['OrderLineItemConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, successfulFulfillments?: Maybe<Array<_RefType['Fulfillment']>> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, product: _RefType['Product'], sellingPlanAllocations: _RefType['SellingPlanAllocationConnection'], storeAvailability: _RefType['StoreAvailabilityConnection'] } ) | ( Omit<SellingPlan, 'billingPolicy' | 'checkoutCharge' | 'deliveryPolicy' | 'metafield' | 'metafields' | 'priceAdjustments'> & { billingPolicy?: Maybe<_RefType['SellingPlanBillingPolicy']>, checkoutCharge: _RefType['SellingPlanCheckoutCharge'], deliveryPolicy?: Maybe<_RefType['SellingPlanDeliveryPolicy']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, priceAdjustments: Array<_RefType['SellingPlanPriceAdjustment']> } ) | ( Omit<Shop, 'brand' | 'metafield' | 'metafields'> & { brand?: Maybe<_RefType['Brand']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } );
  MetafieldReference: ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<GenericFile, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<MediaImage, 'image' | 'previewImage'> & { image?: Maybe<_RefType['Image']>, previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<_RefType['MetaobjectField']>, fields: Array<_RefType['MetaobjectField']>, seo?: Maybe<_RefType['MetaobjectSEO']> } ) | ( Omit<Model3d, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, product: _RefType['Product'], sellingPlanAllocations: _RefType['SellingPlanAllocationConnection'], storeAvailability: _RefType['StoreAvailabilityConnection'] } ) | ( Omit<Video, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } );
  PricingValue: ( MoneyV2 ) | ( PricingPercentageValue );
  SearchResultItem: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } );
...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = {
  BaseCartLine: ( Omit<CartLine, 'discountAllocations' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<_RefType['CartDiscountAllocation']>, merchandise: _RefType['Merchandise'], sellingPlanAllocation?: Maybe<_RefType['SellingPlanAllocation']> } ) | ( Omit<ComponentizableCartLine, 'discountAllocations' | 'lineComponents' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<_RefType['CartDiscountAllocation']>, lineComponents: Array<_RefType['CartLine']>, merchandise: _RefType['Merchandise'], sellingPlanAllocation?: Maybe<_RefType['SellingPlanAllocation']> } );
  CartDiscountAllocation: ( Omit<CartAutomaticDiscountAllocation, 'discountApplication'> & { discountApplication: _RefType['CartDiscountApplication'] } ) | ( Omit<CartCodeDiscountAllocation, 'discountApplication'> & { discountApplication: _RefType['CartDiscountApplication'] } ) | ( Omit<CartCustomDiscountAllocation, 'discountApplication'> & { discountApplication: _RefType['CartDiscountApplication'] } );
  ...
  DisplayableError: ( CartUserError ) | ( CustomerUserError ) | ( MetafieldDeleteUserError ) | ( MetafieldsSetUserError ) | ( UserError ) | ( UserErrorsShopPayPaymentRequestSessionUserErrors );
  HasMetafields: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<_RefType['Article']>, articles: _RefType['ArticleConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Cart, 'buyerIdentity' | 'delivery' | 'deliveryGroups' | 'discountAllocations' | 'lines' | 'metafield' | 'metafields'> & { buyerIdentity: _RefType['CartBuyerIdentity'], delivery: _RefType['CartDelivery'], deliveryGroups: _RefType['CartDeliveryGroupConnection'], discountAllocations: Array<_RefType['CartDiscountAllocation']>, lines: _RefType['BaseCartLineConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<Company, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<CompanyLocation, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Customer, 'metafield' | 'metafields' | 'orders'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, orders: _RefType['OrderConnection'] } ) | ( Omit<Location, 'address' | 'metafield' | 'metafields'> & { address: _RefType['LocationAddress'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Market, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Order, 'discountApplications' | 'lineItems' | 'metafield' | 'metafields' | 'shippingDiscountAllocations' | 'successfulFulfillments'> & { discountApplications: _RefType['DiscountApplicationConnection'], lineItems: _RefType['OrderLineItemConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, successfulFulfillments?: Maybe<Array<_RefType['Fulfillment']>> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, product: _RefType['Product'], sellingPlanAllocations: _RefType['SellingPlanAllocationConnection'], storeAvailability: _RefType['StoreAvailabilityConnection'] } ) | ( Omit<SellingPlan, 'billingPolicy' | 'checkoutCharge' | 'deliveryPolicy' | 'metafield' | 'metafields' | 'priceAdjustments'> & { billingPolicy?: Maybe<_RefType['SellingPlanBillingPolicy']>, checkoutCharge: _RefType['SellingPlanCheckoutCharge'], deliveryPolicy?: Maybe<_RefType['SellingPlanDeliveryPolicy']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, priceAdjustments: Array<_RefType['SellingPlanPriceAdjustment']> } ) | ( Omit<Shop, 'brand' | 'metafield' | 'metafields'> & { brand?: Maybe<_RefType['Brand']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } );
  Media: ( Omit<ExternalVideo, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<MediaImage, 'image' | 'previewImage'> & { image?: Maybe<_RefType['Image']>, previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Model3d, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Video, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } );
  Node: ( AppliedGiftCard ) | ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<_RefType['Article']>, articles: _RefType['ArticleConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Cart, 'buyerIdentity' | 'delivery' | 'deliveryGroups' | 'discountAllocations' | 'lines' | 'metafield' | 'metafields'> & { buyerIdentity: _RefType['CartBuyerIdentity'], delivery: _RefType['CartDelivery'], deliveryGroups: _RefType['CartDeliveryGroupConnection'], discountAllocations: Array<_RefType['CartDiscountAllocation']>, lines: _RefType['BaseCartLineConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<CartLine, 'discountAllocations' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<_RefType['CartDiscountAllocation']>, merchandise: _RefType['Merchandise'], sellingPlanAllocation?: Maybe<_RefType['SellingPlanAllocation']> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Comment ) | ( Omit<Company, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( CompanyContact ) | ( Omit<CompanyLocation, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<ComponentizableCartLine, 'discountAllocations' | 'lineComponents' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<_RefType['CartDiscountAllocation']>, lineComponents: Array<_RefType['CartLine']>, merchandise: _RefType['Merchandise'], sellingPlanAllocation?: Maybe<_RefType['SellingPlanAllocation']> } ) | ( Omit<ExternalVideo, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<GenericFile, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Location, 'address' | 'metafield' | 'metafields'> & { address: _RefType['LocationAddress'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( MailingAddress ) | ( Omit<Market, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<MediaImage, 'image' | 'previewImage'> & { image?: Maybe<_RefType['Image']>, previewImage?: Maybe<_RefType['Image']> } ) | ( MediaPresentation ) | ( Omit<Menu, 'items'> & { items: Array<_RefType['MenuItem']> } ) | ( Omit<MenuItem, 'items' | 'resource'> & { items: Array<_RefType['MenuItem']>, resource?: Maybe<_RefType['MenuItemResource']> } ) | ( Omit<Metafield, 'parentResource' | 'reference' | 'references'> & { parentResource: _RefType['MetafieldParentResource'], reference?: Maybe<_RefType['MetafieldReference']>, references?: Maybe<_RefType['MetafieldReferenceConnection']> } ) | ( Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<_RefType['MetaobjectField']>, fields: Array<_RefType['MetaobjectField']>, seo?: Maybe<_RefType['MetaobjectSEO']> } ) | ( Omit<Model3d, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } ) | ( Omit<Order, 'discountApplications' | 'lineItems' | 'metafield' | 'metafields' | 'shippingDiscountAllocations' | 'successfulFulfillments'> & { discountApplications: _RefType['DiscountApplicationConnection'], lineItems: _RefType['OrderLineItemConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, shippingDiscountAllocations: Array<_RefType['DiscountAllocation']>, successfulFulfillments?: Maybe<Array<_RefType['Fulfillment']>> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( Omit<ProductOption, 'optionValues'> & { optionValues: Array<_RefType['ProductOptionValue']> } ) | ( Omit<ProductOptionValue, 'firstSelectableVariant' | 'swatch'> & { firstSelectableVariant?: Maybe<_RefType['ProductVariant']>, swatch?: Maybe<_RefType['ProductOptionValueSwatch']> } ) | ( Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, product: _RefType['Product'], sellingPlanAllocations: _RefType['SellingPlanAllocationConnection'], storeAvailability: _RefType['StoreAvailabilityConnection'] } ) | ( Omit<Shop, 'brand' | 'metafield' | 'metafields'> & { brand?: Maybe<_RefType['Brand']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( ShopPayInstallmentsFinancingPlan ) | ( ShopPayInstallmentsFinancingPlanTerm ) | ( ShopPayInstallmentsProductVariantPricing ) | ( ShopPolicy ) | ( TaxonomyCategory ) | ( UrlRedirect ) | ( Omit<Video, 'previewImage'> & { previewImage?: Maybe<_RefType['Image']> } );
  OnlineStorePublishable: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<_RefType['Article']>, articles: _RefType['ArticleConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<_RefType['MetaobjectField']>, fields: Array<_RefType['MetaobjectField']>, seo?: Maybe<_RefType['MetaobjectSEO']> } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } );
  SitemapResourceInterface: ( SitemapResource ) | ( SitemapResourceMetaobject );
  Trackable: ( Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: _RefType['Blog'], image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<_RefType['Image']>, metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, products: _RefType['ProductConnection'] } ) | ( Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>> } ) | ( Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<_RefType['ProductVariant']>, collections: _RefType['CollectionConnection'], featuredImage?: Maybe<_RefType['Image']>, images: _RefType['ImageConnection'], media: _RefType['MediaConnection'], metafield?: Maybe<_RefType['Metafield']>, metafields: Array<Maybe<_RefType['Metafield']>>, options: Array<_RefType['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<_RefType['ProductVariant']>, sellingPlanGroups: _RefType['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<_RefType['ProductVariant']> } ) | ( SearchQuerySuggestion );
};
...
export type ResolversTypes = {
  ...
  Article: ResolverTypeWrapper<Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: ResolversTypes['Blog'], image?: Maybe<ResolversTypes['Image']>, metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  ...
  BaseCartLine: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['BaseCartLine']>;
  BaseCartLineConnection: ResolverTypeWrapper<Omit<BaseCartLineConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['BaseCartLineEdge']>, nodes: Array<ResolversTypes['BaseCartLine']> }>;
  BaseCartLineEdge: ResolverTypeWrapper<Omit<BaseCartLineEdge, 'node'> & { node: ResolversTypes['BaseCartLine'] }>;
  Blog: ResolverTypeWrapper<Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<ResolversTypes['Article']>, articles: ResolversTypes['ArticleConnection'], metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  BlogConnection: ResolverTypeWrapper<Omit<BlogConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['BlogEdge']>, nodes: Array<ResolversTypes['Blog']> }>;
  BlogEdge: ResolverTypeWrapper<Omit<BlogEdge, 'node'> & { node: ResolversTypes['Blog'] }>;
  BlogSortKeys: BlogSortKeys;
  Boolean: ResolverTypeWrapper<Scalars['Boolean']['output']>;
  Brand: ResolverTypeWrapper<Omit<Brand, 'coverImage' | 'logo' | 'squareLogo'> & { coverImage?: Maybe<ResolversTypes['MediaImage']>, logo?: Maybe<ResolversTypes['MediaImage']>, squareLogo?: Maybe<ResolversTypes['MediaImage']> }>;
  BrandColorGroup: ResolverTypeWrapper<BrandColorGroup>;
  BrandColors: ResolverTypeWrapper<BrandColors>;
  BuyerInput: BuyerInput;
  CardBrand: CardBrand;
  Cart: ResolverTypeWrapper<Omit<Cart, 'buyerIdentity' | 'delivery' | 'deliveryGroups' | 'discountAllocations' | 'lines' | 'metafield' | 'metafields'> & { buyerIdentity: ResolversTypes['CartBuyerIdentity'], delivery: ResolversTypes['CartDelivery'], deliveryGroups: ResolversTypes['CartDeliveryGroupConnection'], discountAllocations: Array<ResolversTypes['CartDiscountAllocation']>, lines: ResolversTypes['BaseCartLineConnection'], metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  CartAddress: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CartAddress']>;
  ...
  CartAutomaticDiscountAllocation: ResolverTypeWrapper<Omit<CartAutomaticDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversTypes['CartDiscountApplication'] }>;
  CartBillingAddressUpdatePayload: ResolverTypeWrapper<Omit<CartBillingAddressUpdatePayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartBuyerIdentity: ResolverTypeWrapper<Omit<CartBuyerIdentity, 'customer' | 'deliveryAddressPreferences' | 'purchasingCompany'> & { customer?: Maybe<ResolversTypes['Customer']>, deliveryAddressPreferences: Array<ResolversTypes['DeliveryAddress']>, purchasingCompany?: Maybe<ResolversTypes['PurchasingCompany']> }>;
  ...
  CartCodeDiscountAllocation: ResolverTypeWrapper<Omit<CartCodeDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversTypes['CartDiscountApplication'] }>;
  CartCompletionAction: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CartCompletionAction']>;
  CartCompletionActionRequired: ResolverTypeWrapper<Omit<CartCompletionActionRequired, 'action'> & { action?: Maybe<ResolversTypes['CartCompletionAction']> }>;
  CartCompletionAttemptResult: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CartCompletionAttemptResult']>;
  ...
  CartCustomDiscountAllocation: ResolverTypeWrapper<Omit<CartCustomDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversTypes['CartDiscountApplication'] }>;
  CartDelivery: ResolverTypeWrapper<Omit<CartDelivery, 'addresses'> & { addresses: Array<ResolversTypes['CartSelectableAddress']> }>;
  CartDeliveryAddress: ResolverTypeWrapper<CartDeliveryAddress>;
  CartDeliveryAddressInput: CartDeliveryAddressInput;
  CartDeliveryAddressesAddPayload: ResolverTypeWrapper<Omit<CartDeliveryAddressesAddPayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartDeliveryAddressesRemovePayload: ResolverTypeWrapper<Omit<CartDeliveryAddressesRemovePayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartDeliveryAddressesUpdatePayload: ResolverTypeWrapper<Omit<CartDeliveryAddressesUpdatePayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  ...
  CartDeliveryGroup: ResolverTypeWrapper<Omit<CartDeliveryGroup, 'cartLines'> & { cartLines: ResolversTypes['BaseCartLineConnection'] }>;
  CartDeliveryGroupConnection: ResolverTypeWrapper<Omit<CartDeliveryGroupConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['CartDeliveryGroupEdge']>, nodes: Array<ResolversTypes['CartDeliveryGroup']> }>;
  CartDeliveryGroupEdge: ResolverTypeWrapper<Omit<CartDeliveryGroupEdge, 'node'> & { node: ResolversTypes['CartDeliveryGroup'] }>;
  ...
  CartDiscountAllocation: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['CartDiscountAllocation']>;
  CartDiscountApplication: ResolverTypeWrapper<Omit<CartDiscountApplication, 'value'> & { value: ResolversTypes['PricingValue'] }>;
  ...
  CartLine: ResolverTypeWrapper<Omit<CartLine, 'discountAllocations' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<ResolversTypes['CartDiscountAllocation']>, merchandise: ResolversTypes['Merchandise'], sellingPlanAllocation?: Maybe<ResolversTypes['SellingPlanAllocation']> }>;
  ...
  CartMetafieldsSetPayload: ResolverTypeWrapper<Omit<CartMetafieldsSetPayload, 'metafields'> & { metafields?: Maybe<Array<ResolversTypes['Metafield']>> }>;
  ...
  CartPaymentUpdatePayload: ResolverTypeWrapper<Omit<CartPaymentUpdatePayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartPreferences: ResolverTypeWrapper<CartPreferences>;
  CartPreferencesInput: CartPreferencesInput;
  CartPrepareForCompletionPayload: ResolverTypeWrapper<Omit<CartPrepareForCompletionPayload, 'result'> & { result?: Maybe<ResolversTypes['CartPrepareForCompletionResult']> }>;
  CartPrepareForCompletionResult: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CartPrepareForCompletionResult']>;
  CartSelectableAddress: ResolverTypeWrapper<Omit<CartSelectableAddress, 'address'> & { address: ResolversTypes['CartAddress'] }>;
  ...
  CartSelectedDeliveryOptionsUpdatePayload: ResolverTypeWrapper<Omit<CartSelectedDeliveryOptionsUpdatePayload, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartStatusNotReady: ResolverTypeWrapper<Omit<CartStatusNotReady, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartStatusReady: ResolverTypeWrapper<Omit<CartStatusReady, 'cart'> & { cart?: Maybe<ResolversTypes['Cart']> }>;
  CartSubmitForCompletionPayload: ResolverTypeWrapper<Omit<CartSubmitForCompletionPayload, 'result'> & { result?: Maybe<ResolversTypes['CartSubmitForCompletionResult']> }>;
  CartSubmitForCompletionResult: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['CartSubmitForCompletionResult']>;
  ...
  Collection: ResolverTypeWrapper<Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<ResolversTypes['Image']>, metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, products: ResolversTypes['ProductConnection'] }>;
  ...
  Company: ResolverTypeWrapper<Omit<Company, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  CompanyContact: ResolverTypeWrapper<CompanyContact>;
  CompanyLocation: ResolverTypeWrapper<Omit<CompanyLocation, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  ...
  ComponentizableCartLine: ResolverTypeWrapper<Omit<ComponentizableCartLine, 'discountAllocations' | 'lineComponents' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<ResolversTypes['CartDiscountAllocation']>, lineComponents: Array<ResolversTypes['CartLine']>, merchandise: ResolversTypes['Merchandise'], sellingPlanAllocation?: Maybe<ResolversTypes['SellingPlanAllocation']> }>;
  Count: ResolverTypeWrapper<Count>;
  CountPrecision: CountPrecision;
  Country: ResolverTypeWrapper<Omit<Country, 'market'> & { market?: Maybe<ResolversTypes['Market']> }>;
  CountryCode: CountryCode;
  CropRegion: CropRegion;
  Currency: ResolverTypeWrapper<Currency>;
  CurrencyCode: CurrencyCode;
  Customer: ResolverTypeWrapper<Omit<Customer, 'metafield' | 'metafields' | 'orders'> & { metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, orders: ResolversTypes['OrderConnection'] }>;
  ...
  CustomerActivateByUrlPayload: ResolverTypeWrapper<Omit<CustomerActivateByUrlPayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  CustomerActivateInput: CustomerActivateInput;
  CustomerActivatePayload: ResolverTypeWrapper<Omit<CustomerActivatePayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  ...
  CustomerCreatePayload: ResolverTypeWrapper<Omit<CustomerCreatePayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  CustomerDefaultAddressUpdatePayload: ResolverTypeWrapper<Omit<CustomerDefaultAddressUpdatePayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  CustomerErrorCode: CustomerErrorCode;
  CustomerRecoverPayload: ResolverTypeWrapper<CustomerRecoverPayload>;
  CustomerResetByUrlPayload: ResolverTypeWrapper<Omit<CustomerResetByUrlPayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  CustomerResetInput: CustomerResetInput;
  CustomerResetPayload: ResolverTypeWrapper<Omit<CustomerResetPayload, 'customer'> & { customer?: Maybe<ResolversTypes['Customer']> }>;
  ...
  DeliveryAddress: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['DeliveryAddress']>;
  ...
  ExternalVideo: ResolverTypeWrapper<Omit<ExternalVideo, 'previewImage'> & { previewImage?: Maybe<ResolversTypes['Image']> }>;
  Filter: ResolverTypeWrapper<Omit<Filter, 'values'> & { values: Array<ResolversTypes['FilterValue']> }>;
  FilterPresentation: FilterPresentation;
  FilterType: FilterType;
  FilterValue: ResolverTypeWrapper<Omit<FilterValue, 'image' | 'swatch'> & { image?: Maybe<ResolversTypes['MediaImage']>, swatch?: Maybe<ResolversTypes['Swatch']> }>;
  ...
  FulfillmentLineItem: ResolverTypeWrapper<Omit<FulfillmentLineItem, 'lineItem'> & { lineItem: ResolversTypes['OrderLineItem'] }>;
  ...
  GenericFile: ResolverTypeWrapper<Omit<GenericFile, 'previewImage'> & { previewImage?: Maybe<ResolversTypes['Image']> }>;
  ...
  ImageConnection: ResolverTypeWrapper<Omit<ImageConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['ImageEdge']>, nodes: Array<ResolversTypes['Image']> }>;
  ...
  Localization: ResolverTypeWrapper<Omit<Localization, 'availableCountries' | 'country' | 'market'> & { availableCountries: Array<ResolversTypes['Country']>, country: ResolversTypes['Country'], market: ResolversTypes['Market'] }>;
  Location: ResolverTypeWrapper<Omit<Location, 'address' | 'metafield' | 'metafields'> & { address: ResolversTypes['LocationAddress'], metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  LocationAddress: ResolverTypeWrapper<LocationAddress>;
  LocationConnection: ResolverTypeWrapper<Omit<LocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['LocationEdge']>, nodes: Array<ResolversTypes['Location']> }>;
  ...
  Market: ResolverTypeWrapper<Omit<Market, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  Media: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Media']>;
  MediaConnection: ResolverTypeWrapper<Omit<MediaConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['MediaEdge']>, nodes: Array<ResolversTypes['Media']> }>;
  MediaContentType: MediaContentType;
  MediaEdge: ResolverTypeWrapper<Omit<MediaEdge, 'node'> & { node: ResolversTypes['Media'] }>;
  MediaHost: MediaHost;
  MediaImage: ResolverTypeWrapper<Omit<MediaImage, 'image' | 'previewImage'> & { image?: Maybe<ResolversTypes['Image']>, previewImage?: Maybe<ResolversTypes['Image']> }>;
  MediaPresentation: ResolverTypeWrapper<MediaPresentation>;
  MediaPresentationFormat: MediaPresentationFormat;
  Menu: ResolverTypeWrapper<Omit<Menu, 'items'> & { items: Array<ResolversTypes['MenuItem']> }>;
  MenuItem: ResolverTypeWrapper<Omit<MenuItem, 'items' | 'resource'> & { items: Array<ResolversTypes['MenuItem']>, resource?: Maybe<ResolversTypes['MenuItemResource']> }>;
  MenuItemResource: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['MenuItemResource']>;
  MenuItemType: MenuItemType;
  Merchandise: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['Merchandise']>;
  Metafield: ResolverTypeWrapper<Omit<Metafield, 'parentResource' | 'reference' | 'references'> & { parentResource: ResolversTypes['MetafieldParentResource'], reference?: Maybe<ResolversTypes['MetafieldReference']>, references?: Maybe<ResolversTypes['MetafieldReferenceConnection']> }>;
  ...
  MetafieldReferenceConnection: ResolverTypeWrapper<Omit<MetafieldReferenceConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['MetafieldReferenceEdge']>, nodes: Array<ResolversTypes['MetafieldReference']> }>;
  MetafieldReferenceEdge: ResolverTypeWrapper<Omit<MetafieldReferenceEdge, 'node'> & { node: ResolversTypes['MetafieldReference'] }>;
  MetafieldsSetUserError: ResolverTypeWrapper<MetafieldsSetUserError>;
  MetafieldsSetUserErrorCode: MetafieldsSetUserErrorCode;
  Metaobject: ResolverTypeWrapper<Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<ResolversTypes['MetaobjectField']>, fields: Array<ResolversTypes['MetaobjectField']>, seo?: Maybe<ResolversTypes['MetaobjectSEO']> }>;
  MetaobjectConnection: ResolverTypeWrapper<Omit<MetaobjectConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['MetaobjectEdge']>, nodes: Array<ResolversTypes['Metaobject']> }>;
  MetaobjectEdge: ResolverTypeWrapper<Omit<MetaobjectEdge, 'node'> & { node: ResolversTypes['Metaobject'] }>;
  MetaobjectField: ResolverTypeWrapper<Omit<MetaobjectField, 'reference' | 'references'> & { reference?: Maybe<ResolversTypes['MetafieldReference']>, references?: Maybe<ResolversTypes['MetafieldReferenceConnection']> }>;
  MetaobjectHandleInput: MetaobjectHandleInput;
  MetaobjectSEO: ResolverTypeWrapper<Omit<MetaobjectSeo, 'description' | 'title'> & { description?: Maybe<ResolversTypes['MetaobjectField']>, title?: Maybe<ResolversTypes['MetaobjectField']> }>;
  Model3d: ResolverTypeWrapper<Omit<Model3d, 'previewImage'> & { previewImage?: Maybe<ResolversTypes['Image']> }>;
  Model3dSource: ResolverTypeWrapper<Model3dSource>;
  MoneyInput: MoneyInput;
  MoneyV2: ResolverTypeWrapper<MoneyV2>;
  Mutation: ResolverTypeWrapper<{}>;
  Node: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['Node']>;
  OnlineStorePublishable: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['OnlineStorePublishable']>;
  Order: ResolverTypeWrapper<Omit<Order, 'discountApplications' | 'lineItems' | 'metafield' | 'metafields' | 'shippingDiscountAllocations' | 'successfulFulfillments'> & { discountApplications: ResolversTypes['DiscountApplicationConnection'], lineItems: ResolversTypes['OrderLineItemConnection'], metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, shippingDiscountAllocations: Array<ResolversTypes['DiscountAllocation']>, successfulFulfillments?: Maybe<Array<ResolversTypes['Fulfillment']>> }>;
  ...
  OrderLineItem: ResolverTypeWrapper<Omit<OrderLineItem, 'discountAllocations' | 'variant'> & { discountAllocations: Array<ResolversTypes['DiscountAllocation']>, variant?: Maybe<ResolversTypes['ProductVariant']> }>;
  OrderLineItemConnection: ResolverTypeWrapper<Omit<OrderLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['OrderLineItemEdge']>, nodes: Array<ResolversTypes['OrderLineItem']> }>;
  OrderLineItemEdge: ResolverTypeWrapper<Omit<OrderLineItemEdge, 'node'> & { node: ResolversTypes['OrderLineItem'] }>;
  OrderSortKeys: OrderSortKeys;
  Page: ResolverTypeWrapper<Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  ...
  PaginatedSitemapResources: ResolverTypeWrapper<Omit<PaginatedSitemapResources, 'items'> & { items: Array<ResolversTypes['SitemapResourceInterface']> }>;
  PaymentSettings: ResolverTypeWrapper<PaymentSettings>;
  PredictiveSearchLimitScope: PredictiveSearchLimitScope;
  PredictiveSearchResult: ResolverTypeWrapper<Omit<PredictiveSearchResult, 'articles' | 'collections' | 'pages' | 'products'> & { articles: Array<ResolversTypes['Article']>, collections: Array<ResolversTypes['Collection']>, pages: Array<ResolversTypes['Page']>, products: Array<ResolversTypes['Product']> }>;
  ...
  Product: ResolverTypeWrapper<Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<ResolversTypes['ProductVariant']>, collections: ResolversTypes['CollectionConnection'], featuredImage?: Maybe<ResolversTypes['Image']>, images: ResolversTypes['ImageConnection'], media: ResolversTypes['MediaConnection'], metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, options: Array<ResolversTypes['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<ResolversTypes['ProductVariant']>, sellingPlanGroups: ResolversTypes['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<ResolversTypes['ProductVariant']> }>;
  ProductCollectionSortKeys: ProductCollectionSortKeys;
  ProductConnection: ResolverTypeWrapper<Omit<ProductConnection, 'edges' | 'filters' | 'nodes'> & { edges: Array<ResolversTypes['ProductEdge']>, filters: Array<ResolversTypes['Filter']>, nodes: Array<ResolversTypes['Product']> }>;
  ...
  ProductOptionValue: ResolverTypeWrapper<Omit<ProductOptionValue, 'firstSelectableVariant' | 'swatch'> & { firstSelectableVariant?: Maybe<ResolversTypes['ProductVariant']>, swatch?: Maybe<ResolversTypes['ProductOptionValueSwatch']> }>;
  ...
  ProductVariant: ResolverTypeWrapper<Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<ResolversTypes['Image']>, metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, product: ResolversTypes['Product'], sellingPlanAllocations: ResolversTypes['SellingPlanAllocationConnection'], storeAvailability: ResolversTypes['StoreAvailabilityConnection'] }>;
  ProductVariantComponent: ResolverTypeWrapper<Omit<ProductVariantComponent, 'productVariant'> & { productVariant: ResolversTypes['ProductVariant'] }>;
  ...
  PurchasingCompany: ResolverTypeWrapper<Omit<PurchasingCompany, 'company' | 'location'> & { company: ResolversTypes['Company'], location: ResolversTypes['CompanyLocation'] }>;
  ...
  SearchResultItemConnection: ResolverTypeWrapper<Omit<SearchResultItemConnection, 'edges' | 'nodes' | 'productFilters'> & { edges: Array<ResolversTypes['SearchResultItemEdge']>, nodes: Array<ResolversTypes['SearchResultItem']>, productFilters: Array<ResolversTypes['Filter']> }>;
  ...
  SellingPlan: ResolverTypeWrapper<Omit<SellingPlan, 'billingPolicy' | 'checkoutCharge' | 'deliveryPolicy' | 'metafield' | 'metafields' | 'priceAdjustments'> & { billingPolicy?: Maybe<ResolversTypes['SellingPlanBillingPolicy']>, checkoutCharge: ResolversTypes['SellingPlanCheckoutCharge'], deliveryPolicy?: Maybe<ResolversTypes['SellingPlanDeliveryPolicy']>, metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>>, priceAdjustments: Array<ResolversTypes['SellingPlanPriceAdjustment']> }>;
  SellingPlanAllocation: ResolverTypeWrapper<Omit<SellingPlanAllocation, 'priceAdjustments' | 'sellingPlan'> & { priceAdjustments: Array<ResolversTypes['SellingPlanAllocationPriceAdjustment']>, sellingPlan: ResolversTypes['SellingPlan'] }>;
  SellingPlanAllocationConnection: ResolverTypeWrapper<Omit<SellingPlanAllocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SellingPlanAllocationEdge']>, nodes: Array<ResolversTypes['SellingPlanAllocation']> }>;
  SellingPlanAllocationEdge: ResolverTypeWrapper<Omit<SellingPlanAllocationEdge, 'node'> & { node: ResolversTypes['SellingPlanAllocation'] }>;
  SellingPlanAllocationPriceAdjustment: ResolverTypeWrapper<SellingPlanAllocationPriceAdjustment>;
  SellingPlanBillingPolicy: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SellingPlanBillingPolicy']>;
  SellingPlanCheckoutCharge: ResolverTypeWrapper<Omit<SellingPlanCheckoutCharge, 'value'> & { value: ResolversTypes['SellingPlanCheckoutChargeValue'] }>;
  ...
  SellingPlanCheckoutChargeValue: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SellingPlanCheckoutChargeValue']>;
  SellingPlanConnection: ResolverTypeWrapper<Omit<SellingPlanConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SellingPlanEdge']>, nodes: Array<ResolversTypes['SellingPlan']> }>;
  SellingPlanDeliveryPolicy: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SellingPlanDeliveryPolicy']>;
  SellingPlanEdge: ResolverTypeWrapper<Omit<SellingPlanEdge, 'node'> & { node: ResolversTypes['SellingPlan'] }>;
  ...
  SellingPlanGroup: ResolverTypeWrapper<Omit<SellingPlanGroup, 'options' | 'sellingPlans'> & { options: Array<ResolversTypes['SellingPlanGroupOption']>, sellingPlans: ResolversTypes['SellingPlanConnection'] }>;
  SellingPlanGroupConnection: ResolverTypeWrapper<Omit<SellingPlanGroupConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['SellingPlanGroupEdge']>, nodes: Array<ResolversTypes['SellingPlanGroup']> }>;
  SellingPlanGroupEdge: ResolverTypeWrapper<Omit<SellingPlanGroupEdge, 'node'> & { node: ResolversTypes['SellingPlanGroup'] }>;
  ...
  SellingPlanPriceAdjustmentValue: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>['SellingPlanPriceAdjustmentValue']>;
  ...
  Shop: ResolverTypeWrapper<Omit<Shop, 'brand' | 'metafield' | 'metafields'> & { brand?: Maybe<ResolversTypes['Brand']>, metafield?: Maybe<ResolversTypes['Metafield']>, metafields: Array<Maybe<ResolversTypes['Metafield']>> }>;
  ...
  Sitemap: ResolverTypeWrapper<Omit<Sitemap, 'resources'> & { resources?: Maybe<ResolversTypes['PaginatedSitemapResources']> }>;
  SitemapImage: ResolverTypeWrapper<SitemapImage>;
  SitemapResource: ResolverTypeWrapper<SitemapResource>;
  SitemapResourceInterface: ResolverTypeWrapper<ResolversInterfaceTypes<ResolversTypes>['SitemapResourceInterface']>;
  SitemapResourceMetaobject: ResolverTypeWrapper<SitemapResourceMetaobject>;
  SitemapType: SitemapType;
  StoreAvailability: ResolverTypeWrapper<Omit<StoreAvailability, 'location'> & { location: ResolversTypes['Location'] }>;
  StoreAvailabilityConnection: ResolverTypeWrapper<Omit<StoreAvailabilityConnection, 'edges' | 'nodes'> & { edges: Array<ResolversTypes['StoreAvailabilityEdge']>, nodes: Array<ResolversTypes['StoreAvailability']> }>;
  StoreAvailabilityEdge: ResolverTypeWrapper<Omit<StoreAvailabilityEdge, 'node'> & { node: ResolversTypes['StoreAvailability'] }>;
  ...
  Swatch: ResolverTypeWrapper<Omit<Swatch, 'image'> & { image?: Maybe<ResolversTypes['MediaImage']> }>;
  ...
  Video: ResolverTypeWrapper<Omit<Video, 'previewImage'> & { previewImage?: Maybe<ResolversTypes['Image']> }>;
...
export type ResolversParentTypes = {
  ...
  Article: Omit<Article, 'blog' | 'image' | 'metafield' | 'metafields'> & { blog: ResolversParentTypes['Blog'], image?: Maybe<ResolversParentTypes['Image']>, metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  ...
  BaseCartLineConnection: Omit<BaseCartLineConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['BaseCartLineEdge']>, nodes: Array<ResolversParentTypes['BaseCartLine']> };
  BaseCartLineEdge: Omit<BaseCartLineEdge, 'node'> & { node: ResolversParentTypes['BaseCartLine'] };
  Blog: Omit<Blog, 'articleByHandle' | 'articles' | 'metafield' | 'metafields'> & { articleByHandle?: Maybe<ResolversParentTypes['Article']>, articles: ResolversParentTypes['ArticleConnection'], metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  BlogConnection: Omit<BlogConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['BlogEdge']>, nodes: Array<ResolversParentTypes['Blog']> };
  BlogEdge: Omit<BlogEdge, 'node'> & { node: ResolversParentTypes['Blog'] };
  Boolean: Scalars['Boolean']['output'];
  Brand: Omit<Brand, 'coverImage' | 'logo' | 'squareLogo'> & { coverImage?: Maybe<ResolversParentTypes['MediaImage']>, logo?: Maybe<ResolversParentTypes['MediaImage']>, squareLogo?: Maybe<ResolversParentTypes['MediaImage']> };
  BrandColorGroup: BrandColorGroup;
  BrandColors: BrandColors;
  BuyerInput: BuyerInput;
  Cart: Omit<Cart, 'buyerIdentity' | 'delivery' | 'deliveryGroups' | 'discountAllocations' | 'lines' | 'metafield' | 'metafields'> & { buyerIdentity: ResolversParentTypes['CartBuyerIdentity'], delivery: ResolversParentTypes['CartDelivery'], deliveryGroups: ResolversParentTypes['CartDeliveryGroupConnection'], discountAllocations: Array<ResolversParentTypes['CartDiscountAllocation']>, lines: ResolversParentTypes['BaseCartLineConnection'], metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  ...
  CartAutomaticDiscountAllocation: Omit<CartAutomaticDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversParentTypes['CartDiscountApplication'] };
  CartBillingAddressUpdatePayload: Omit<CartBillingAddressUpdatePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartBuyerIdentity: Omit<CartBuyerIdentity, 'customer' | 'deliveryAddressPreferences' | 'purchasingCompany'> & { customer?: Maybe<ResolversParentTypes['Customer']>, deliveryAddressPreferences: Array<ResolversParentTypes['DeliveryAddress']>, purchasingCompany?: Maybe<ResolversParentTypes['PurchasingCompany']> };
  CartBuyerIdentityInput: CartBuyerIdentityInput;
  CartBuyerIdentityUpdatePayload: Omit<CartBuyerIdentityUpdatePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartCodeDiscountAllocation: Omit<CartCodeDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversParentTypes['CartDiscountApplication'] };
  CartCompletionAction: ResolversUnionTypes<ResolversParentTypes>['CartCompletionAction'];
  CartCompletionActionRequired: Omit<CartCompletionActionRequired, 'action'> & { action?: Maybe<ResolversParentTypes['CartCompletionAction']> };
  ...
  CartCustomDiscountAllocation: Omit<CartCustomDiscountAllocation, 'discountApplication'> & { discountApplication: ResolversParentTypes['CartDiscountApplication'] };
  CartDelivery: Omit<CartDelivery, 'addresses'> & { addresses: Array<ResolversParentTypes['CartSelectableAddress']> };
  CartDeliveryAddress: CartDeliveryAddress;
  CartDeliveryAddressInput: CartDeliveryAddressInput;
  CartDeliveryAddressesAddPayload: Omit<CartDeliveryAddressesAddPayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartDeliveryAddressesRemovePayload: Omit<CartDeliveryAddressesRemovePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartDeliveryAddressesUpdatePayload: Omit<CartDeliveryAddressesUpdatePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartDeliveryCoordinatesPreference: CartDeliveryCoordinatesPreference;
  CartDeliveryCoordinatesPreferenceInput: CartDeliveryCoordinatesPreferenceInput;
  CartDeliveryGroup: Omit<CartDeliveryGroup, 'cartLines'> & { cartLines: ResolversParentTypes['BaseCartLineConnection'] };
  CartDeliveryGroupConnection: Omit<CartDeliveryGroupConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['CartDeliveryGroupEdge']>, nodes: Array<ResolversParentTypes['CartDeliveryGroup']> };
  CartDeliveryGroupEdge: Omit<CartDeliveryGroupEdge, 'node'> & { node: ResolversParentTypes['CartDeliveryGroup'] };
  CartDeliveryInput: CartDeliveryInput;
  ...
  CartDiscountApplication: Omit<CartDiscountApplication, 'value'> & { value: ResolversParentTypes['PricingValue'] };
  ...
  CartInput: CartInput;
  CartInputMetafieldInput: CartInputMetafieldInput;
  CartLine: Omit<CartLine, 'discountAllocations' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<ResolversParentTypes['CartDiscountAllocation']>, merchandise: ResolversParentTypes['Merchandise'], sellingPlanAllocation?: Maybe<ResolversParentTypes['SellingPlanAllocation']> };
  ...
  CartMetafieldsSetInput: CartMetafieldsSetInput;
  CartMetafieldsSetPayload: Omit<CartMetafieldsSetPayload, 'metafields'> & { metafields?: Maybe<Array<ResolversParentTypes['Metafield']>> };
  ...
  CartPaymentInput: CartPaymentInput;
  CartPaymentUpdatePayload: Omit<CartPaymentUpdatePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartPreferences: CartPreferences;
  CartPreferencesInput: CartPreferencesInput;
  CartPrepareForCompletionPayload: Omit<CartPrepareForCompletionPayload, 'result'> & { result?: Maybe<ResolversParentTypes['CartPrepareForCompletionResult']> };
  CartPrepareForCompletionResult: ResolversUnionTypes<ResolversParentTypes>['CartPrepareForCompletionResult'];
  CartSelectableAddress: Omit<CartSelectableAddress, 'address'> & { address: ResolversParentTypes['CartAddress'] };
  CartSelectableAddressInput: CartSelectableAddressInput;
  CartSelectableAddressUpdateInput: CartSelectableAddressUpdateInput;
  CartSelectedDeliveryOptionInput: CartSelectedDeliveryOptionInput;
  CartSelectedDeliveryOptionsUpdatePayload: Omit<CartSelectedDeliveryOptionsUpdatePayload, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartStatusNotReady: Omit<CartStatusNotReady, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartStatusReady: Omit<CartStatusReady, 'cart'> & { cart?: Maybe<ResolversParentTypes['Cart']> };
  CartSubmitForCompletionPayload: Omit<CartSubmitForCompletionPayload, 'result'> & { result?: Maybe<ResolversParentTypes['CartSubmitForCompletionResult']> };
  ...
  CategoryFilter: CategoryFilter;
  Collection: Omit<Collection, 'image' | 'metafield' | 'metafields' | 'products'> & { image?: Maybe<ResolversParentTypes['Image']>, metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, products: ResolversParentTypes['ProductConnection'] };
  ...
  Company: Omit<Company, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  CompanyContact: CompanyContact;
  CompanyLocation: Omit<CompanyLocation, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  CompletePaymentChallenge: CompletePaymentChallenge;
  CompletionError: CompletionError;
  ComponentizableCartLine: Omit<ComponentizableCartLine, 'discountAllocations' | 'lineComponents' | 'merchandise' | 'sellingPlanAllocation'> & { discountAllocations: Array<ResolversParentTypes['CartDiscountAllocation']>, lineComponents: Array<ResolversParentTypes['CartLine']>, merchandise: ResolversParentTypes['Merchandise'], sellingPlanAllocation?: Maybe<ResolversParentTypes['SellingPlanAllocation']> };
  Count: Count;
  Country: Omit<Country, 'market'> & { market?: Maybe<ResolversParentTypes['Market']> };
  Currency: Currency;
  Customer: Omit<Customer, 'metafield' | 'metafields' | 'orders'> & { metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, orders: ResolversParentTypes['OrderConnection'] };
  ...
  CustomerActivateByUrlPayload: Omit<CustomerActivateByUrlPayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  CustomerActivateInput: CustomerActivateInput;
  CustomerActivatePayload: Omit<CustomerActivatePayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  ...
  CustomerCreateInput: CustomerCreateInput;
  CustomerCreatePayload: Omit<CustomerCreatePayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  CustomerDefaultAddressUpdatePayload: Omit<CustomerDefaultAddressUpdatePayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  CustomerRecoverPayload: CustomerRecoverPayload;
  CustomerResetByUrlPayload: Omit<CustomerResetByUrlPayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  CustomerResetInput: CustomerResetInput;
  CustomerResetPayload: Omit<CustomerResetPayload, 'customer'> & { customer?: Maybe<ResolversParentTypes['Customer']> };
  CustomerUpdateInput: CustomerUpdateInput;
  ...
  Domain: Domain;
  ExternalVideo: Omit<ExternalVideo, 'previewImage'> & { previewImage?: Maybe<ResolversParentTypes['Image']> };
  Filter: Omit<Filter, 'values'> & { values: Array<ResolversParentTypes['FilterValue']> };
  FilterValue: Omit<FilterValue, 'image' | 'swatch'> & { image?: Maybe<ResolversParentTypes['MediaImage']>, swatch?: Maybe<ResolversParentTypes['Swatch']> };
  ...
  FulfillmentLineItem: Omit<FulfillmentLineItem, 'lineItem'> & { lineItem: ResolversParentTypes['OrderLineItem'] };
  ...
  GenericFile: Omit<GenericFile, 'previewImage'> & { previewImage?: Maybe<ResolversParentTypes['Image']> };
  GeoCoordinateInput: GeoCoordinateInput;
  ...
  Image: Image;
  ImageConnection: Omit<ImageConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['ImageEdge']>, nodes: Array<ResolversParentTypes['Image']> };
  ...
  Language: Language;
  Localization: Omit<Localization, 'availableCountries' | 'country' | 'market'> & { availableCountries: Array<ResolversParentTypes['Country']>, country: ResolversParentTypes['Country'], market: ResolversParentTypes['Market'] };
  Location: Omit<Location, 'address' | 'metafield' | 'metafields'> & { address: ResolversParentTypes['LocationAddress'], metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  LocationAddress: LocationAddress;
  LocationConnection: Omit<LocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['LocationEdge']>, nodes: Array<ResolversParentTypes['Location']> };
  ...
  Market: Omit<Market, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  Media: ResolversInterfaceTypes<ResolversParentTypes>['Media'];
  MediaConnection: Omit<MediaConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['MediaEdge']>, nodes: Array<ResolversParentTypes['Media']> };
  MediaEdge: Omit<MediaEdge, 'node'> & { node: ResolversParentTypes['Media'] };
  MediaImage: Omit<MediaImage, 'image' | 'previewImage'> & { image?: Maybe<ResolversParentTypes['Image']>, previewImage?: Maybe<ResolversParentTypes['Image']> };
  MediaPresentation: MediaPresentation;
  Menu: Omit<Menu, 'items'> & { items: Array<ResolversParentTypes['MenuItem']> };
  MenuItem: Omit<MenuItem, 'items' | 'resource'> & { items: Array<ResolversParentTypes['MenuItem']>, resource?: Maybe<ResolversParentTypes['MenuItemResource']> };
  ...
  Metafield: Omit<Metafield, 'parentResource' | 'reference' | 'references'> & { parentResource: ResolversParentTypes['MetafieldParentResource'], reference?: Maybe<ResolversParentTypes['MetafieldReference']>, references?: Maybe<ResolversParentTypes['MetafieldReferenceConnection']> };
  ...
  MetafieldReferenceConnection: Omit<MetafieldReferenceConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['MetafieldReferenceEdge']>, nodes: Array<ResolversParentTypes['MetafieldReference']> };
  MetafieldReferenceEdge: Omit<MetafieldReferenceEdge, 'node'> & { node: ResolversParentTypes['MetafieldReference'] };
  MetafieldsSetUserError: MetafieldsSetUserError;
  Metaobject: Omit<Metaobject, 'field' | 'fields' | 'seo'> & { field?: Maybe<ResolversParentTypes['MetaobjectField']>, fields: Array<ResolversParentTypes['MetaobjectField']>, seo?: Maybe<ResolversParentTypes['MetaobjectSEO']> };
  MetaobjectConnection: Omit<MetaobjectConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['MetaobjectEdge']>, nodes: Array<ResolversParentTypes['Metaobject']> };
  MetaobjectEdge: Omit<MetaobjectEdge, 'node'> & { node: ResolversParentTypes['Metaobject'] };
  MetaobjectField: Omit<MetaobjectField, 'reference' | 'references'> & { reference?: Maybe<ResolversParentTypes['MetafieldReference']>, references?: Maybe<ResolversParentTypes['MetafieldReferenceConnection']> };
  MetaobjectHandleInput: MetaobjectHandleInput;
  MetaobjectSEO: Omit<MetaobjectSeo, 'description' | 'title'> & { description?: Maybe<ResolversParentTypes['MetaobjectField']>, title?: Maybe<ResolversParentTypes['MetaobjectField']> };
  Model3d: Omit<Model3d, 'previewImage'> & { previewImage?: Maybe<ResolversParentTypes['Image']> };
  ...
  Order: Omit<Order, 'discountApplications' | 'lineItems' | 'metafield' | 'metafields' | 'shippingDiscountAllocations' | 'successfulFulfillments'> & { discountApplications: ResolversParentTypes['DiscountApplicationConnection'], lineItems: ResolversParentTypes['OrderLineItemConnection'], metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, shippingDiscountAllocations: Array<ResolversParentTypes['DiscountAllocation']>, successfulFulfillments?: Maybe<Array<ResolversParentTypes['Fulfillment']>> };
  ...
  OrderLineItem: Omit<OrderLineItem, 'discountAllocations' | 'variant'> & { discountAllocations: Array<ResolversParentTypes['DiscountAllocation']>, variant?: Maybe<ResolversParentTypes['ProductVariant']> };
  OrderLineItemConnection: Omit<OrderLineItemConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['OrderLineItemEdge']>, nodes: Array<ResolversParentTypes['OrderLineItem']> };
  OrderLineItemEdge: Omit<OrderLineItemEdge, 'node'> & { node: ResolversParentTypes['OrderLineItem'] };
  Page: Omit<Page, 'metafield' | 'metafields'> & { metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  ...
  PageInfo: PageInfo;
  PaginatedSitemapResources: Omit<PaginatedSitemapResources, 'items'> & { items: Array<ResolversParentTypes['SitemapResourceInterface']> };
  PaymentSettings: PaymentSettings;
  PredictiveSearchResult: Omit<PredictiveSearchResult, 'articles' | 'collections' | 'pages' | 'products'> & { articles: Array<ResolversParentTypes['Article']>, collections: Array<ResolversParentTypes['Collection']>, pages: Array<ResolversParentTypes['Page']>, products: Array<ResolversParentTypes['Product']> };
  PriceRangeFilter: PriceRangeFilter;
  PricingPercentageValue: PricingPercentageValue;
  PricingValue: ResolversUnionTypes<ResolversParentTypes>['PricingValue'];
  Product: Omit<Product, 'adjacentVariants' | 'collections' | 'featuredImage' | 'images' | 'media' | 'metafield' | 'metafields' | 'options' | 'selectedOrFirstAvailableVariant' | 'sellingPlanGroups' | 'variantBySelectedOptions'> & { adjacentVariants: Array<ResolversParentTypes['ProductVariant']>, collections: ResolversParentTypes['CollectionConnection'], featuredImage?: Maybe<ResolversParentTypes['Image']>, images: ResolversParentTypes['ImageConnection'], media: ResolversParentTypes['MediaConnection'], metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, options: Array<ResolversParentTypes['ProductOption']>, selectedOrFirstAvailableVariant?: Maybe<ResolversParentTypes['ProductVariant']>, sellingPlanGroups: ResolversParentTypes['SellingPlanGroupConnection'], variantBySelectedOptions?: Maybe<ResolversParentTypes['ProductVariant']> };
  ProductConnection: Omit<ProductConnection, 'edges' | 'filters' | 'nodes'> & { edges: Array<ResolversParentTypes['ProductEdge']>, filters: Array<ResolversParentTypes['Filter']>, nodes: Array<ResolversParentTypes['Product']> };
  ...
  ProductOptionValue: Omit<ProductOptionValue, 'firstSelectableVariant' | 'swatch'> & { firstSelectableVariant?: Maybe<ResolversParentTypes['ProductVariant']>, swatch?: Maybe<ResolversParentTypes['ProductOptionValueSwatch']> };
  ProductOptionValueSwatch: Omit<ProductOptionValueSwatch, 'image'> & { image?: Maybe<ResolversParentTypes['Media']> };
  ProductPriceRange: ProductPriceRange;
  ProductVariant: Omit<ProductVariant, 'image' | 'metafield' | 'metafields' | 'product' | 'sellingPlanAllocations' | 'storeAvailability'> & { image?: Maybe<ResolversParentTypes['Image']>, metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, product: ResolversParentTypes['Product'], sellingPlanAllocations: ResolversParentTypes['SellingPlanAllocationConnection'], storeAvailability: ResolversParentTypes['StoreAvailabilityConnection'] };
  ProductVariantComponent: Omit<ProductVariantComponent, 'productVariant'> & { productVariant: ResolversParentTypes['ProductVariant'] };
  ...
  PurchasingCompany: Omit<PurchasingCompany, 'company' | 'location'> & { company: ResolversParentTypes['Company'], location: ResolversParentTypes['CompanyLocation'] };
  ...
  SearchResultItemConnection: Omit<SearchResultItemConnection, 'edges' | 'nodes' | 'productFilters'> & { edges: Array<ResolversParentTypes['SearchResultItemEdge']>, nodes: Array<ResolversParentTypes['SearchResultItem']>, productFilters: Array<ResolversParentTypes['Filter']> };
  SearchResultItemEdge: Omit<SearchResultItemEdge, 'node'> & { node: ResolversParentTypes['SearchResultItem'] };
  SelectedOption: SelectedOption;
  SelectedOptionInput: SelectedOptionInput;
  SellingPlan: Omit<SellingPlan, 'billingPolicy' | 'checkoutCharge' | 'deliveryPolicy' | 'metafield' | 'metafields' | 'priceAdjustments'> & { billingPolicy?: Maybe<ResolversParentTypes['SellingPlanBillingPolicy']>, checkoutCharge: ResolversParentTypes['SellingPlanCheckoutCharge'], deliveryPolicy?: Maybe<ResolversParentTypes['SellingPlanDeliveryPolicy']>, metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>>, priceAdjustments: Array<ResolversParentTypes['SellingPlanPriceAdjustment']> };
  SellingPlanAllocation: Omit<SellingPlanAllocation, 'priceAdjustments' | 'sellingPlan'> & { priceAdjustments: Array<ResolversParentTypes['SellingPlanAllocationPriceAdjustment']>, sellingPlan: ResolversParentTypes['SellingPlan'] };
  SellingPlanAllocationConnection: Omit<SellingPlanAllocationConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SellingPlanAllocationEdge']>, nodes: Array<ResolversParentTypes['SellingPlanAllocation']> };
  SellingPlanAllocationEdge: Omit<SellingPlanAllocationEdge, 'node'> & { node: ResolversParentTypes['SellingPlanAllocation'] };
  ...
  SellingPlanCheckoutCharge: Omit<SellingPlanCheckoutCharge, 'value'> & { value: ResolversParentTypes['SellingPlanCheckoutChargeValue'] };
  ...
  SellingPlanConnection: Omit<SellingPlanConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SellingPlanEdge']>, nodes: Array<ResolversParentTypes['SellingPlan']> };
  SellingPlanDeliveryPolicy: ResolversUnionTypes<ResolversParentTypes>['SellingPlanDeliveryPolicy'];
  SellingPlanEdge: Omit<SellingPlanEdge, 'node'> & { node: ResolversParentTypes['SellingPlan'] };
  ...
  SellingPlanGroup: Omit<SellingPlanGroup, 'options' | 'sellingPlans'> & { options: Array<ResolversParentTypes['SellingPlanGroupOption']>, sellingPlans: ResolversParentTypes['SellingPlanConnection'] };
  SellingPlanGroupConnection: Omit<SellingPlanGroupConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['SellingPlanGroupEdge']>, nodes: Array<ResolversParentTypes['SellingPlanGroup']> };
  SellingPlanGroupEdge: Omit<SellingPlanGroupEdge, 'node'> & { node: ResolversParentTypes['SellingPlanGroup'] };
  ...
  Shop: Omit<Shop, 'brand' | 'metafield' | 'metafields'> & { brand?: Maybe<ResolversParentTypes['Brand']>, metafield?: Maybe<ResolversParentTypes['Metafield']>, metafields: Array<Maybe<ResolversParentTypes['Metafield']>> };
  ...
  Sitemap: Omit<Sitemap, 'resources'> & { resources?: Maybe<ResolversParentTypes['PaginatedSitemapResources']> };
  ...
  StoreAvailability: Omit<StoreAvailability, 'location'> & { location: ResolversParentTypes['Location'] };
  StoreAvailabilityConnection: Omit<StoreAvailabilityConnection, 'edges' | 'nodes'> & { edges: Array<ResolversParentTypes['StoreAvailabilityEdge']>, nodes: Array<ResolversParentTypes['StoreAvailability']> };
  StoreAvailabilityEdge: Omit<StoreAvailabilityEdge, 'node'> & { node: ResolversParentTypes['StoreAvailability'] };
  ...
  Swatch: Omit<Swatch, 'image'> & { image?: Maybe<ResolversParentTypes['MediaImage']> };
  ...
  VariantOptionFilter: VariantOptionFilter;
  Video: Omit<Video, 'previewImage'> & { previewImage?: Maybe<ResolversParentTypes['Image']> };
...
export type ArticleResolvers<ContextType = any, ParentType extends ResolversParentTypes['Article'] = ResolversParentTypes['Article']> = {
  ...
  content?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<ArticleContentArgs>>;
  contentHtml?: Resolver<ResolversTypes['HTML'], ParentType, ContextType>;
  excerpt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType, Partial<ArticleExcerptArgs>>;
  excerptHtml?: Resolver<Maybe<ResolversTypes['HTML']>, ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<ArticleMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<ArticleMetafieldsArgs, 'identifiers'>>;
...
export type BaseCartLineResolvers<ContextType = any, ParentType extends ResolversParentTypes['BaseCartLine'] = ResolversParentTypes['BaseCartLine']> = {
  __resolveType: TypeResolveFn<'CartLine' | 'ComponentizableCartLine', ParentType, ContextType>;
  attribute?: Resolver<Maybe<ResolversTypes['Attribute']>, ParentType, ContextType, RequireFields<BaseCartLineAttributeArgs, 'key'>>;
  ...
  discountAllocations?: Resolver<Array<ResolversTypes['CartDiscountAllocation']>, ParentType, ContextType>;
  estimatedCost?: Resolver<ResolversTypes['CartLineEstimatedCost'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  merchandise?: Resolver<ResolversTypes['Merchandise'], ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  sellingPlanAllocation?: Resolver<Maybe<ResolversTypes['SellingPlanAllocation']>, ParentType, ContextType>;
};

export type BaseCartLineConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['BaseCartLineConnection'] = ResolversParentTypes['BaseCartLineConnection']> = {
  edges?: Resolver<Array<ResolversTypes['BaseCartLineEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['BaseCartLine']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BaseCartLineEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['BaseCartLineEdge'] = ResolversParentTypes['BaseCartLineEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type BlogResolvers<ContextType = any, ParentType extends ResolversParentTypes['Blog'] = ResolversParentTypes['Blog']> = {
  ...
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<BlogMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<BlogMetafieldsArgs, 'identifiers'>>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  seo?: Resolver<Maybe<ResolversTypes['SEO']>, ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type BrandColorGroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['BrandColorGroup'] = ResolversParentTypes['BrandColorGroup']> = {
  background?: Resolver<Maybe<ResolversTypes['Color']>, ParentType, ContextType>;
  foreground?: Resolver<Maybe<ResolversTypes['Color']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type BrandColorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['BrandColors'] = ResolversParentTypes['BrandColors']> = {
  primary?: Resolver<Array<ResolversTypes['BrandColorGroup']>, ParentType, ContextType>;
  secondary?: Resolver<Array<ResolversTypes['BrandColorGroup']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CartResolvers<ContextType = any, ParentType extends ResolversParentTypes['Cart'] = ResolversParentTypes['Cart']> = {
  ...
  attribute?: Resolver<Maybe<ResolversTypes['Attribute']>, ParentType, ContextType, RequireFields<CartAttributeArgs, 'key'>>;
  attributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  ...
  deliveryGroups?: Resolver<ResolversTypes['CartDeliveryGroupConnection'], ParentType, ContextType, RequireFields<CartDeliveryGroupsArgs, 'reverse' | 'withCarrierRates'>>;
  discountAllocations?: Resolver<Array<ResolversTypes['CartDiscountAllocation']>, ParentType, ContextType>;
  discountCodes?: Resolver<Array<ResolversTypes['CartDiscountCode']>, ParentType, ContextType>;
  estimatedCost?: Resolver<ResolversTypes['CartEstimatedCost'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lines?: Resolver<ResolversTypes['BaseCartLineConnection'], ParentType, ContextType, RequireFields<CartLinesArgs, 'reverse'>>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CartMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<CartMetafieldsArgs, 'identifiers'>>;
...
export type CartAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartAddress'] = ResolversParentTypes['CartAddress']> = {
  __resolveType: TypeResolveFn<'CartDeliveryAddress', ParentType, ContextType>;
};

export type CartAttributesUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartAttributesUpdatePayload'] = ResolversParentTypes['CartAttributesUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartAutomaticDiscountAllocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartAutomaticDiscountAllocation'] = ResolversParentTypes['CartAutomaticDiscountAllocation']> = {
  discountApplication?: Resolver<ResolversTypes['CartDiscountApplication'], ParentType, ContextType>;
  discountedAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  targetType?: Resolver<ResolversTypes['DiscountApplicationTargetType'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartBillingAddressUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartBillingAddressUpdatePayload'] = ResolversParentTypes['CartBillingAddressUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartBuyerIdentityResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartBuyerIdentity'] = ResolversParentTypes['CartBuyerIdentity']> = {
  countryCode?: Resolver<Maybe<ResolversTypes['CountryCode']>, ParentType, ContextType>;
  customer?: Resolver<Maybe<ResolversTypes['Customer']>, ParentType, ContextType>;
  deliveryAddressPreferences?: Resolver<Array<ResolversTypes['DeliveryAddress']>, ParentType, ContextType>;
  email?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  phone?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  preferences?: Resolver<Maybe<ResolversTypes['CartPreferences']>, ParentType, ContextType>;
  purchasingCompany?: Resolver<Maybe<ResolversTypes['PurchasingCompany']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartBuyerIdentityUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartBuyerIdentityUpdatePayload'] = ResolversParentTypes['CartBuyerIdentityUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartCodeDiscountAllocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCodeDiscountAllocation'] = ResolversParentTypes['CartCodeDiscountAllocation']> = {
...
export type CartCompletionActionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionAction'] = ResolversParentTypes['CartCompletionAction']> = {
  __resolveType: TypeResolveFn<'CompletePaymentChallenge', ParentType, ContextType>;
};

export type CartCompletionActionRequiredResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionActionRequired'] = ResolversParentTypes['CartCompletionActionRequired']> = {
  action?: Resolver<Maybe<ResolversTypes['CartCompletionAction']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartCompletionAttemptResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionAttemptResult'] = ResolversParentTypes['CartCompletionAttemptResult']> = {
  __resolveType: TypeResolveFn<'CartCompletionActionRequired' | 'CartCompletionFailed' | 'CartCompletionProcessing' | 'CartCompletionSuccess', ParentType, ContextType>;
};

export type CartCompletionFailedResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionFailed'] = ResolversParentTypes['CartCompletionFailed']> = {
  errors?: Resolver<Array<ResolversTypes['CompletionError']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartCompletionProcessingResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionProcessing'] = ResolversParentTypes['CartCompletionProcessing']> = {
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  pollDelay?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartCompletionSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCompletionSuccess'] = ResolversParentTypes['CartCompletionSuccess']> = {
...
export type CartCostResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCost'] = ResolversParentTypes['CartCost']> = {
  checkoutChargeAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  subtotalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  subtotalAmountEstimated?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  totalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalAmountEstimated?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  totalDutyAmount?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalDutyAmountEstimated?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  totalTaxAmount?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  totalTaxAmountEstimated?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCreatePayload'] = ResolversParentTypes['CartCreatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartCustomDiscountAllocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartCustomDiscountAllocation'] = ResolversParentTypes['CartCustomDiscountAllocation']> = {
  discountApplication?: Resolver<ResolversTypes['CartDiscountApplication'], ParentType, ContextType>;
  discountedAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  targetType?: Resolver<ResolversTypes['DiscountApplicationTargetType'], ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type CartDeliveryResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDelivery'] = ResolversParentTypes['CartDelivery']> = {
  addresses?: Resolver<Array<ResolversTypes['CartSelectableAddress']>, ParentType, ContextType, RequireFields<CartDeliveryAddressesArgs, 'selected'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDeliveryAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryAddress'] = ResolversParentTypes['CartDeliveryAddress']> = {
  ...
  formatted?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<CartDeliveryAddressFormattedArgs, 'withCompany' | 'withName'>>;
...
export type CartDeliveryAddressesAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryAddressesAddPayload'] = ResolversParentTypes['CartDeliveryAddressesAddPayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartDeliveryAddressesRemovePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryAddressesRemovePayload'] = ResolversParentTypes['CartDeliveryAddressesRemovePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartDeliveryAddressesUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryAddressesUpdatePayload'] = ResolversParentTypes['CartDeliveryAddressesUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartDeliveryCoordinatesPreferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryCoordinatesPreference'] = ResolversParentTypes['CartDeliveryCoordinatesPreference']> = {
...
export type CartDeliveryGroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryGroup'] = ResolversParentTypes['CartDeliveryGroup']> = {
  cartLines?: Resolver<ResolversTypes['BaseCartLineConnection'], ParentType, ContextType, RequireFields<CartDeliveryGroupCartLinesArgs, 'reverse'>>;
  deliveryAddress?: Resolver<ResolversTypes['MailingAddress'], ParentType, ContextType>;
  deliveryOptions?: Resolver<Array<ResolversTypes['CartDeliveryOption']>, ParentType, ContextType>;
  groupType?: Resolver<ResolversTypes['CartDeliveryGroupType'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  selectedDeliveryOption?: Resolver<Maybe<ResolversTypes['CartDeliveryOption']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDeliveryGroupConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryGroupConnection'] = ResolversParentTypes['CartDeliveryGroupConnection']> = {
  edges?: Resolver<Array<ResolversTypes['CartDeliveryGroupEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['CartDeliveryGroup']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDeliveryGroupEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryGroupEdge'] = ResolversParentTypes['CartDeliveryGroupEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['CartDeliveryGroup'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDeliveryOptionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryOption'] = ResolversParentTypes['CartDeliveryOption']> = {
  code?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  deliveryMethodType?: Resolver<ResolversTypes['DeliveryMethodType'], ParentType, ContextType>;
...
export type CartDeliveryPreferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDeliveryPreference'] = ResolversParentTypes['CartDeliveryPreference']> = {
  coordinates?: Resolver<Maybe<ResolversTypes['CartDeliveryCoordinatesPreference']>, ParentType, ContextType>;
  deliveryMethod?: Resolver<Array<ResolversTypes['PreferenceDeliveryMethodType']>, ParentType, ContextType>;
  pickupHandle?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDiscountAllocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDiscountAllocation'] = ResolversParentTypes['CartDiscountAllocation']> = {
  __resolveType: TypeResolveFn<'CartAutomaticDiscountAllocation' | 'CartCodeDiscountAllocation' | 'CartCustomDiscountAllocation', ParentType, ContextType>;
  discountApplication?: Resolver<ResolversTypes['CartDiscountApplication'], ParentType, ContextType>;
  discountedAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  targetType?: Resolver<ResolversTypes['DiscountApplicationTargetType'], ParentType, ContextType>;
};

export type CartDiscountApplicationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDiscountApplication'] = ResolversParentTypes['CartDiscountApplication']> = {
  allocationMethod?: Resolver<ResolversTypes['DiscountApplicationAllocationMethod'], ParentType, ContextType>;
  targetSelection?: Resolver<ResolversTypes['DiscountApplicationTargetSelection'], ParentType, ContextType>;
  targetType?: Resolver<ResolversTypes['DiscountApplicationTargetType'], ParentType, ContextType>;
  value?: Resolver<ResolversTypes['PricingValue'], ParentType, ContextType>;
...
export type CartDiscountCodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDiscountCode'] = ResolversParentTypes['CartDiscountCode']> = {
  applicable?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartDiscountCodesUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartDiscountCodesUpdatePayload'] = ResolversParentTypes['CartDiscountCodesUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartEstimatedCostResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartEstimatedCost'] = ResolversParentTypes['CartEstimatedCost']> = {
  checkoutChargeAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  subtotalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalDutyAmount?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
...
export type CartGiftCardCodesRemovePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartGiftCardCodesRemovePayload'] = ResolversParentTypes['CartGiftCardCodesRemovePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartGiftCardCodesUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartGiftCardCodesUpdatePayload'] = ResolversParentTypes['CartGiftCardCodesUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartLineResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLine'] = ResolversParentTypes['CartLine']> = {
  attribute?: Resolver<Maybe<ResolversTypes['Attribute']>, ParentType, ContextType, RequireFields<CartLineAttributeArgs, 'key'>>;
  attributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  cost?: Resolver<ResolversTypes['CartLineCost'], ParentType, ContextType>;
  discountAllocations?: Resolver<Array<ResolversTypes['CartDiscountAllocation']>, ParentType, ContextType>;
  estimatedCost?: Resolver<ResolversTypes['CartLineEstimatedCost'], ParentType, ContextType>;
...
export type CartLineCostResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLineCost'] = ResolversParentTypes['CartLineCost']> = {
...
export type CartLineEstimatedCostResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLineEstimatedCost'] = ResolversParentTypes['CartLineEstimatedCost']> = {
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  compareAtAmount?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  subtotalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  totalAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartLinesAddPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLinesAddPayload'] = ResolversParentTypes['CartLinesAddPayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartLinesRemovePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLinesRemovePayload'] = ResolversParentTypes['CartLinesRemovePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartLinesUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartLinesUpdatePayload'] = ResolversParentTypes['CartLinesUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartMetafieldDeletePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartMetafieldDeletePayload'] = ResolversParentTypes['CartMetafieldDeletePayload']> = {
  deletedId?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['MetafieldDeleteUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartMetafieldsSetPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartMetafieldsSetPayload'] = ResolversParentTypes['CartMetafieldsSetPayload']> = {
...
export type CartNoteUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartNoteUpdatePayload'] = ResolversParentTypes['CartNoteUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartOperationErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartOperationError'] = ResolversParentTypes['CartOperationError']> = {
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartPaymentUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartPaymentUpdatePayload'] = ResolversParentTypes['CartPaymentUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartPreferencesResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartPreferences'] = ResolversParentTypes['CartPreferences']> = {
  delivery?: Resolver<Maybe<ResolversTypes['CartDeliveryPreference']>, ParentType, ContextType>;
  wallet?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartPrepareForCompletionPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartPrepareForCompletionPayload'] = ResolversParentTypes['CartPrepareForCompletionPayload']> = {
  result?: Resolver<Maybe<ResolversTypes['CartPrepareForCompletionResult']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartPrepareForCompletionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartPrepareForCompletionResult'] = ResolversParentTypes['CartPrepareForCompletionResult']> = {
  __resolveType: TypeResolveFn<'CartStatusNotReady' | 'CartStatusReady' | 'CartThrottled', ParentType, ContextType>;
};

export type CartSelectableAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartSelectableAddress'] = ResolversParentTypes['CartSelectableAddress']> = {
...
export type CartSelectedDeliveryOptionsUpdatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartSelectedDeliveryOptionsUpdatePayload'] = ResolversParentTypes['CartSelectedDeliveryOptionsUpdatePayload']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  warnings?: Resolver<Array<ResolversTypes['CartWarning']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CartStatusNotReadyResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartStatusNotReady'] = ResolversParentTypes['CartStatusNotReady']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  errors?: Resolver<Array<ResolversTypes['CartOperationError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartStatusReadyResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartStatusReady'] = ResolversParentTypes['CartStatusReady']> = {
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartSubmitForCompletionPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartSubmitForCompletionPayload'] = ResolversParentTypes['CartSubmitForCompletionPayload']> = {
  result?: Resolver<Maybe<ResolversTypes['CartSubmitForCompletionResult']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['CartUserError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartSubmitForCompletionResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartSubmitForCompletionResult'] = ResolversParentTypes['CartSubmitForCompletionResult']> = {
  __resolveType: TypeResolveFn<'SubmitAlreadyAccepted' | 'SubmitFailed' | 'SubmitSuccess' | 'SubmitThrottled', ParentType, ContextType>;
};

export type CartThrottledResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartThrottled'] = ResolversParentTypes['CartThrottled']> = {
  pollAfter?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartUserError'] = ResolversParentTypes['CartUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['CartErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CartWarningResolvers<ContextType = any, ParentType extends ResolversParentTypes['CartWarning'] = ResolversParentTypes['CartWarning']> = {
...
export type CollectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['Collection'] = ResolversParentTypes['Collection']> = {
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<CollectionDescriptionArgs>>;
  descriptionHtml?: Resolver<ResolversTypes['HTML'], ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CollectionMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<CollectionMetafieldsArgs, 'identifiers'>>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
...
export type CollectionConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['CollectionConnection'] = ResolversParentTypes['CollectionConnection']> = {
  ...
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  totalCount?: Resolver<ResolversTypes['UnsignedInt64'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CommentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Comment'] = ResolversParentTypes['Comment']> = {
  ...
  content?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<CommentContentArgs>>;
  contentHtml?: Resolver<ResolversTypes['HTML'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type CompanyResolvers<ContextType = any, ParentType extends ResolversParentTypes['Company'] = ResolversParentTypes['Company']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CompanyMetafieldArgs, 'key'>>;
...
export type CompanyLocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompanyLocation'] = ResolversParentTypes['CompanyLocation']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  locale?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CompanyLocationMetafieldArgs, 'key'>>;
...
export type CompletePaymentChallengeResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompletePaymentChallenge'] = ResolversParentTypes['CompletePaymentChallenge']> = {
  redirectUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type CompletionErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['CompletionError'] = ResolversParentTypes['CompletionError']> = {
  code?: Resolver<ResolversTypes['CompletionErrorCode'], ParentType, ContextType>;
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ComponentizableCartLineResolvers<ContextType = any, ParentType extends ResolversParentTypes['ComponentizableCartLine'] = ResolversParentTypes['ComponentizableCartLine']> = {
  attribute?: Resolver<Maybe<ResolversTypes['Attribute']>, ParentType, ContextType, RequireFields<ComponentizableCartLineAttributeArgs, 'key'>>;
  attributes?: Resolver<Array<ResolversTypes['Attribute']>, ParentType, ContextType>;
  cost?: Resolver<ResolversTypes['CartLineCost'], ParentType, ContextType>;
  discountAllocations?: Resolver<Array<ResolversTypes['CartDiscountAllocation']>, ParentType, ContextType>;
  estimatedCost?: Resolver<ResolversTypes['CartLineEstimatedCost'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lineComponents?: Resolver<Array<ResolversTypes['CartLine']>, ParentType, ContextType>;
  merchandise?: Resolver<ResolversTypes['Merchandise'], ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  sellingPlanAllocation?: Resolver<Maybe<ResolversTypes['SellingPlanAllocation']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type CustomerResolvers<ContextType = any, ParentType extends ResolversParentTypes['Customer'] = ResolversParentTypes['Customer']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<CustomerMetafieldArgs, 'key'>>;
  ...
  numberOfOrders?: Resolver<ResolversTypes['UnsignedInt64'], ParentType, ContextType>;
...
export type DisplayableErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['DisplayableError'] = ResolversParentTypes['DisplayableError']> = {
  __resolveType: TypeResolveFn<'CartUserError' | 'CustomerUserError' | 'MetafieldDeleteUserError' | 'MetafieldsSetUserError' | 'UserError' | 'UserErrorsShopPayPaymentRequestSessionUserErrors', ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
};
...
export type ExternalVideoResolvers<ContextType = any, ParentType extends ResolversParentTypes['ExternalVideo'] = ResolversParentTypes['ExternalVideo']> = {
  ...
  presentation?: Resolver<Maybe<ResolversTypes['MediaPresentation']>, ParentType, ContextType>;
...
export type FilterValueResolvers<ContextType = any, ParentType extends ResolversParentTypes['FilterValue'] = ResolversParentTypes['FilterValue']> = {
  count?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['MediaImage']>, ParentType, ContextType>;
...
export type FulfillmentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Fulfillment'] = ResolversParentTypes['Fulfillment']> = {
  ...
  trackingInfo?: Resolver<Array<ResolversTypes['FulfillmentTrackingInfo']>, ParentType, ContextType, Partial<FulfillmentTrackingInfoArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type GenericFileResolvers<ContextType = any, ParentType extends ResolversParentTypes['GenericFile'] = ResolversParentTypes['GenericFile']> = {
  alt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  mimeType?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  originalFileSize?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  previewImage?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  url?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type HasMetafieldsResolvers<ContextType = any, ParentType extends ResolversParentTypes['HasMetafields'] = ResolversParentTypes['HasMetafields']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Cart' | 'Collection' | 'Company' | 'CompanyLocation' | 'Customer' | 'Location' | 'Market' | 'Order' | 'Page' | 'Product' | 'ProductVariant' | 'SellingPlan' | 'Shop', ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<HasMetafieldsMetafieldArgs, 'key'>>;
...
export type InContextAnnotationResolvers<ContextType = any, ParentType extends ResolversParentTypes['InContextAnnotation'] = ResolversParentTypes['InContextAnnotation']> = {
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  type?: Resolver<ResolversTypes['InContextAnnotationType'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type InContextAnnotationTypeResolvers<ContextType = any, ParentType extends ResolversParentTypes['InContextAnnotationType'] = ResolversParentTypes['InContextAnnotationType']> = {
...
export type LocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Location'] = ResolversParentTypes['Location']> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<LocationMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<LocationMetafieldsArgs, 'identifiers'>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MailingAddressResolvers<ContextType = any, ParentType extends ResolversParentTypes['MailingAddress'] = ResolversParentTypes['MailingAddress']> = {
  ...
  firstName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  formatted?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, RequireFields<MailingAddressFormattedArgs, 'withCompany' | 'withName'>>;
  formattedArea?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastName?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  latitude?: Resolver<Maybe<ResolversTypes['Float']>, ParentType, ContextType>;
...
export type MailingAddressConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MailingAddressConnection'] = ResolversParentTypes['MailingAddressConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['MailingAddress']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MarketResolvers<ContextType = any, ParentType extends ResolversParentTypes['Market'] = ResolversParentTypes['Market']> = {
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<MarketMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<MarketMetafieldsArgs, 'identifiers'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MediaPresentationResolvers<ContextType = any, ParentType extends ResolversParentTypes['MediaPresentation'] = ResolversParentTypes['MediaPresentation']> = {
  asJson?: Resolver<Maybe<ResolversTypes['JSON']>, ParentType, ContextType, RequireFields<MediaPresentationAsJsonArgs, 'format'>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MenuItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['MenuItem'] = ResolversParentTypes['MenuItem']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  items?: Resolver<Array<ResolversTypes['MenuItem']>, ParentType, ContextType>;
  resource?: Resolver<Maybe<ResolversTypes['MenuItemResource']>, ParentType, ContextType>;
...
export type MenuItemResourceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MenuItemResource'] = ResolversParentTypes['MenuItemResource']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Collection' | 'Metaobject' | 'Page' | 'Product' | 'ShopPolicy', ParentType, ContextType>;
};

export type MerchandiseResolvers<ContextType = any, ParentType extends ResolversParentTypes['Merchandise'] = ResolversParentTypes['Merchandise']> = {
...
export type MetafieldResolvers<ContextType = any, ParentType extends ResolversParentTypes['Metafield'] = ResolversParentTypes['Metafield']> = {
  ...
  references?: Resolver<Maybe<ResolversTypes['MetafieldReferenceConnection']>, ParentType, ContextType, Partial<MetafieldReferencesArgs>>;
...
export type MetafieldDeleteUserErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldDeleteUserError'] = ResolversParentTypes['MetafieldDeleteUserError']> = {
  code?: Resolver<Maybe<ResolversTypes['MetafieldDeleteErrorCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MetafieldReferenceResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldReference'] = ResolversParentTypes['MetafieldReference']> = {
  __resolveType: TypeResolveFn<'Collection' | 'GenericFile' | 'MediaImage' | 'Metaobject' | 'Model3d' | 'Page' | 'Product' | 'ProductVariant' | 'Video', ParentType, ContextType>;
};

export type MetafieldReferenceConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldReferenceConnection'] = ResolversParentTypes['MetafieldReferenceConnection']> = {
  edges?: Resolver<Array<ResolversTypes['MetafieldReferenceEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['MetafieldReference']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetafieldReferenceEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetafieldReferenceEdge'] = ResolversParentTypes['MetafieldReferenceEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type MetaobjectResolvers<ContextType = any, ParentType extends ResolversParentTypes['Metaobject'] = ResolversParentTypes['Metaobject']> = {
  field?: Resolver<Maybe<ResolversTypes['MetaobjectField']>, ParentType, ContextType, RequireFields<MetaobjectFieldArgs, 'key'>>;
  fields?: Resolver<Array<ResolversTypes['MetaobjectField']>, ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  seo?: Resolver<Maybe<ResolversTypes['MetaobjectSEO']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetaobjectConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetaobjectConnection'] = ResolversParentTypes['MetaobjectConnection']> = {
  edges?: Resolver<Array<ResolversTypes['MetaobjectEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['Metaobject']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetaobjectEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetaobjectEdge'] = ResolversParentTypes['MetaobjectEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Metaobject'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetaobjectFieldResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetaobjectField'] = ResolversParentTypes['MetaobjectField']> = {
  key?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  reference?: Resolver<Maybe<ResolversTypes['MetafieldReference']>, ParentType, ContextType>;
  references?: Resolver<Maybe<ResolversTypes['MetafieldReferenceConnection']>, ParentType, ContextType, Partial<MetaobjectFieldReferencesArgs>>;
  type?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  value?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type MetaobjectSeoResolvers<ContextType = any, ParentType extends ResolversParentTypes['MetaobjectSEO'] = ResolversParentTypes['MetaobjectSEO']> = {
  description?: Resolver<Maybe<ResolversTypes['MetaobjectField']>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['MetaobjectField']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  cartAttributesUpdate?: Resolver<Maybe<ResolversTypes['CartAttributesUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartAttributesUpdateArgs, 'attributes' | 'cartId'>>;
  cartBillingAddressUpdate?: Resolver<Maybe<ResolversTypes['CartBillingAddressUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartBillingAddressUpdateArgs, 'cartId'>>;
  cartBuyerIdentityUpdate?: Resolver<Maybe<ResolversTypes['CartBuyerIdentityUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartBuyerIdentityUpdateArgs, 'buyerIdentity' | 'cartId'>>;
  cartCreate?: Resolver<Maybe<ResolversTypes['CartCreatePayload']>, ParentType, ContextType, Partial<MutationCartCreateArgs>>;
  cartDeliveryAddressesAdd?: Resolver<Maybe<ResolversTypes['CartDeliveryAddressesAddPayload']>, ParentType, ContextType, RequireFields<MutationCartDeliveryAddressesAddArgs, 'addresses' | 'cartId'>>;
  cartDeliveryAddressesRemove?: Resolver<Maybe<ResolversTypes['CartDeliveryAddressesRemovePayload']>, ParentType, ContextType, RequireFields<MutationCartDeliveryAddressesRemoveArgs, 'addressIds' | 'cartId'>>;
  cartDeliveryAddressesUpdate?: Resolver<Maybe<ResolversTypes['CartDeliveryAddressesUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartDeliveryAddressesUpdateArgs, 'addresses' | 'cartId'>>;
  cartDiscountCodesUpdate?: Resolver<Maybe<ResolversTypes['CartDiscountCodesUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartDiscountCodesUpdateArgs, 'cartId'>>;
  cartGiftCardCodesRemove?: Resolver<Maybe<ResolversTypes['CartGiftCardCodesRemovePayload']>, ParentType, ContextType, RequireFields<MutationCartGiftCardCodesRemoveArgs, 'appliedGiftCardIds' | 'cartId'>>;
  cartGiftCardCodesUpdate?: Resolver<Maybe<ResolversTypes['CartGiftCardCodesUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartGiftCardCodesUpdateArgs, 'cartId' | 'giftCardCodes'>>;
  cartLinesAdd?: Resolver<Maybe<ResolversTypes['CartLinesAddPayload']>, ParentType, ContextType, RequireFields<MutationCartLinesAddArgs, 'cartId' | 'lines'>>;
  cartLinesRemove?: Resolver<Maybe<ResolversTypes['CartLinesRemovePayload']>, ParentType, ContextType, RequireFields<MutationCartLinesRemoveArgs, 'cartId' | 'lineIds'>>;
  cartLinesUpdate?: Resolver<Maybe<ResolversTypes['CartLinesUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartLinesUpdateArgs, 'cartId' | 'lines'>>;
  cartMetafieldDelete?: Resolver<Maybe<ResolversTypes['CartMetafieldDeletePayload']>, ParentType, ContextType, RequireFields<MutationCartMetafieldDeleteArgs, 'input'>>;
  cartMetafieldsSet?: Resolver<Maybe<ResolversTypes['CartMetafieldsSetPayload']>, ParentType, ContextType, RequireFields<MutationCartMetafieldsSetArgs, 'metafields'>>;
  cartNoteUpdate?: Resolver<Maybe<ResolversTypes['CartNoteUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartNoteUpdateArgs, 'cartId' | 'note'>>;
  cartPaymentUpdate?: Resolver<Maybe<ResolversTypes['CartPaymentUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartPaymentUpdateArgs, 'cartId' | 'payment'>>;
  cartPrepareForCompletion?: Resolver<Maybe<ResolversTypes['CartPrepareForCompletionPayload']>, ParentType, ContextType, RequireFields<MutationCartPrepareForCompletionArgs, 'cartId'>>;
  cartSelectedDeliveryOptionsUpdate?: Resolver<Maybe<ResolversTypes['CartSelectedDeliveryOptionsUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCartSelectedDeliveryOptionsUpdateArgs, 'cartId' | 'selectedDeliveryOptions'>>;
  cartSubmitForCompletion?: Resolver<Maybe<ResolversTypes['CartSubmitForCompletionPayload']>, ParentType, ContextType, RequireFields<MutationCartSubmitForCompletionArgs, 'attemptToken' | 'cartId'>>;
  ...
  customerAddressCreate?: Resolver<Maybe<ResolversTypes['CustomerAddressCreatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressCreateArgs, 'address' | 'customerAccessToken'>>;
  customerAddressDelete?: Resolver<Maybe<ResolversTypes['CustomerAddressDeletePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressDeleteArgs, 'customerAccessToken' | 'id'>>;
  customerAddressUpdate?: Resolver<Maybe<ResolversTypes['CustomerAddressUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerAddressUpdateArgs, 'address' | 'customerAccessToken' | 'id'>>;
  ...
  customerDefaultAddressUpdate?: Resolver<Maybe<ResolversTypes['CustomerDefaultAddressUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerDefaultAddressUpdateArgs, 'addressId' | 'customerAccessToken'>>;
  ...
  customerResetByUrl?: Resolver<Maybe<ResolversTypes['CustomerResetByUrlPayload']>, ParentType, ContextType, RequireFields<MutationCustomerResetByUrlArgs, 'password' | 'resetUrl'>>;
  customerUpdate?: Resolver<Maybe<ResolversTypes['CustomerUpdatePayload']>, ParentType, ContextType, RequireFields<MutationCustomerUpdateArgs, 'customer' | 'customerAccessToken'>>;
  shopPayPaymentRequestSessionCreate?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestSessionCreatePayload']>, ParentType, ContextType, RequireFields<MutationShopPayPaymentRequestSessionCreateArgs, 'paymentRequest' | 'sourceIdentifier'>>;
  shopPayPaymentRequestSessionSubmit?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestSessionSubmitPayload']>, ParentType, ContextType, RequireFields<MutationShopPayPaymentRequestSessionSubmitArgs, 'idempotencyKey' | 'paymentRequest' | 'token'>>;
};

export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'AppliedGiftCard' | 'Article' | 'Blog' | 'Cart' | 'CartLine' | 'Collection' | 'Comment' | 'Company' | 'CompanyContact' | 'CompanyLocation' | 'ComponentizableCartLine' | 'ExternalVideo' | 'GenericFile' | 'Location' | 'MailingAddress' | 'Market' | 'MediaImage' | 'MediaPresentation' | 'Menu' | 'MenuItem' | 'Metafield' | 'Metaobject' | 'Model3d' | 'Order' | 'Page' | 'Product' | 'ProductOption' | 'ProductOptionValue' | 'ProductVariant' | 'Shop' | 'ShopPayInstallmentsFinancingPlan' | 'ShopPayInstallmentsFinancingPlanTerm' | 'ShopPayInstallmentsProductVariantPricing' | 'ShopPolicy' | 'TaxonomyCategory' | 'UrlRedirect' | 'Video', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};

export type OnlineStorePublishableResolvers<ContextType = any, ParentType extends ResolversParentTypes['OnlineStorePublishable'] = ResolversParentTypes['OnlineStorePublishable']> = {
  __resolveType: TypeResolveFn<'Article' | 'Blog' | 'Collection' | 'Metaobject' | 'Page' | 'Product', ParentType, ContextType>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
};
...
export type OrderResolvers<ContextType = any, ParentType extends ResolversParentTypes['Order'] = ResolversParentTypes['Order']> = {
  ...
  currentTotalShippingPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  ...
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<OrderMetafieldArgs, 'key'>>;
  ...
  subtotalPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  subtotalPriceV2?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  successfulFulfillments?: Resolver<Maybe<Array<ResolversTypes['Fulfillment']>>, ParentType, ContextType, Partial<OrderSuccessfulFulfillmentsArgs>>;
...
export type PageResolvers<ContextType = any, ParentType extends ResolversParentTypes['Page'] = ResolversParentTypes['Page']> = {
  ...
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<PageMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<PageMetafieldsArgs, 'identifiers'>>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  seo?: Resolver<Maybe<ResolversTypes['SEO']>, ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  trackingParameters?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type PaginatedSitemapResourcesResolvers<ContextType = any, ParentType extends ResolversParentTypes['PaginatedSitemapResources'] = ResolversParentTypes['PaginatedSitemapResources']> = {
  hasNextPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  items?: Resolver<Array<ResolversTypes['SitemapResourceInterface']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type PredictiveSearchResultResolvers<ContextType = any, ParentType extends ResolversParentTypes['PredictiveSearchResult'] = ResolversParentTypes['PredictiveSearchResult']> = {
  ...
  queries?: Resolver<Array<ResolversTypes['SearchQuerySuggestion']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ProductResolvers<ContextType = any, ParentType extends ResolversParentTypes['Product'] = ResolversParentTypes['Product']> = {
  adjacentVariants?: Resolver<Array<ResolversTypes['ProductVariant']>, ParentType, ContextType, RequireFields<ProductAdjacentVariantsArgs, 'caseInsensitiveMatch' | 'ignoreUnknownOptions'>>;
  availableForSale?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  category?: Resolver<Maybe<ResolversTypes['TaxonomyCategory']>, ParentType, ContextType>;
  ...
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<ProductDescriptionArgs>>;
  descriptionHtml?: Resolver<ResolversTypes['HTML'], ParentType, ContextType>;
  encodedVariantAvailability?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  encodedVariantExistence?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  featuredImage?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  images?: Resolver<ResolversTypes['ImageConnection'], ParentType, ContextType, RequireFields<ProductImagesArgs, 'reverse' | 'sortKey'>>;
  ...
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<ProductMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<ProductMetafieldsArgs, 'identifiers'>>;
  onlineStoreUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  options?: Resolver<Array<ResolversTypes['ProductOption']>, ParentType, ContextType, Partial<ProductOptionsArgs>>;
  ...
  selectedOrFirstAvailableVariant?: Resolver<Maybe<ResolversTypes['ProductVariant']>, ParentType, ContextType, RequireFields<ProductSelectedOrFirstAvailableVariantArgs, 'caseInsensitiveMatch' | 'ignoreUnknownOptions'>>;
  ...
  trackingParameters?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  variantBySelectedOptions?: Resolver<Maybe<ResolversTypes['ProductVariant']>, ParentType, ContextType, RequireFields<ProductVariantBySelectedOptionsArgs, 'caseInsensitiveMatch' | 'ignoreUnknownOptions' | 'selectedOptions'>>;
  ...
  variantsCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
...
export type ProductOptionValueSwatchResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductOptionValueSwatch'] = ResolversParentTypes['ProductOptionValueSwatch']> = {
...
export type ProductVariantResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariant'] = ResolversParentTypes['ProductVariant']> = {
  ...
  components?: Resolver<ResolversTypes['ProductVariantComponentConnection'], ParentType, ContextType, Partial<ProductVariantComponentsArgs>>;
  currentlyNotInStock?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  groupedBy?: Resolver<ResolversTypes['ProductVariantConnection'], ParentType, ContextType, Partial<ProductVariantGroupedByArgs>>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['Image']>, ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<ProductVariantMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<ProductVariantMetafieldsArgs, 'identifiers'>>;
  ...
  quantityPriceBreaks?: Resolver<ResolversTypes['QuantityPriceBreakConnection'], ParentType, ContextType, Partial<ProductVariantQuantityPriceBreaksArgs>>;
  quantityRule?: Resolver<ResolversTypes['QuantityRule'], ParentType, ContextType>;
  requiresComponents?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  ...
  shopPayInstallmentsPricing?: Resolver<Maybe<ResolversTypes['ShopPayInstallmentsProductVariantPricing']>, ParentType, ContextType>;
...
export type ProductVariantComponentResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantComponent'] = ResolversParentTypes['ProductVariantComponent']> = {
  productVariant?: Resolver<ResolversTypes['ProductVariant'], ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ProductVariantComponentConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantComponentConnection'] = ResolversParentTypes['ProductVariantComponentConnection']> = {
  edges?: Resolver<Array<ResolversTypes['ProductVariantComponentEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['ProductVariantComponent']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ProductVariantComponentEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['ProductVariantComponentEdge'] = ResolversParentTypes['ProductVariantComponentEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['ProductVariantComponent'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type QuantityPriceBreakResolvers<ContextType = any, ParentType extends ResolversParentTypes['QuantityPriceBreak'] = ResolversParentTypes['QuantityPriceBreak']> = {
  minimumQuantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  price?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type QuantityPriceBreakConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['QuantityPriceBreakConnection'] = ResolversParentTypes['QuantityPriceBreakConnection']> = {
  edges?: Resolver<Array<ResolversTypes['QuantityPriceBreakEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['QuantityPriceBreak']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type QuantityPriceBreakEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['QuantityPriceBreakEdge'] = ResolversParentTypes['QuantityPriceBreakEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  node?: Resolver<ResolversTypes['QuantityPriceBreak'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type QuantityRuleResolvers<ContextType = any, ParentType extends ResolversParentTypes['QuantityRule'] = ResolversParentTypes['QuantityRule']> = {
...
export type QueryRootResolvers<ContextType = any, ParentType extends ResolversParentTypes['QueryRoot'] = ResolversParentTypes['QueryRoot']> = {
  article?: Resolver<Maybe<ResolversTypes['Article']>, ParentType, ContextType, RequireFields<QueryRootArticleArgs, 'id'>>;
  ...
  blog?: Resolver<Maybe<ResolversTypes['Blog']>, ParentType, ContextType, Partial<QueryRootBlogArgs>>;
  ...
  cart?: Resolver<Maybe<ResolversTypes['Cart']>, ParentType, ContextType, RequireFields<QueryRootCartArgs, 'id'>>;
  cartCompletionAttempt?: Resolver<Maybe<ResolversTypes['CartCompletionAttemptResult']>, ParentType, ContextType, RequireFields<QueryRootCartCompletionAttemptArgs, 'attemptId'>>;
  collection?: Resolver<Maybe<ResolversTypes['Collection']>, ParentType, ContextType, Partial<QueryRootCollectionArgs>>;
  ...
  menu?: Resolver<Maybe<ResolversTypes['Menu']>, ParentType, ContextType, RequireFields<QueryRootMenuArgs, 'handle'>>;
  metaobject?: Resolver<Maybe<ResolversTypes['Metaobject']>, ParentType, ContextType, Partial<QueryRootMetaobjectArgs>>;
  metaobjects?: Resolver<ResolversTypes['MetaobjectConnection'], ParentType, ContextType, RequireFields<QueryRootMetaobjectsArgs, 'reverse' | 'type'>>;
  ...
  page?: Resolver<Maybe<ResolversTypes['Page']>, ParentType, ContextType, Partial<QueryRootPageArgs>>;
  ...
  predictiveSearch?: Resolver<Maybe<ResolversTypes['PredictiveSearchResult']>, ParentType, ContextType, RequireFields<QueryRootPredictiveSearchArgs, 'query'>>;
  product?: Resolver<Maybe<ResolversTypes['Product']>, ParentType, ContextType, Partial<QueryRootProductArgs>>;
  ...
  productRecommendations?: Resolver<Maybe<Array<ResolversTypes['Product']>>, ParentType, ContextType, RequireFields<QueryRootProductRecommendationsArgs, 'intent'>>;
  ...
  search?: Resolver<ResolversTypes['SearchResultItemConnection'], ParentType, ContextType, RequireFields<QueryRootSearchArgs, 'query' | 'reverse' | 'sortKey'>>;
  shop?: Resolver<ResolversTypes['Shop'], ParentType, ContextType>;
  sitemap?: Resolver<ResolversTypes['Sitemap'], ParentType, ContextType, RequireFields<QueryRootSitemapArgs, 'type'>>;
  urlRedirects?: Resolver<ResolversTypes['UrlRedirectConnection'], ParentType, ContextType, RequireFields<QueryRootUrlRedirectsArgs, 'reverse'>>;
};
...
export type SearchQuerySuggestionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchQuerySuggestion'] = ResolversParentTypes['SearchQuerySuggestion']> = {
...
export type SearchResultItemConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SearchResultItemConnection'] = ResolversParentTypes['SearchResultItemConnection']> = {
  edges?: Resolver<Array<ResolversTypes['SearchResultItemEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['SearchResultItem']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  productFilters?: Resolver<Array<ResolversTypes['Filter']>, ParentType, ContextType>;
...
export type SellingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlan'] = ResolversParentTypes['SellingPlan']> = {
  billingPolicy?: Resolver<Maybe<ResolversTypes['SellingPlanBillingPolicy']>, ParentType, ContextType>;
  checkoutCharge?: Resolver<ResolversTypes['SellingPlanCheckoutCharge'], ParentType, ContextType>;
  deliveryPolicy?: Resolver<Maybe<ResolversTypes['SellingPlanDeliveryPolicy']>, ParentType, ContextType>;
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<SellingPlanMetafieldArgs, 'key'>>;
  metafields?: Resolver<Array<Maybe<ResolversTypes['Metafield']>>, ParentType, ContextType, RequireFields<SellingPlanMetafieldsArgs, 'identifiers'>>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type SellingPlanAllocationResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanAllocation'] = ResolversParentTypes['SellingPlanAllocation']> = {
  ...
  remainingBalanceChargeAmount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
...
export type SellingPlanAllocationConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanAllocationConnection'] = ResolversParentTypes['SellingPlanAllocationConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['SellingPlanAllocation']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SellingPlanBillingPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanBillingPolicy'] = ResolversParentTypes['SellingPlanBillingPolicy']> = {
  __resolveType: TypeResolveFn<'SellingPlanRecurringBillingPolicy', ParentType, ContextType>;
};

export type SellingPlanCheckoutChargeResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanCheckoutCharge'] = ResolversParentTypes['SellingPlanCheckoutCharge']> = {
  type?: Resolver<ResolversTypes['SellingPlanCheckoutChargeType'], ParentType, ContextType>;
  value?: Resolver<ResolversTypes['SellingPlanCheckoutChargeValue'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SellingPlanCheckoutChargePercentageValueResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanCheckoutChargePercentageValue'] = ResolversParentTypes['SellingPlanCheckoutChargePercentageValue']> = {
  percentage?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SellingPlanCheckoutChargeValueResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanCheckoutChargeValue'] = ResolversParentTypes['SellingPlanCheckoutChargeValue']> = {
  __resolveType: TypeResolveFn<'MoneyV2' | 'SellingPlanCheckoutChargePercentageValue', ParentType, ContextType>;
};
...
export type SellingPlanConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanConnection'] = ResolversParentTypes['SellingPlanConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['SellingPlan']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SellingPlanDeliveryPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanDeliveryPolicy'] = ResolversParentTypes['SellingPlanDeliveryPolicy']> = {
  __resolveType: TypeResolveFn<'SellingPlanRecurringDeliveryPolicy', ParentType, ContextType>;
};
...
export type SellingPlanGroupConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanGroupConnection'] = ResolversParentTypes['SellingPlanGroupConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['SellingPlanGroup']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SellingPlanPercentagePriceAdjustmentResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanPercentagePriceAdjustment'] = ResolversParentTypes['SellingPlanPercentagePriceAdjustment']> = {
  adjustmentPercentage?: Resolver<ResolversTypes['Float'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SellingPlanRecurringBillingPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanRecurringBillingPolicy'] = ResolversParentTypes['SellingPlanRecurringBillingPolicy']> = {
  interval?: Resolver<ResolversTypes['SellingPlanInterval'], ParentType, ContextType>;
  intervalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SellingPlanRecurringDeliveryPolicyResolvers<ContextType = any, ParentType extends ResolversParentTypes['SellingPlanRecurringDeliveryPolicy'] = ResolversParentTypes['SellingPlanRecurringDeliveryPolicy']> = {
  interval?: Resolver<ResolversTypes['SellingPlanInterval'], ParentType, ContextType>;
  intervalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ShopResolvers<ContextType = any, ParentType extends ResolversParentTypes['Shop'] = ResolversParentTypes['Shop']> = {
  ...
  description?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  metafield?: Resolver<Maybe<ResolversTypes['Metafield']>, ParentType, ContextType, RequireFields<ShopMetafieldArgs, 'key'>>;
  ...
  shopPayInstallmentsPricing?: Resolver<Maybe<ResolversTypes['ShopPayInstallmentsPricing']>, ParentType, ContextType>;
  subscriptionPolicy?: Resolver<Maybe<ResolversTypes['ShopPolicyWithDefault']>, ParentType, ContextType>;
  termsOfService?: Resolver<Maybe<ResolversTypes['ShopPolicy']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayInstallmentsFinancingPlanResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayInstallmentsFinancingPlan'] = ResolversParentTypes['ShopPayInstallmentsFinancingPlan']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  terms?: Resolver<Array<ResolversTypes['ShopPayInstallmentsFinancingPlanTerm']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayInstallmentsFinancingPlanTermResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayInstallmentsFinancingPlanTerm'] = ResolversParentTypes['ShopPayInstallmentsFinancingPlanTerm']> = {
  apr?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  frequency?: Resolver<ResolversTypes['ShopPayInstallmentsFinancingPlanFrequency'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  installmentsCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
  loanType?: Resolver<ResolversTypes['ShopPayInstallmentsLoan'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayInstallmentsPricingResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayInstallmentsPricing'] = ResolversParentTypes['ShopPayInstallmentsPricing']> = {
  financingPlans?: Resolver<Array<ResolversTypes['ShopPayInstallmentsFinancingPlan']>, ParentType, ContextType>;
  maxPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  minPrice?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayInstallmentsProductVariantPricingResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayInstallmentsProductVariantPricing'] = ResolversParentTypes['ShopPayInstallmentsProductVariantPricing']> = {
...
export type ShopPayPaymentRequestResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequest'] = ResolversParentTypes['ShopPayPaymentRequest']> = {
  deliveryMethods?: Resolver<Array<ResolversTypes['ShopPayPaymentRequestDeliveryMethod']>, ParentType, ContextType>;
  discountCodes?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  discounts?: Resolver<Maybe<Array<ResolversTypes['ShopPayPaymentRequestDiscount']>>, ParentType, ContextType>;
  lineItems?: Resolver<Array<ResolversTypes['ShopPayPaymentRequestLineItem']>, ParentType, ContextType>;
  locale?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  presentmentCurrency?: Resolver<ResolversTypes['CurrencyCode'], ParentType, ContextType>;
  selectedDeliveryMethodType?: Resolver<ResolversTypes['ShopPayPaymentRequestDeliveryMethodType'], ParentType, ContextType>;
  shippingAddress?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestContactField']>, ParentType, ContextType>;
  shippingLines?: Resolver<Array<ResolversTypes['ShopPayPaymentRequestShippingLine']>, ParentType, ContextType>;
  ...
  totalShippingPrice?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestTotalShippingPrice']>, ParentType, ContextType>;
  totalTax?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestContactFieldResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestContactField'] = ResolversParentTypes['ShopPayPaymentRequestContactField']> = {
...
export type ShopPayPaymentRequestDeliveryMethodResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestDeliveryMethod'] = ResolversParentTypes['ShopPayPaymentRequestDeliveryMethod']> = {
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  deliveryExpectationLabel?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  detail?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  maxDeliveryDate?: Resolver<Maybe<ResolversTypes['ISO8601DateTime']>, ParentType, ContextType>;
  minDeliveryDate?: Resolver<Maybe<ResolversTypes['ISO8601DateTime']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestDiscountResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestDiscount'] = ResolversParentTypes['ShopPayPaymentRequestDiscount']> = {
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestImageResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestImage'] = ResolversParentTypes['ShopPayPaymentRequestImage']> = {
  alt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  url?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestLineItemResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestLineItem'] = ResolversParentTypes['ShopPayPaymentRequestLineItem']> = {
  ...
  image?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestImage']>, ParentType, ContextType>;
  itemDiscounts?: Resolver<Maybe<Array<ResolversTypes['ShopPayPaymentRequestDiscount']>>, ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  lineDiscounts?: Resolver<Maybe<Array<ResolversTypes['ShopPayPaymentRequestDiscount']>>, ParentType, ContextType>;
  originalItemPrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  originalLinePrice?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  quantity?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
...
export type ShopPayPaymentRequestReceiptResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestReceipt'] = ResolversParentTypes['ShopPayPaymentRequestReceipt']> = {
  paymentRequest?: Resolver<ResolversTypes['ShopPayPaymentRequest'], ParentType, ContextType>;
  processingStatusType?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  token?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestSessionResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestSession'] = ResolversParentTypes['ShopPayPaymentRequestSession']> = {
  checkoutUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  paymentRequest?: Resolver<ResolversTypes['ShopPayPaymentRequest'], ParentType, ContextType>;
...
export type ShopPayPaymentRequestSessionCreatePayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestSessionCreatePayload'] = ResolversParentTypes['ShopPayPaymentRequestSessionCreatePayload']> = {
  shopPayPaymentRequestSession?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestSession']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsShopPayPaymentRequestSessionUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestSessionSubmitPayloadResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestSessionSubmitPayload'] = ResolversParentTypes['ShopPayPaymentRequestSessionSubmitPayload']> = {
  paymentRequestReceipt?: Resolver<Maybe<ResolversTypes['ShopPayPaymentRequestReceipt']>, ParentType, ContextType>;
  userErrors?: Resolver<Array<ResolversTypes['UserErrorsShopPayPaymentRequestSessionUserErrors']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type ShopPayPaymentRequestShippingLineResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestShippingLine'] = ResolversParentTypes['ShopPayPaymentRequestShippingLine']> = {
  amount?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  code?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  label?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ShopPayPaymentRequestTotalShippingPriceResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPayPaymentRequestTotalShippingPrice'] = ResolversParentTypes['ShopPayPaymentRequestTotalShippingPrice']> = {
  discounts?: Resolver<Array<ResolversTypes['ShopPayPaymentRequestDiscount']>, ParentType, ContextType>;
  finalTotal?: Resolver<ResolversTypes['MoneyV2'], ParentType, ContextType>;
  originalTotal?: Resolver<Maybe<ResolversTypes['MoneyV2']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type ShopPolicyWithDefaultResolvers<ContextType = any, ParentType extends ResolversParentTypes['ShopPolicyWithDefault'] = ResolversParentTypes['ShopPolicyWithDefault']> = {
  body?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  id?: Resolver<Maybe<ResolversTypes['ID']>, ParentType, ContextType>;
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type SitemapResolvers<ContextType = any, ParentType extends ResolversParentTypes['Sitemap'] = ResolversParentTypes['Sitemap']> = {
  pagesCount?: Resolver<Maybe<ResolversTypes['Count']>, ParentType, ContextType>;
  resources?: Resolver<Maybe<ResolversTypes['PaginatedSitemapResources']>, ParentType, ContextType, RequireFields<SitemapResourcesArgs, 'page'>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SitemapImageResolvers<ContextType = any, ParentType extends ResolversParentTypes['SitemapImage'] = ResolversParentTypes['SitemapImage']> = {
  alt?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type SitemapResourceResolvers<ContextType = any, ParentType extends ResolversParentTypes['SitemapResource'] = ResolversParentTypes['SitemapResource']> = {
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['SitemapImage']>, ParentType, ContextType>;
  title?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SitemapResourceInterfaceResolvers<ContextType = any, ParentType extends ResolversParentTypes['SitemapResourceInterface'] = ResolversParentTypes['SitemapResourceInterface']> = {
  __resolveType: TypeResolveFn<'SitemapResource' | 'SitemapResourceMetaobject', ParentType, ContextType>;
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
};

export type SitemapResourceMetaobjectResolvers<ContextType = any, ParentType extends ResolversParentTypes['SitemapResourceMetaobject'] = ResolversParentTypes['SitemapResourceMetaobject']> = {
  handle?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  onlineStoreUrlHandle?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  type?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type StoreAvailabilityConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['StoreAvailabilityConnection'] = ResolversParentTypes['StoreAvailabilityConnection']> = {
  ...
  nodes?: Resolver<Array<ResolversTypes['StoreAvailability']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type SubmissionErrorResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubmissionError'] = ResolversParentTypes['SubmissionError']> = {
  code?: Resolver<ResolversTypes['SubmissionErrorCode'], ParentType, ContextType>;
  message?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubmitAlreadyAcceptedResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubmitAlreadyAccepted'] = ResolversParentTypes['SubmitAlreadyAccepted']> = {
  attemptId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubmitFailedResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubmitFailed'] = ResolversParentTypes['SubmitFailed']> = {
  checkoutUrl?: Resolver<Maybe<ResolversTypes['URL']>, ParentType, ContextType>;
  errors?: Resolver<Array<ResolversTypes['SubmissionError']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubmitSuccessResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubmitSuccess'] = ResolversParentTypes['SubmitSuccess']> = {
  attemptId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  redirectUrl?: Resolver<ResolversTypes['URL'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SubmitThrottledResolvers<ContextType = any, ParentType extends ResolversParentTypes['SubmitThrottled'] = ResolversParentTypes['SubmitThrottled']> = {
  pollAfter?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type SwatchResolvers<ContextType = any, ParentType extends ResolversParentTypes['Swatch'] = ResolversParentTypes['Swatch']> = {
  color?: Resolver<Maybe<ResolversTypes['Color']>, ParentType, ContextType>;
  image?: Resolver<Maybe<ResolversTypes['MediaImage']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type TaxonomyCategoryResolvers<ContextType = any, ParentType extends ResolversParentTypes['TaxonomyCategory'] = ResolversParentTypes['TaxonomyCategory']> = {
  ancestors?: Resolver<Array<ResolversTypes['TaxonomyCategory']>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type TrackableResolvers<ContextType = any, ParentType extends ResolversParentTypes['Trackable'] = ResolversParentTypes['Trackable']> = {
  __resolveType: TypeResolveFn<'Article' | 'Collection' | 'Page' | 'Product' | 'SearchQuerySuggestion', ParentType, ContextType>;
  trackingParameters?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
};
...
export type UrlRedirectResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlRedirect'] = ResolversParentTypes['UrlRedirect']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type UrlRedirectConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlRedirectConnection'] = ResolversParentTypes['UrlRedirectConnection']> = {
  edges?: Resolver<Array<ResolversTypes['UrlRedirectEdge']>, ParentType, ContextType>;
  nodes?: Resolver<Array<ResolversTypes['UrlRedirect']>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['PageInfo'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type UrlRedirectEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['UrlRedirectEdge'] = ResolversParentTypes['UrlRedirectEdge']> = {
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type UserErrorsShopPayPaymentRequestSessionUserErrorsResolvers<ContextType = any, ParentType extends ResolversParentTypes['UserErrorsShopPayPaymentRequestSessionUserErrors'] = ResolversParentTypes['UserErrorsShopPayPaymentRequestSessionUserErrors']> = {
  code?: Resolver<Maybe<ResolversTypes['UserErrorsShopPayPaymentRequestSessionUserErrorsCode']>, ParentType, ContextType>;
  field?: Resolver<Maybe<Array<ResolversTypes['String']>>, ParentType, ContextType>;
  message?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
