...
1. Replace these placeholder images with your own images while keeping the same filenames:
   ...
   - testimonial-1.jpeg through testimonial-3.jpeg: Testimonial profile images (400×400px recommended)

2. If you need to use different filenames, make sure to update the paths in the respective component files
