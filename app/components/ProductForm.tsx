...
export function ProductForm({
  ...
  useEffect(() => {
    ...
    if (variant) {
      ...
      setSelectedOptions(
        variant.selectedOptions.reduce((acc: Record<string, string>, option) => {
  ...
  return (
    <div className="space-y-6">
                ...
                {option.values.map((value) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 border text-sm rounded-sm relative ${isSelected
      ...
      <div className="flex items-center mt-2">
        ...
        {selectedVariant.compareAtPrice && Number(selectedVariant.compareAtPrice.amount) > 0 && (
