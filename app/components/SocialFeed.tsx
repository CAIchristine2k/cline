...
export function SocialFeed() {
  ...
  const socialPosts: SocialPost[] = [
    ...
    },
    {
      ...
      platform: 'youtube',
      content:
        "Honored to be featured in this month's Boxing Legacy magazine. Check out the full interview at the link in bio.",
  ...
  const socialHandle = config.socialLinks.instagram
    ? config.socialLinks.instagram.split('/').pop() ||
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Stay connected with {config.influencerName} on social media for
            exclusive content, behind-the-scenes footage, and the latest product
            announcements.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {socialPosts.map((post) => {
            ...
            return (
              <div
                key={post.id}
                className="bg-gray-900 rounded-lg overflow-hidden shadow-lg group border border-gray-800 hover:border-primary/30 transition-all duration-300"
              >
