      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto leading-relaxed mb-8">
            Create personalized {config.influencerName} merchandise with your own photos and designs.
            Perfect for gifts or showing your unique style.
          </p>
        </div>
        ...
        <div className="bg-secondary/40 backdrop-blur-md border border-primary/20 rounded-lg p-6 shadow-md mb-12">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-black/40 p-6 rounded-lg border border-primary/10 transition-all duration-300 hover:border-primary/30">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Easy Design Tools</h3>
              <p className="text-gray-400">Our intuitive editor lets you add photos, text, and designs with simple drag-and-drop controls.</p>
            </div>
            ...
            <div className="bg-black/40 p-6 rounded-lg border border-primary/10 transition-all duration-300 hover:border-primary/30">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Unique Results</h3>
              <p className="text-gray-400">Create one-of-a-kind {config.influencerName} merchandise that stands out from the crowd.</p>
            </div>
            ...
            <div className="bg-black/40 p-6 rounded-lg border border-primary/10 transition-all duration-300 hover:border-primary/30">
              ...
              <p className="text-gray-400">All customized products are printed with high-quality materials that look great and last.</p>
            </div>
          </div>
        </div>
