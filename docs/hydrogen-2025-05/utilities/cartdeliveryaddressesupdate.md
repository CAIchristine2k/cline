...
### CartDeliveryAddressesUpdateDefaultGeneratedType
...
#### Returns: CartDeliveryAddressesUpdateFunction- A function that takes an array of addresses and optional parameters, and returns the result of the API call.
